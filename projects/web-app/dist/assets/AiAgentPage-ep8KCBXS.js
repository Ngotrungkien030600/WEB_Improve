...
- [ ] So sánh được edge vs cloud AI`,checklist:[`Trả lời trôi chảy 10 câu phỏng vấn trên`,`Giải thích được vòng lặp agent bằng ví dụ cụ thể`,`Biết cách xử lý rate limit và tối ưu chi phí`,`So sánh được edge vs cloud AI`]}];var g=window.aiAgentConcepts,_=window.aiAgentQuizData,v=window.aiAgentTopics,y=`aiAgentChecklist`;function b(){try{return JSON.parse(localStorage.getItem(y)||`{}`)}catch{return{}}}function x(e){localStorage.setItem(y,JSON.stringify(e))}function S(e,t){let n=0,r=0;return e.forEach(e=>{e.checklist&&e.checklist.forEach(e=>{n++,t[e]&&r++})}),{done:r,total:n,percent:n>0?Math.round(r/n*100):0}}function C(e,t){let n=e.checklist||[];return{done:n.filter(e=>t[e]).length,total:n.length}}var w=[{id:`learn`,label:`Học`,icon:`📚`},{id:`quiz`,label:`Thi`,icon:`🎯`},{id:`lessons`,label:`Bài học`,icon:`📖`}],T=[{id:`general`,label:`Agent cơ bản`,icon:`🤖`},{id:`token`,label:`Token`,icon:`🔢`},{id:`quota`,label:`Quota`,icon:`⏳`},{id:`edge`,label:`Edge`,icon:`📡`}],E={name:`AiAgentPage`,components:{CHomeTimer:ee},data(){return{tabs:w,activeTab:`learn`,filterCategory:`all`,currentIndex:0,isFlipped:!1,selectedLesson:0,concepts:g,lessons:v,checklist:{},quizQuestions:[],quizCategories:T,currentQuestion:0,selectedAnswer:null,answered:!1,quizScore:0,quizStarted:!1,quizCount:10,quizTime:15,quizTimer:null,quizTimeLeft:15,selectedQuizCategory:`general`}},computed:{filteredCards(){return this.filterCategory===`all`?this.concepts:this.concepts.filter(e=>e.category===this.filterCategory)},currentCard(){return this.filteredCards[this.currentIndex]},lessonProgress(){return S(this.lessons,this.checklist)},renderedLesson(){let e=this.lessons[this.selectedLesson];if(!e)return``;let t=e.content?this.renderMarkdown(e.content):``;return e.checklist&&e.checklist.length>0&&(t+=`<h3>📝 Checklist</h3>`,e.checklist.forEach(e=>{let n=!!this.checklist[e],r=e.replace(/"/g,`&quot;`);t+=`
            <label class="checklist-item ${n?`checked`:``}">
              ...
              <span>${e}</span>
            </label>`})),t},currentQuizQuestion(){return this.quizQuestions[this.currentQuestion]?this.quizQuestions[this.currentQuestion]:null},quizPercent(){return this.quizScore===0&&!this.quizStarted?`0%`:Math.round(this.quizScore/this.quizQuestions.length*100)+`%`},quizLevel(){let e=this.quizScore/this.quizQuestions.length*100;return e>=90?`🟢 Xuất sắc`:e>=70?`🟡 Tốt`:e>=50?`🟠 Trung bình`:`🔴 Cần cố gắng`}},mounted(){this.checklist=b(),this.$nextTick(()=>this.bindLessonEvents())},updated(){this.$nextTick(()=>this.bindLessonEvents())},methods:{handleNavigate(e){h(e)},filterCategory(){this.currentIndex=0,this.isFlipped=!1},prevCard(){this.currentIndex>0&&(this.currentIndex--,this.isFlipped=!1)},nextCard(){this.currentIndex<this.filteredCards.length-1&&(this.currentIndex++,this.isFlipped=!1)},toggleLessonItem(e,t){this.checklist={...this.checklist,[e]:t},x(this.checklist)},getLessonProgress(e){let t=this.lessons[e];if(!t)return`0/0`;let{done:n,total:r}=C(t,this.checklist);return`${n}/${r}`},bindLessonEvents(){document.querySelectorAll(`.ai-lesson-content .checklist-item input`).forEach(e=>{e._bound||(e._bound=!0,e.addEventListener(`change`,()=>{this.toggleLessonItem(e.dataset.item,e.checked);let t=e.closest(`.checklist-item`);t&&t.classList.toggle(`checked`,e.checked)}))})},startQuiz(){let e=_[this.selectedQuizCategory]||[];if(e.length===0)return;let t=[...e].sort(()=>Math.random()-.5);this.quizQuestions=t.slice(0,Math.min(this.quizCount,e.length)),this.currentQuestion=0,this.selectedAnswer=null,this.answered=!1,this.quizScore=0,this.quizStarted=!0,this.startQuizTimer()},startQuizTimer(){this.quizTimer&&clearInterval(this.quizTimer),this.quizTimeLeft=this.quizTime,this.quizTimer=setInterval(()=>{this.quizTimeLeft--,this.quizTimeLeft<=0&&this.submitQuizAnswer()},1e3)},submitQuizAnswer(){if(this.answered)return;this.answered=!0,this.quizTimer&&clearInterval(this.quizTimer);let e=this.quizQuestions[this.currentQuestion];this.selectedAnswer===e.correct&&this.quizScore++},nextQuestion(){this.answered||this.submitQuizAnswer(),this.currentQuestion<this.quizQuestions.length-1&&(this.currentQuestion++,this.selectedAnswer=null,this.answered=!1,this.startQuizTimer())},resetQuiz(){this.quizTimer&&clearInterval(this.quizTimer),this.quizStarted=!1,this.quizQuestions=[],this.currentQuestion=0,this.selectedAnswer=null,this.answered=!1,this.quizScore=0},renderMarkdown(e){return e?e.replace(/^#{1,6} (.+)$/gm,(e,t)=>`<h${t.length}>${t}</h${t.length}>`).replace(/\*\*(.+?)\*\*/g,`<strong>$1</strong>`).replace(/\n\n/g,`</p><p>`).replace(/^(?!<[h|p|u|o|l|b|c])(.+)$/gm,`<p>$1</p>`).replace(/<p><\/p>/g,``):``}}},D={class:`page-root`,style:{"--color-accent":`#f472b6`}},O={class:`container`},k={class:`ai-topbar`},A={class:`topbar-right`},j={class:`ai-tabs`},M=[`onClick`],N={key:0,class:`ai-section`},P={class:`ai-card-filter`},F={class:`ai-card-inner`},I={class:`ai-card-front`},L={class:`ai-card-category`},R={class:`ai-card-en`},z={class:`ai-card-vi`},B={class:`ai-card-def`},V={class:`ai-card-back`},H={class:`ai-card-ex`},U={class:`ai-card-counter`},te={class:`ai-card-controls`},W={key:1,class:`ai-section`},G={key:0,class:`ai-q-config`},K={class:`ai-q-tabs`},q=[`onClick`],J={class:`ai-q-settings`},Y={class:`ai-q-timer-bar`},X={class:`ai-q-timer-text`},Z={class:`ai-q-card`},Q={class:`ai-q-badge`},ne={class:`ai-q-progress`},re={class:`ai-q-question`},ie={class:`ai-q-options`},ae=[`disabled`,`onClick`],oe={class:`ai-q-stats`},se={class:`ai-q-stat-value`},ce={class:`ai-q-stat-value`},le={class:`ai-q-stat-value`},ue={class:`ai-q-stat-value`},de={key:2,class:`ai-section`},fe={class:`ai-lesson-layout`},pe={class:`ai-lesson-sidebar`},$={class:`ai-lesson-list`},me=[`onClick`],he={class:`ai-lesson-stat`},ge={class:`ai-lesson-progress`},_e={class:`progress-track`},ve={class:`ai-lesson-content`},ye={class:`ai-lesson-card`},be=[`innerHTML`];function xe(c,h,ee,g,_,v){let y=e(`CHomeTimer`);return f(),d(`div`,D,[s(`div`,O,[s(`header`,k,[h[12]||=s(`div`,{class:`topbar-left`},[s(`h1`,null,`🤖 Học AI Agent`),s(`p`,null,`Agent — Tools — Token — Quota — AI at Edge`)],-1),s(`div`,A,[p(y),s(`button`,{class:`home-btn`,type:`button`,"aria-label":`Về trang chủ`,title:`Về trang chủ`,onClick:h[0]||=e=>v.handleNavigate(`/`)},`🏠`)])]),s(`nav`,j,[(f(!0),d(o,null,i(_.tabs,e=>(f(),d(`button`,{key:e.id,class:r([`ai-tab`,{active:_.activeTab===e.id}]),onClick:t=>_.activeTab=e.id},n(e.icon)+` `+n(e.label),11,M))),128))]),_.activeTab===`learn`?(f(),d(`section`,N,[s(`div`,P,[l(s(`select`,{"onUpdate:modelValue":h[1]||=e=>v.filterCategory=e},[...h[13]||=[m(`<option value="all" data-v-39e0821a>📂 Tất cả chủ đề</option><option value="agent" data-v-39e0821a>🤖 Agent Fundamentals</option><option value="tools" data-v-39e0821a>🔧 Tools &amp; MCP</option><option value="token" data-v-39e0821a>🔢 Token &amp; Context</option><option value="quota" data-v-39e0821a>⏳ Quota &amp; Cost</option><option value="edge" data-v-39e0821a>📡 AI at Edge</option>`,6)]],512),[[u,v.filterCategory]])]),s(`div`,{class:r([`ai-card`,{flipped:_.isFlipped}]),onClick:h[2]||=e=>_.isFlipped=!_.isFlipped},[s(`div`,F,[s(`div`,I,[s(`span`,L,n(v.currentCard?.category?.toUpperCase()),1),s(`div`,R,n(v.currentCard?.en),1),s(`div`,z,n(v.currentCard?.vi),1),s(`div`,B,n(v.currentCard?.definition),1)]),s(`div`,V,[h[14]||=s(`span`,{class:`ai-card-category`},`VÍ DỤ`,-1),s(`div`,H,n(v.currentCard?.example),1),h[15]||=s(`p`,{class:`flip-hint`},`🔄 Click để xem lại mặt trước`,-1)])])],2),s(`p`,U,n(_.currentIndex+1)+` / `+n(v.filteredCards.length),1),s(`div`,te,[s(`button`,{class:`ai-card-btn`,onClick:h[3]||=(...e)=>v.prevCard&&v.prevCard(...e)},`⬅️ Trước`),s(`button`,{class:`ai-card-btn`,onClick:h[4]||=e=>_.isFlipped=!_.isFlipped},`🔄 Lật`),s(`button`,{class:`ai-card-btn`,onClick:h[5]||=(...e)=>v.nextCard&&v.nextCard(...e)},`Tiếp ➡️`)])])):a(``,!0),_.activeTab===`quiz`?(f(),d(`section`,W,[_.quizStarted?a(``,!0):(f(),d(`div`,G,[s(`div`,K,[(f(!0),d(o,null,i(_.quizCategories,e=>(f(),d(`button`,{key:e.id,class:r([`ai-q-tab`,{active:_.selectedQuizCategory===e.id}]),onClick:t=>_.selectedQuizCategory=e.id},n(e.icon)+` `+n(e.label),11,q))),128))]),s(`div`,J,[l(s(`select`,{"onUpdate:modelValue":h[6]||=e=>_.quizCount=e},[...h[16]||=[s(`option`,{value:`5`},`5 câu`,-1),s(`option`,{value:`10`},`10 câu`,-1),s(`option`,{value:`15`},`15 câu`,-1)]],512),[[u,_.quizCount,void 0,{number:!0}]]),l(s(`select`,{"onUpdate:modelValue":h[7]||=e=>_.quizTime=e},[...h[17]||=[s(`option`,{value:`10`},`10s`,-1),s(`option`,{value:`15`},`15s`,-1),s(`option`,{value:`20`},`20s`,-1),s(`option`,{value:`30`},`30s`,-1)]],512),[[u,_.quizTime,void 0,{number:!0}]]),s(`button`,{class:`ai-q-start`,onClick:h[8]||=(...e)=>v.startQuiz&&v.startQuiz(...e)},`▶️ Bắt đầu`)])])),_.quizStarted&&v.currentQuizQuestion?(f(),d(o,{key:1},[s(`div`,Y,[s(`div`,{class:`ai-q-timer-fill`,style:t({width:_.quizTimeLeft/_.quizTime*100+`%`})},null,4)]),s(`p`,X,n(_.quizTimeLeft)+`s`,1),s(`div`,Z,[s(`span`,Q,n(_.quizCategories.find(e=>e.id===_.selectedQuizCategory)?.label),1),s(`span`,ne,`Câu `+n(_.currentQuestion+1)+` / `+n(_.quizQuestions.length),1),s(`h2`,re,n(v.currentQuizQuestion.question),1),s(`div`,ie,[(f(!0),d(o,null,i(v.currentQuizQuestion.options,(e,t)=>(f(),d(`button`,{key:t,class:r([`ai-q-option`,{selected:_.selectedAnswer===t,correct:_.answered&&t===v.currentQuizQuestion.correct,wrong:_.answered&&_.selectedAnswer===t&&t!==v.currentQuizQuestion.correct}]),disabled:_.answered,onClick:e=>{_.selectedAnswer=t,v.submitQuizAnswer()}},n(e),11,ae))),128))]),_.answered?(f(),d(`div`,{key:0,class:r([`ai-q-feedback`,_.selectedAnswer===v.currentQuizQuestion.correct?`correct`:`wrong`])},n(_.selectedAnswer===v.currentQuizQuestion.correct?`✅ Chính xác!`:`❌ Chưa đúng. Đáp án đúng: `+v.currentQuizQuestion.options[v.currentQuizQuestion.correct]),3)):a(``,!0),_.answered?a(``,!0):(f(),d(`button`,{key:1,class:`ai-q-submit`,onClick:h[9]||=(...e)=>v.submitQuizAnswer&&v.submitQuizAnswer(...e)},`Xác nhận`)),_.answered&&_.currentQuestion<_.quizQuestions.length-1?(f(),d(`button`,{key:2,class:`ai-q-next`,onClick:h[10]||=(...e)=>v.nextQuestion&&v.nextQuestion(...e)},`Câu tiếp theo ➡️`)):a(``,!0),_.answered&&_.currentQuestion===_.quizQuestions.length-1?(f(),d(`button`,{key:3,class:`ai-q-restart`,onClick:h[11]||=(...e)=>v.resetQuiz&&v.resetQuiz(...e)},`🔄 Làm lại`)):a(``,!0)]),s(`div`,oe,[s(`div`,null,[s(`span`,se,n(_.quizScore),1),h[18]||=s(`span`,{class:`ai-q-stat-label`},`Đúng`,-1)]),s(`div`,null,[s(`span`,ce,n(_.quizQuestions.length),1),h[19]||=s(`span`,{class:`ai-q-stat-label`},`Tổng`,-1)]),s(`div`,null,[s(`span`,le,n(v.quizPercent),1),h[20]||=s(`span`,{class:`ai-q-stat-label`},`Tỉ lệ`,-1)]),s(`div`,null,[s(`span`,ue,n(v.quizLevel),1),h[21]||=s(`span`,{class:`ai-q-stat-label`},`Trình độ`,-1)])])],64)):a(``,!0)])):a(``,!0),_.activeTab===`lessons`?(f(),d(`section`,de,[s(`div`,fe,[s(`aside`,pe,[h[22]||=s(`h3`,null,`📚 Bài học`,-1),s(`ul`,$,[(f(!0),d(o,null,i(_.lessons,(e,t)=>(f(),d(`li`,{key:t,class:r([`ai-lesson-item`,{active:_.selectedLesson===t}]),onClick:e=>_.selectedLesson=t},[s(`span`,null,n(e.title?.replace(/^📄 /,``)),1),s(`span`,he,n(v.getLessonProgress(t)),1)],10,me))),128))]),s(`div`,ge,[s(`span`,null,n(v.lessonProgress.done)+` / `+n(v.lessonProgress.total),1),s(`div`,_e,[s(`div`,{class:`progress-fill`,style:t({width:v.lessonProgress.percent+`%`})},null,4)])])]),s(`div`,ve,[s(`div`,ye,[s(`h2`,null,n(_.lessons[_.selectedLesson]?.title),1),s(`div`,{class:`lesson-body`,innerHTML:v.renderedLesson},null,8,be)])])])])):a(``,!0)])])}var Se=c(E,[[`render`,xe],[`__scopeId`,`data-v-39e0821a`]]);export{Se as default};