import{D as e,F as ee,L as t,O as n,S as r,T as i,_ as a,b as o,f as s,g as c,i as l,p as u,w as d,x as f,y as p}from"./index-DeiQdXeD.js";import{t as m}from"./navigate-BTF2NSAJ.js";import{t as h}from"./CodeBlock-D2C4RN7L.js";var g=`// 1. Field injection (không khuyến nghị — khó test)
@Service
...
}`,J={name:`SpringSectionAsync`,components:{CodeBlock:h},data(){return{asyncCode:G,scheduledCode:K,eventCode:q}}},Y={class:`ss-section`};function ae(ee,t,n,i,a,o){let s=e(`CodeBlock`);return d(),p(`div`,Y,[t[0]||=c(`h3`,null,`@Async — chạy nền, không chặn response`,-1),t[1]||=c(`p`,{class:`section-text`},[c(`code`,null,`@Async`),f(` đẩy method chạy vào `),c(`strong`,null,`thread pool riêng`),f(`, trả response ngay lập tức. Áp dụng cho tác vụ chậm không cần đợi kết quả: gửi email welcome, gọi webhook, xử lý file. `),c(`strong`,null,`Bẫy phổ biến:`),f(` gọi @Async method từ bên trong cùng class sẽ không có tác dụng (proxy không đi qua).`)],-1),r(s,{code:a.asyncCode,language:`java`},null,8,[`code`]),t[2]||=c(`h3`,null,`@Scheduled — chạy tự động theo lịch`,-1),t[3]||=c(`p`,{class:`section-text`},[f(`Tác vụ định kỳ như dọn dữ liệu cũ, gửi báo cáo, chạy backup. Cron `),c(`code`,null,`0 0 2 * * ?`),f(` = mỗi ngày lúc 2h sáng. Khi chạy nhiều instance, cần khóa phân tán (ShedLock, Quartz) để tránh `),c(`strong`,null,`nhiều instance chạy cùng lúc`),f(`.`)],-1),r(s,{code:a.scheduledCode,language:`java`},null,8,[`code`]),t[4]||=c(`h3`,null,`@EventListener — tách rời các module`,-1),t[5]||=c(`p`,{class:`section-text`},[f(`Publisher `),c(`strong`,null,`phát event`),f(`, listener `),c(`strong`,null,`lắng nghe và xử lý`),f(` — hai module không biết về nhau. VD: UserService tạo user xong phát `),c(`code`,null,`UserCreatedEvent`),f(`, module email/notification tự phản ứng. Kết hợp `),c(`code`,null,`@Async`),f(` để không làm chậm luồng chính. Đây là nền tảng của kiến trúc `),c(`strong`,null,`event-driven`),f(`.`)],-1),r(s,{code:a.eventCode,language:`java`},null,8,[`code`])])}var X=l(J,[[`render`,ae],[`__scopeId`,`data-v-0200952d`]]),oe=`@ExtendWith(MockitoExtension.class)
...
}`,ce={name:`SpringSectionTest`,components:{CodeBlock:h},data(){return{unitTestCode:oe,integrationTestCode:se}}},le={class:`ss-section`};function ue(ee,t,n,i,a,s){let l=e(`CodeBlock`);return d(),p(`div`,le,[t[0]||=o(`<h3 data-v-d45a1664>Các loại test — kiểm tra ở đúng tầng</h3><div class="cards-grid cols-4" data-v-d45a1664><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Unit Test</h4><p data-v-d45a1664>Test 1 class độc lập, mock dependencies. Nhanh nhất, chạy mỗi lần commit. @ExtendWith(MockitoExtension.class).</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Integration Test</h4><p data-v-d45a1664>Test tầng repository với DB thật. @DataJpaTest + Testcontainers.</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Web Layer Test</h4><p data-v-d45a1664>@WebMvcTest — chỉ tầng controller, mock service — test HTTP + JSON serialize.</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Full Integration</h4><p data-v-d45a1664>@SpringBootTest + Testcontainers — test từ controller đến DB. Chậm nhất, chạy trước khi release.</p></div></div><p class="section-text" data-v-d45a1664><strong data-v-d45a1664>Chiến lược thực tế:</strong> đa số là unit test (nhanh, rẻ), vài integration test cho repository/controller, số ít full flow. Kim tự tháp test — càng lên cao càng ít, càng xuống dưới càng nhiều.</p><h3 data-v-d45a1664>Unit Test với Mockito — test logic không cần DB</h3><p class="section-text" data-v-d45a1664><code data-v-d45a1664>@Mock</code> tạo &quot;bản sao giả&quot; của dependency (không chạm DB thật), <code data-v-d45a1664>@InjectMocks</code> đưa chúng vào class cần test. Kiểm tra: kết quả trả về đúng (<code data-v-d45a1664>assertThat</code>) và method được gọi đúng (<code data-v-d45a1664>verify</code>). Chạy trong mili-giây, lặp lại vô tận.</p>`,5),r(l,{code:a.unitTestCode,language:`java`},null,8,[`code`]),t[1]||=c(`h3`,null,`Integration Test với Testcontainers — DB thật nhưng tạm thời`,-1),t[2]||=c(`p`,{class:`section-text`},[c(`strong`,null,`Testcontainers`),f(` khởi động PostgreSQL thật trong Docker cho mỗi lần test — dữ liệu sạch, không phụ thuộc máy dev, không ô nhiễm DB thật. Bắt được lỗi mà mock bỏ sót: SQL sai, mapping Entity lệch schema, constraint vi phạm.`)],-1),r(l,{code:a.integrationTestCode,language:`java`},null,8,[`code`])])}var Z=l(ce,[[`render`,ue],[`__scopeId`,`data-v-d45a1664`]]),de=`// Service Registry (Eureka Server)
