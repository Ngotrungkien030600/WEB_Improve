import{$ as e,F as t,G as n,H as r,I as i,K as a,L as o,M as s,N as c,O as l,R as u,U as d,k as f,tt as p,y as m}from"./index-BcKf1x_1.js";import{n as h}from"./navigate-DQ42X3KF.js";import{t as g}from"./CodeBlock-CXBq-1YT.js";var ee=`// 1. Field injection (không khuyến nghị — khó test)
@Service
...
}`,ie=`public record UserCreateRequest(
...
}`,k={name:`SpringSectionJpa`,components:{CodeBlock:g},data(){return{entityCode:E,repositoryCode:D,n1Code:O}}},A={class:`ss-section`};function j(e,a,c,l,d,f){let p=n(`CodeBlock`);return r(),t(`div`,A,[a[0]||=s(`h3`,null,`Entity & Relationships — ánh xạ bảng DB thành object`,-1),a[1]||=s(`p`,{class:`section-text`},[s(`code`,null,`@Entity`),o(` đánh dấu class ánh xạ tới 1 bảng, mỗi field là 1 cột. Quan hệ quan trọng nhất: `),s(`code`,null,`@OneToMany`),o(` (1 user → nhiều order) và `),s(`code`,null,`@ManyToMany`),o(` (user ↔ role) qua bảng trung gian `),s(`code`,null,`user_roles`),o(`. Chọn đúng quan hệ + cascade quyết định cách Hibernate sinh SQL và quản lý dữ liệu liên quan.`)],-1),u(p,{code:d.entityCode,language:`java`},null,8,[`code`]),a[2]||=s(`h3`,null,`Repository — Spring Data JPA sinh sẵn query`,-1),a[3]||=s(`p`,{class:`section-text`},[s(`code`,null,`JpaRepository`),o(` cung cấp sẵn CRUD + paging (findAll, save, findById...). Chỉ cần `),s(`strong`,null,`khai báo method theo quy ước tên`),o(` (`),s(`code`,null,`findByEmail`),o(`) Spring tự implement. `),s(`code`,null,`@Query`),o(` dùng khi cần JPQL tùy biến — kèm `),s(`code`,null,`@Modifying`),o(` cho lệnh UPDATE/DELETE.`)],-1),u(p,{code:d.repositoryCode,language:`java`},null,8,[`code`]),a[4]||=i(`<h3 data-v-1a64ab5a>N+1 Problem — cái bẫy hiệu năng kinh điển</h3><p class="section-text" data-v-1a64ab5a><strong data-v-1a64ab5a>N+1</strong>: lấy danh sách N record, rồi mỗi record lại query thêm quan hệ → tổng <strong data-v-1a64ab5a>N+1 queries</strong> thay vì 1. Gây chậm rõ rệt khi dữ liệu lớn (1000 users → 1001 queries). Đây là lỗi hiệu năng phổ biến nhất khi dùng JPA, thường bị phát hiện muộn ở production.</p><div class="cards-grid cols-2" data-v-1a64ab5a><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Fix 1: JOIN FETCH</h4><p data-v-1a64ab5a>Gộp 1 query lấy luôn dữ liệu quan hệ. Hiệu quả cho truy vấn cố định.</p></div><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Fix 2: @EntityGraph</h4><p data-v-1a64ab5a>Khai báo eager load các quan hệ theo tên — tái sử dụng được với nhiều query.</p></div><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Fix 3: @BatchSize</h4><p data-v-1a64ab5a>Gom N quan hệ vào 1 query IN (...). Giảm số query mà không phải sửa từng truy vấn.</p></div><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Kiểm tra thực tế</h4><p data-v-1a64ab5a>Bật <code data-v-1a64ab5a>spring.jpa.show-sql</code> hoặc Hibernate Stats khi test — đếm số query phát sinh, bắt N+1 trước khi lên production.</p></div></div>`,3),u(p,{code:d.n1Code,language:`java`},null,8,[`code`])])}var M=m(k,[[`render`,j],[`__scopeId`,`data-v-1a64ab5a`]]),N=`@Configuration
@EnableWebSecurity
...
}`,J={name:`SpringSectionAsync`,components:{CodeBlock:g},data(){return{asyncCode:G,scheduledCode:K,eventCode:q}}},Y={class:`ss-section`};function ae(e,i,a,c,l,d){let f=n(`CodeBlock`);return r(),t(`div`,Y,[i[0]||=s(`h3`,null,`@Async — chạy nền, không chặn response`,-1),i[1]||=s(`p`,{class:`section-text`},[s(`code`,null,`@Async`),o(` đẩy method chạy vào `),s(`strong`,null,`thread pool riêng`),o(`, trả response ngay lập tức. Áp dụng cho tác vụ chậm không cần đợi kết quả: gửi email welcome, gọi webhook, xử lý file. `),s(`strong`,null,`Bẫy phổ biến:`),o(` gọi @Async method từ bên trong cùng class sẽ không có tác dụng (proxy không đi qua).`)],-1),u(f,{code:l.asyncCode,language:`java`},null,8,[`code`]),i[2]||=s(`h3`,null,`@Scheduled — chạy tự động theo lịch`,-1),i[3]||=s(`p`,{class:`section-text`},[o(`Tác vụ định kỳ như dọn dữ liệu cũ, gửi báo cáo, chạy backup. Cron `),s(`code`,null,`0 0 2 * * ?`),o(` = mỗi ngày lúc 2h sáng. Khi chạy nhiều instance, cần khóa phân tán (ShedLock, Quartz) để tránh `),s(`strong`,null,`nhiều instance chạy cùng lúc`),o(`.`)],-1),u(f,{code:l.scheduledCode,language:`java`},null,8,[`code`]),i[4]||=s(`h3`,null,`@EventListener — tách rời các module`,-1),i[5]||=s(`p`,{class:`section-text`},[o(`Publisher `),s(`strong`,null,`phát event`),o(`, listener `),s(`strong`,null,`lắng nghe và xử lý`),o(` — hai module không biết về nhau. VD: UserService tạo user xong phát `),s(`code`,null,`UserCreatedEvent`),o(`, module email/notification tự phản ứng. Kết hợp `),s(`code`,null,`@Async`),o(` để không làm chậm luồng chính. Đây là nền tảng của kiến trúc `),s(`strong`,null,`event-driven`),o(`.`)],-1),u(f,{code:l.eventCode,language:`java`},null,8,[`code`])])}var X=m(J,[[`render`,ae],[`__scopeId`,`data-v-0200952d`]]),oe=`@ExtendWith(MockitoExtension.class)
...
}`,ce={name:`SpringSectionTest`,components:{CodeBlock:g},data(){return{unitTestCode:oe,integrationTestCode:se}}},le={class:`ss-section`};function ue(e,a,c,l,d,f){let p=n(`CodeBlock`);return r(),t(`div`,le,[a[0]||=i(`<h3 data-v-d45a1664>Các loại test — kiểm tra ở đúng tầng</h3><div class="cards-grid cols-4" data-v-d45a1664><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Unit Test</h4><p data-v-d45a1664>Test 1 class độc lập, mock dependencies. Nhanh nhất, chạy mỗi lần commit. @ExtendWith(MockitoExtension.class).</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Integration Test</h4><p data-v-d45a1664>Test tầng repository với DB thật. @DataJpaTest + Testcontainers.</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Web Layer Test</h4><p data-v-d45a1664>@WebMvcTest — chỉ tầng controller, mock service — test HTTP + JSON serialize.</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Full Integration</h4><p data-v-d45a1664>@SpringBootTest + Testcontainers — test từ controller đến DB. Chậm nhất, chạy trước khi release.</p></div></div><p class="section-text" data-v-d45a1664><strong data-v-d45a1664>Chiến lược thực tế:</strong> đa số là unit test (nhanh, rẻ), vài integration test cho repository/controller, số ít full flow. Kim tự tháp test — càng lên cao càng ít, càng xuống dưới càng nhiều.</p><h3 data-v-d45a1664>Unit Test với Mockito — test logic không cần DB</h3><p class="section-text" data-v-d45a1664><code data-v-d45a1664>@Mock</code> tạo &quot;bản sao giả&quot; của dependency (không chạm DB thật), <code data-v-d45a1664>@InjectMocks</code> đưa chúng vào class cần test. Kiểm tra: kết quả trả về đúng (<code data-v-d45a1664>assertThat</code>) và method được gọi đúng (<code data-v-d45a1664>verify</code>). Chạy trong mili-giây, lặp lại vô tận.</p>`,5),u(p,{code:d.unitTestCode,language:`java`},null,8,[`code`]),a[1]||=s(`h3`,null,`Integration Test với Testcontainers — DB thật nhưng tạm thời`,-1),a[2]||=s(`p`,{class:`section-text`},[s(`strong`,null,`Testcontainers`),o(` khởi động PostgreSQL thật trong Docker cho mỗi lần test — dữ liệu sạch, không phụ thuộc máy dev, không ô nhiễm DB thật. Bắt được lỗi mà mock bỏ sót: SQL sai, mapping Entity lệch schema, constraint vi phạm.`)],-1),u(p,{code:d.integrationTestCode,language:`java`},null,8,[`code`])])}var Z=m(ce,[[`render`,ue],[`__scopeId`,`data-v-d45a1664`]]),de=`// Service Registry (Eureka Server)
...
spring:
  config:
    import: configserver:http://localhost:8888`,me={name:`SpringSectionCloud`,components:{CodeBlock:g},data(){return{eurekaCode:de,gatewayCode:fe,configCode:pe}}},he={class:`ss-section`};function ge(e,a,c,l,d,f){let p=n(`CodeBlock`);return r(),t(`div`,he,[a[0]||=s(`h3`,null,`Service Discovery (Eureka) — các service tìm nhau thế nào?`,-1),a[1]||=s(`p`,{class:`section-text`},[o(`Trong microservices, service chạy ở nhiều instance với IP thay đổi liên tục (scale, deploy). `),s(`strong`,null,`Eureka Server`),o(` là "danh bạ" — mỗi service tự đăng ký (địa chỉ + port) khi khởi động, service khác tra danh bạ để gọi. Không có nó, phải hardcode địa chỉ — vỡ ngay khi scale.`)],-1),u(p,{code:d.eurekaCode,language:`java`},null,8,[`code`]),a[2]||=i(`<h3 data-v-e14e73f1>API Gateway — cửa ngõ duy nhất vào hệ thống</h3><p class="section-text" data-v-e14e73f1><strong data-v-e14e73f1>Gateway</strong> đứng trước mọi service: định tuyến (<code data-v-e14e73f1>/api/users/**</code> → user-service), xác thực, rate limiting, circuit breaker. Client chỉ gọi 1 địa chỉ, không cần biết hệ thống bên trong có bao nhiêu service. <code data-v-e14e73f1>lb://user-service</code> = load balancing qua Eureka.</p><div class="cards-grid cols-2" data-v-e14e73f1><div class="info-card" data-v-e14e73f1><h4 data-v-e14e73f1>Circuit Breaker</h4><p data-v-e14e73f1>Service con chết/đứng → gateway chuyển sang fallback thay vì giữ request chờ — ngăn lỗi leo thang lan cả hệ thống.</p></div><div class="info-card" data-v-e14e73f1><h4 data-v-e14e73f1>Lợi ích thực tế</h4><p data-v-e14e73f1>1 điểm duy nhất để áp security, CORS, logging, monitoring — thay vì lặp ở từng service.</p></div></div>`,3),u(p,{code:d.gatewayCode,language:`java`},null,8,[`code`]),a[3]||=s(`h3`,null,`Spring Cloud Config — cấu hình tập trung`,-1),a[4]||=s(`p`,{class:`section-text`},[o(`Cấu hình (DB url, secret, feature flag) nằm ở `),s(`strong`,null,`1 nơi duy nhất`),o(`, các service pull về khi khởi động. Đổi config không cần sửa code + deploy từng service — chỉ sửa ở Config Server rồi refresh. Tránh tình trạng config nằm rải rác, khác nhau giữa các service.`)],-1),u(p,{code:d.configCode,language:`yaml`},null,8,[`code`]),a[5]||=i(`<h3 data-v-e14e73f1>Best Practices Checklist</h3><ul class="tips-list" data-v-e14e73f1><li data-v-e14e73f1><strong data-v-e14e73f1>Package structure:</strong> controller → service → repository → entity/dto</li><li data-v-e14e73f1><strong data-v-e14e73f1>DTO riêng:</strong> không expose entity ra ngoài</li><li data-v-e14e73f1><strong data-v-e14e73f1>Exception handling:</strong> Global exception handler</li><li data-v-e14e73f1><strong data-v-e14e73f1>Logging:</strong> SLF4J + MDC (traceId, userId)</li><li data-v-e14e73f1><strong data-v-e14e73f1>Transaction:</strong> @Transactional trên service layer</li><li data-v-e14e73f1><strong data-v-e14e73f1>Security:</strong> JWT + HTTPS, không hardcode secret</li><li data-v-e14e73f1><strong data-v-e14e73f1>Monitoring:</strong> Actuator + Micrometer + Prometheus</li></ul>`,2)])}var Q=m(me,[[`render`,ge],[`__scopeId`,`data-v-e14e73f1`]]),_e=[{id:`core`,num:`01`,title:`IoC & Dependency Injection`,component:x},{id:`web`,num:`02`,title:`Spring MVC & REST API`,component:T},{id:`jpa`,num:`03`,title:`JPA & Hibernate`,component:M},{id:`security`,num:`04`,title:`Spring Security & JWT`,component:z},{id:`boot`,num:`05`,title:`Auto-config & Actuator`,component:W},{id:`async`,num:`06`,title:`Async & Scheduling`,component:X},{id:`test`,num:`07`,title:`Testing`,component:Z},{id:`cloud`,num:`08`,title:`Spring Cloud & Microservices`,component:Q}],ve={name:`SpringSectionPage`,components:{SectionCore:x,SectionWeb:T,SectionJpa:M,SectionSecurity:z,SectionBoot:W,SectionAsync:X,SectionTest:Z,SectionCloud:Q},data(){return{sections:_e}},computed:{currentId(){return this.$route.params.sectionId},current(){return this.sections.find(e=>e.id===this.currentId)||null},currentComponent(){return this.current?this.current.component:null},currentTitle(){return this.current?this.current.title:``},currentNum(){return this.current?this.current.num:``},currentIndex(){return this.sections.findIndex(e=>e.id===this.currentId)},prev(){let e=this.currentIndex;return e>0?this.sections[e-1]:null},next(){let e=this.currentIndex;return e>=0&&e<this.sections.length-1?this.sections[e+1]:null},prevTitle(){return this.prev?this.prev.title:``},nextTitle(){return this.next?this.next.title:``}},mounted(){this.ensureValid()},watch:{"$route.params.sectionId"(){this.ensureValid()}},methods:{ensureValid(){this.current?window.scrollTo({top:0,behavior:`smooth`}):h(`/java/spring-boot/core`,{target:`router`})},handleNav(e){h(e)},goTo(e){h(`/java/spring-boot/${e}`,{target:`router`})}}},ye={class:`spring-section-page`},be={class:`page-header`},xe={class:`header-content`},Se={class:`header-nav`},Ce={class:`page-content`},we={class:`sidebar-toc`},Te={class:`toc-container`},Ee={class:`toc-nav`},De=[`onClick`],$={class:`toc-num`},Oe={class:`toc-text`},ke={class:`main-content`},Ae={class:`content-section`},je={class:`section-header`},Me={class:`section-num`},Ne={class:`section-title`},Pe={class:`section-body`},Fe={class:`pager`},Ie=[`disabled`],Le=[`disabled`];function Re(n,i,o,u,m,h){return r(),t(`div`,ye,[s(`header`,be,[s(`div`,xe,[s(`div`,Se,[s(`button`,{class:`nav-btn`,onClick:i[0]||=e=>h.handleNav(`/java/hub`)},[...i[4]||=[s(`span`,null,`←`,-1),s(`span`,null,`Java`,-1)]]),s(`button`,{class:`nav-btn`,onClick:i[1]||=e=>h.handleNav(`/`)},[...i[5]||=[s(`span`,null,`🏠`,-1),s(`span`,null,`Trang chủ`,-1)]])]),i[6]||=s(`div`,{class:`header-title`},[s(`h1`,null,`🍃 Spring Boot`),s(`p`,{class:`desc`},`Từ IoC/DI đến Microservices — code mẫu, kiến trúc, best practices`)],-1)])]),s(`div`,Ce,[s(`aside`,we,[s(`div`,Te,[i[7]||=s(`h3`,{class:`toc-title`},`Các bài học`,-1),s(`nav`,Ee,[(r(!0),t(f,null,d(m.sections,n=>(r(),t(`a`,{key:n.id,href:`#`,class:e([`toc-link`,{active:n.id===h.currentId}]),onClick:l(e=>h.goTo(n.id),[`prevent`])},[s(`span`,$,p(n.num)+`.`,1),s(`span`,Oe,p(n.title),1)],10,De))),128))])])]),s(`main`,ke,[s(`section`,Ae,[s(`div`,je,[s(`span`,Me,p(h.currentNum),1),s(`h2`,Ne,p(h.currentTitle),1)]),s(`div`,Pe,[(r(),c(a(h.currentComponent)))])]),s(`div`,Fe,[s(`button`,{class:`pager-btn`,disabled:!h.prev,onClick:i[2]||=e=>h.goTo(h.prev.id)},` ← `+p(h.prevTitle),9,Ie),s(`button`,{class:`pager-btn next`,disabled:!h.next,onClick:i[3]||=e=>h.goTo(h.next.id)},p(h.nextTitle)+` → `,9,Le)])])])])}var ze=m(ve,[[`render`,Re],[`__scopeId`,`data-v-2be5286a`]]);export{ze as default};