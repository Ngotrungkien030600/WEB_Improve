import{A as e,D as t,E as n,F as r,H as i,I as a,N as o,P as s,R as c,V as l,Y as u,Z as d,_ as f,j as p,z as ee}from"./index-CaZw3_YQ.js";import{n as m}from"./navigate-CdhFtmit.js";import{t as h}from"./CodeBlock-sleLze8a.js";var g=`// 1. Field injection (không khuyến nghị — khó test)
@Service
...
}`,k={name:`SpringSectionJpa`,components:{CodeBlock:h},data(){return{entityCode:E,repositoryCode:D,n1Code:O}}},A={class:`ss-section`};function j(t,n,i,u,d,f){let p=l(`CodeBlock`);return c(),o(`div`,A,[n[0]||=e(`h3`,null,`Entity & Relationships — ánh xạ bảng DB thành object`,-1),n[1]||=e(`p`,{class:`section-text`},[e(`code`,null,`@Entity`),r(` đánh dấu class ánh xạ tới 1 bảng, mỗi field là 1 cột. Quan hệ quan trọng nhất: `),e(`code`,null,`@OneToMany`),r(` (1 user → nhiều order) và `),e(`code`,null,`@ManyToMany`),r(` (user ↔ role) qua bảng trung gian `),e(`code`,null,`user_roles`),r(`. Chọn đúng quan hệ + cascade quyết định cách Hibernate sinh SQL và quản lý dữ liệu liên quan.`)],-1),a(p,{code:d.entityCode,language:`java`},null,8,[`code`]),n[2]||=e(`h3`,null,`Repository — Spring Data JPA sinh sẵn query`,-1),n[3]||=e(`p`,{class:`section-text`},[e(`code`,null,`JpaRepository`),r(` cung cấp sẵn CRUD + paging (findAll, save, findById...). Chỉ cần `),e(`strong`,null,`khai báo method theo quy ước tên`),r(` (`),e(`code`,null,`findByEmail`),r(`) Spring tự implement. `),e(`code`,null,`@Query`),r(` dùng khi cần JPQL tùy biến — kèm `),e(`code`,null,`@Modifying`),r(` cho lệnh UPDATE/DELETE.`)],-1),a(p,{code:d.repositoryCode,language:`java`},null,8,[`code`]),n[4]||=s(`<h3 data-v-1a64ab5a>N+1 Problem — cái bẫy hiệu năng kinh điển</h3><p class="section-text" data-v-1a64ab5a><strong data-v-1a64ab5a>N+1</strong>: lấy danh sách N record, rồi mỗi record lại query thêm quan hệ → tổng <strong data-v-1a64ab5a>N+1 queries</strong> thay vì 1. Gây chậm rõ rệt khi dữ liệu lớn (1000 users → 1001 queries). Đây là lỗi hiệu năng phổ biến nhất khi dùng JPA, thường bị phát hiện muộn ở production.</p><div class="cards-grid cols-2" data-v-1a64ab5a><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Fix 1: JOIN FETCH</h4><p data-v-1a64ab5a>Gộp 1 query lấy luôn dữ liệu quan hệ. Hiệu quả cho truy vấn cố định.</p></div><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Fix 2: @EntityGraph</h4><p data-v-1a64ab5a>Khai báo eager load các quan hệ theo tên — tái sử dụng được với nhiều query.</p></div><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Fix 3: @BatchSize</h4><p data-v-1a64ab5a>Gom N quan hệ vào 1 query IN (...). Giảm số query mà không phải sửa từng truy vấn.</p></div><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Kiểm tra thực tế</h4><p data-v-1a64ab5a>Bật <code data-v-1a64ab5a>spring.jpa.show-sql</code> hoặc Hibernate Stats khi test — đếm số query phát sinh, bắt N+1 trước khi lên production.</p></div></div>`,3),a(p,{code:d.n1Code,language:`java`},null,8,[`code`])])}var M=f(k,[[`render`,j],[`__scopeId`,`data-v-1a64ab5a`]]),N=`@Configuration
@EnableWebSecurity
...
}`,J={name:`SpringSectionAsync`,components:{CodeBlock:h},data(){return{asyncCode:G,scheduledCode:K,eventCode:q}}},Y={class:`ss-section`};function ae(t,n,i,s,u,d){let f=l(`CodeBlock`);return c(),o(`div`,Y,[n[0]||=e(`h3`,null,`@Async — chạy nền, không chặn response`,-1),n[1]||=e(`p`,{class:`section-text`},[e(`code`,null,`@Async`),r(` đẩy method chạy vào `),e(`strong`,null,`thread pool riêng`),r(`, trả response ngay lập tức. Áp dụng cho tác vụ chậm không cần đợi kết quả: gửi email welcome, gọi webhook, xử lý file. `),e(`strong`,null,`Bẫy phổ biến:`),r(` gọi @Async method từ bên trong cùng class sẽ không có tác dụng (proxy không đi qua).`)],-1),a(f,{code:u.asyncCode,language:`java`},null,8,[`code`]),n[2]||=e(`h3`,null,`@Scheduled — chạy tự động theo lịch`,-1),n[3]||=e(`p`,{class:`section-text`},[r(`Tác vụ định kỳ như dọn dữ liệu cũ, gửi báo cáo, chạy backup. Cron `),e(`code`,null,`0 0 2 * * ?`),r(` = mỗi ngày lúc 2h sáng. Khi chạy nhiều instance, cần khóa phân tán (ShedLock, Quartz) để tránh `),e(`strong`,null,`nhiều instance chạy cùng lúc`),r(`.`)],-1),a(f,{code:u.scheduledCode,language:`java`},null,8,[`code`]),n[4]||=e(`h3`,null,`@EventListener — tách rời các module`,-1),n[5]||=e(`p`,{class:`section-text`},[r(`Publisher `),e(`strong`,null,`phát event`),r(`, listener `),e(`strong`,null,`lắng nghe và xử lý`),r(` — hai module không biết về nhau. VD: UserService tạo user xong phát `),e(`code`,null,`UserCreatedEvent`),r(`, module email/notification tự phản ứng. Kết hợp `),e(`code`,null,`@Async`),r(` để không làm chậm luồng chính. Đây là nền tảng của kiến trúc `),e(`strong`,null,`event-driven`),r(`.`)],-1),a(f,{code:u.eventCode,language:`java`},null,8,[`code`])])}var X=f(J,[[`render`,ae],[`__scopeId`,`data-v-0200952d`]]),oe=`@ExtendWith(MockitoExtension.class)
...
}`,ce={name:`SpringSectionTest`,components:{CodeBlock:h},data(){return{unitTestCode:oe,integrationTestCode:se}}},le={class:`ss-section`};function ue(t,n,i,u,d,f){let p=l(`CodeBlock`);return c(),o(`div`,le,[n[0]||=s(`<h3 data-v-d45a1664>Các loại test — kiểm tra ở đúng tầng</h3><div class="cards-grid cols-4" data-v-d45a1664><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Unit Test</h4><p data-v-d45a1664>Test 1 class độc lập, mock dependencies. Nhanh nhất, chạy mỗi lần commit. @ExtendWith(MockitoExtension.class).</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Integration Test</h4><p data-v-d45a1664>Test tầng repository với DB thật. @DataJpaTest + Testcontainers.</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Web Layer Test</h4><p data-v-d45a1664>@WebMvcTest — chỉ tầng controller, mock service — test HTTP + JSON serialize.</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Full Integration</h4><p data-v-d45a1664>@SpringBootTest + Testcontainers — test từ controller đến DB. Chậm nhất, chạy trước khi release.</p></div></div><p class="section-text" data-v-d45a1664><strong data-v-d45a1664>Chiến lược thực tế:</strong> đa số là unit test (nhanh, rẻ), vài integration test cho repository/controller, số ít full flow. Kim tự tháp test — càng lên cao càng ít, càng xuống dưới càng nhiều.</p><h3 data-v-d45a1664>Unit Test với Mockito — test logic không cần DB</h3><p class="section-text" data-v-d45a1664><code data-v-d45a1664>@Mock</code> tạo &quot;bản sao giả&quot; của dependency (không chạm DB thật), <code data-v-d45a1664>@InjectMocks</code> đưa chúng vào class cần test. Kiểm tra: kết quả trả về đúng (<code data-v-d45a1664>assertThat</code>) và method được gọi đúng (<code data-v-d45a1664>verify</code>). Chạy trong mili-giây, lặp lại vô tận.</p>`,5),a(p,{code:d.unitTestCode,language:`java`},null,8,[`code`]),n[1]||=e(`h3`,null,`Integration Test với Testcontainers — DB thật nhưng tạm thời`,-1),n[2]||=e(`p`,{class:`section-text`},[e(`strong`,null,`Testcontainers`),r(` khởi động PostgreSQL thật trong Docker cho mỗi lần test — dữ liệu sạch, không phụ thuộc máy dev, không ô nhiễm DB thật. Bắt được lỗi mà mock bỏ sót: SQL sai, mapping Entity lệch schema, constraint vi phạm.`)],-1),a(p,{code:d.integrationTestCode,language:`java`},null,8,[`code`])])}var Z=f(ce,[[`render`,ue],[`__scopeId`,`data-v-d45a1664`]]),de=`// Service Registry (Eureka Server)
...
spring:
  config:
    import: configserver:http://localhost:8888`,me={name:`SpringSectionCloud`,components:{CodeBlock:h},data(){return{eurekaCode:de,gatewayCode:fe,configCode:pe}}},he={class:`ss-section`};function ge(t,n,i,u,d,f){let p=l(`CodeBlock`);return c(),o(`div`,he,[n[0]||=e(`h3`,null,`Service Discovery (Eureka) — các service tìm nhau thế nào?`,-1),n[1]||=e(`p`,{class:`section-text`},[r(`Trong microservices, service chạy ở nhiều instance với IP thay đổi liên tục (scale, deploy). `),e(`strong`,null,`Eureka Server`),r(` là "danh bạ" — mỗi service tự đăng ký (địa chỉ + port) khi khởi động, service khác tra danh bạ để gọi. Không có nó, phải hardcode địa chỉ — vỡ ngay khi scale.`)],-1),a(p,{code:d.eurekaCode,language:`java`},null,8,[`code`]),n[2]||=s(`<h3 data-v-e14e73f1>API Gateway — cửa ngõ duy nhất vào hệ thống</h3><p class="section-text" data-v-e14e73f1><strong data-v-e14e73f1>Gateway</strong> đứng trước mọi service: định tuyến (<code data-v-e14e73f1>/api/users/**</code> → user-service), xác thực, rate limiting, circuit breaker. Client chỉ gọi 1 địa chỉ, không cần biết hệ thống bên trong có bao nhiêu service. <code data-v-e14e73f1>lb://user-service</code> = load balancing qua Eureka.</p><div class="cards-grid cols-2" data-v-e14e73f1><div class="info-card" data-v-e14e73f1><h4 data-v-e14e73f1>Circuit Breaker</h4><p data-v-e14e73f1>Service con chết/đứng → gateway chuyển sang fallback thay vì giữ request chờ — ngăn lỗi leo thang lan cả hệ thống.</p></div><div class="info-card" data-v-e14e73f1><h4 data-v-e14e73f1>Lợi ích thực tế</h4><p data-v-e14e73f1>1 điểm duy nhất để áp security, CORS, logging, monitoring — thay vì lặp ở từng service.</p></div></div>`,3),a(p,{code:d.gatewayCode,language:`java`},null,8,[`code`]),n[3]||=e(`h3`,null,`Spring Cloud Config — cấu hình tập trung`,-1),n[4]||=e(`p`,{class:`section-text`},[r(`Cấu hình (DB url, secret, feature flag) nằm ở `),e(`strong`,null,`1 nơi duy nhất`),r(`, các service pull về khi khởi động. Đổi config không cần sửa code + deploy từng service — chỉ sửa ở Config Server rồi refresh. Tránh tình trạng config nằm rải rác, khác nhau giữa các service.`)],-1),a(p,{code:d.configCode,language:`yaml`},null,8,[`code`]),n[5]||=s(`<h3 data-v-e14e73f1>Best Practices Checklist</h3><ul class="tips-list" data-v-e14e73f1><li data-v-e14e73f1><strong data-v-e14e73f1>Package structure:</strong> controller → service → repository → entity/dto</li><li data-v-e14e73f1><strong data-v-e14e73f1>DTO riêng:</strong> không expose entity ra ngoài</li><li data-v-e14e73f1><strong data-v-e14e73f1>Exception handling:</strong> Global exception handler</li><li data-v-e14e73f1><strong data-v-e14e73f1>Logging:</strong> SLF4J + MDC (traceId, userId)</li><li data-v-e14e73f1><strong data-v-e14e73f1>Transaction:</strong> @Transactional trên service layer</li><li data-v-e14e73f1><strong data-v-e14e73f1>Security:</strong> JWT + HTTPS, không hardcode secret</li><li data-v-e14e73f1><strong data-v-e14e73f1>Monitoring:</strong> Actuator + Micrometer + Prometheus</li></ul>`,2)])}var Q=f(me,[[`render`,ge],[`__scopeId`,`data-v-e14e73f1`]]),_e=[{id:`core`,num:`01`,title:`IoC & Dependency Injection`,component:b},{id:`web`,num:`02`,title:`Spring MVC & REST API`,component:T},{id:`jpa`,num:`03`,title:`JPA & Hibernate`,component:M},{id:`security`,num:`04`,title:`Spring Security & JWT`,component:z},{id:`boot`,num:`05`,title:`Auto-config & Actuator`,component:W},{id:`async`,num:`06`,title:`Async & Scheduling`,component:X},{id:`test`,num:`07`,title:`Testing`,component:Z},{id:`cloud`,num:`08`,title:`Spring Cloud & Microservices`,component:Q}],ve={name:`SpringSectionPage`,components:{SectionCore:b,SectionWeb:T,SectionJpa:M,SectionSecurity:z,SectionBoot:W,SectionAsync:X,SectionTest:Z,SectionCloud:Q},data(){return{sections:_e}},computed:{currentId(){return this.$route.params.sectionId},current(){return this.sections.find(e=>e.id===this.currentId)||null},currentComponent(){return this.current?this.current.component:null},currentTitle(){return this.current?this.current.title:``},currentNum(){return this.current?this.current.num:``},currentIndex(){return this.sections.findIndex(e=>e.id===this.currentId)},prev(){let e=this.currentIndex;return e>0?this.sections[e-1]:null},next(){let e=this.currentIndex;return e>=0&&e<this.sections.length-1?this.sections[e+1]:null},prevTitle(){return this.prev?this.prev.title:``},nextTitle(){return this.next?this.next.title:``}},mounted(){this.ensureValid()},watch:{"$route.params.sectionId"(){this.ensureValid()}},methods:{ensureValid(){this.current?window.scrollTo({top:0,behavior:`smooth`}):m(`/java/spring-boot/core`,{target:`router`})},handleNav(e){m(e)},goTo(e){m(`/java/spring-boot/${e}`,{target:`router`})}}},ye={class:`spring-section-page`},be={class:`page-header`},xe={class:`header-content`},Se={class:`header-nav`},Ce={class:`page-content`},we={class:`sidebar-toc`},Te={class:`toc-container`},Ee={class:`toc-nav`},De=[`onClick`],$={class:`toc-num`},Oe={class:`toc-text`},ke={class:`main-content`},Ae={class:`content-section`},je={class:`section-header`},Me={class:`section-num`},Ne={class:`section-title`},Pe={class:`section-body`},Fe={class:`pager`},Ie=[`disabled`],Le=[`disabled`];function Re(r,a,s,l,f,m){return c(),o(`div`,ye,[e(`header`,be,[e(`div`,xe,[e(`div`,Se,[e(`button`,{class:`nav-btn`,onClick:a[0]||=e=>m.handleNav(`/java/hub`)},[...a[4]||=[e(`span`,null,`←`,-1),e(`span`,null,`Java`,-1)]]),e(`button`,{class:`nav-btn`,onClick:a[1]||=e=>m.handleNav(`/`)},[...a[5]||=[e(`span`,null,`🏠`,-1),e(`span`,null,`Trang chủ`,-1)]])]),a[6]||=e(`div`,{class:`header-title`},[e(`h1`,null,`🍃 Spring Boot`),e(`p`,{class:`desc`},`Từ IoC/DI đến Microservices — code mẫu, kiến trúc, best practices`)],-1)])]),e(`div`,Ce,[e(`aside`,we,[e(`div`,Te,[a[7]||=e(`h3`,{class:`toc-title`},`Các bài học`,-1),e(`nav`,Ee,[(c(!0),o(t,null,ee(f.sections,t=>(c(),o(`a`,{key:t.id,href:`#`,class:u([`toc-link`,{active:t.id===m.currentId}]),onClick:n(e=>m.goTo(t.id),[`prevent`])},[e(`span`,$,d(t.num)+`.`,1),e(`span`,Oe,d(t.title),1)],10,De))),128))])])]),e(`main`,ke,[e(`section`,Ae,[e(`div`,je,[e(`span`,Me,d(m.currentNum),1),e(`h2`,Ne,d(m.currentTitle),1)]),e(`div`,Pe,[(c(),p(i(m.currentComponent)))])]),e(`div`,Fe,[e(`button`,{class:`pager-btn`,disabled:!m.prev,onClick:a[2]||=e=>m.goTo(m.prev.id)},` ← `+d(m.prevTitle),9,Ie),e(`button`,{class:`pager-btn next`,disabled:!m.next,onClick:a[3]||=e=>m.goTo(m.next.id)},d(m.nextTitle)+` → `,9,Le)])])])])}var ze=f(ve,[[`render`,Re],[`__scopeId`,`data-v-2be5286a`]]);export{ze as default};