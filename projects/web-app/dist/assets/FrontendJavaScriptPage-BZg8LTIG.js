import{d as e,h as t,i as n,v as r,w as i,y as a}from"./index-CX3t5JlV.js";import{t as o}from"./navigate-UokpJLHS.js";var s={name:`FrontendJavaScriptPage`,methods:{handleNav(e){o(e)}}},c={class:`js-page`,style:{"--color-accent":`#f59e0b`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(n,o,s,f,p,m){return i(),r(`div`,c,[t(`div`,l,[t(`div`,u,[o[2]||=t(`h1`,null,`⚡ JavaScript`,-1),t(`div`,d,[t(`a`,{href:`#`,onClick:o[0]||=e(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),t(`a`,{href:`#`,onClick:o[1]||=e(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=a(`<p class="desc" data-v-eeaf1192>ES6+, DOM, Async/Await, Closure, Promise, Event Loop, Web API, TypeScript cơ bản.</p><div class="section" data-v-eeaf1192><h2 data-v-eeaf1192>📦 ES6+ Features</h2><pre data-v-eeaf1192><code data-v-eeaf1192>const add = (a, b) =&gt; a + b;                     // Arrow
...
// Utility: Partial&lt;User&gt;, Pick&lt;User,&#39;id&#39;&gt;, Omit&lt;User,&#39;id&#39;&gt;</code></pre></div>`,9)])])}var p=n(s,[[`render`,f],[`__scopeId`,`data-v-eeaf1192`]]);export{p as default};