import{c as e,d as t,h as n,m as r,n as i,v as a}from"./index-0polZIe7.js";import{t as o}from"./navigate-DpwFjPeS.js";var s={name:`FrontendJavaScriptPage`,methods:{handleNav(e){o(e)}}},c={class:`js-page`,style:{"--color-accent":`#f59e0b`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(i,o,s,f,p,m){return a(),r(`div`,c,[t(`div`,l,[t(`div`,u,[o[2]||=t(`h1`,null,`⚡ JavaScript`,-1),t(`div`,d,[t(`a`,{href:`#`,onClick:o[0]||=e(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),t(`a`,{href:`#`,onClick:o[1]||=e(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=n(`<p class="desc" data-v-eeaf1192>ES6+, DOM, Async/Await, Closure, Promise, Event Loop, Web API, TypeScript cơ bản.</p><div class="section" data-v-eeaf1192><h2 data-v-eeaf1192>📦 ES6+ Features</h2><pre data-v-eeaf1192><code data-v-eeaf1192>const add = (a, b) =&gt; a + b;                     // Arrow
