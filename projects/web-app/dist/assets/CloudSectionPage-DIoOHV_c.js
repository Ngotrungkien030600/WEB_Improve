import{C as e,F as t,N as n,S as r,T as i,_ as a,b as o,d as s,g as c,m as l,n as u}from"./index-CsiU2etc.js";import{n as d}from"./navigate-5oAyLV3p.js";import{t as f}from"./CTopbar-DSWNdWDt.js";var p=[{id:`iam`,title:`1. IAM (Identity & Access Management)`,html:`<h3>IAM là gì?</h3>\r
...
\r
      ...
      <div class="grid-2">\r
        ...
        <div class="card"><h4>🌐 NAT Gateway</h4><p><strong>Outbound</strong> — cho private instances đi ra internet. Không cho ai vào từ ngoài.</p>`}],m={name:`CloudSectionPage`,components:{CTopbar:f},data(){return{cloudSections:p}},computed:{currentId(){return this.$route.params.sectionId},current(){return this.cloudSections.find(e=>e.id===this.currentId)||null},currentIndex(){return this.cloudSections.findIndex(e=>e.id===this.currentId)},prev(){let e=this.currentIndex;return e>0?this.cloudSections[e-1]:null},next(){let e=this.currentIndex;return e>=0&&e<this.cloudSections.length-1?this.cloudSections[e+1]:null},prevTitle(){return this.prev?this.prev.title.replace(/^\d+\.\s*/,``):``},nextTitle(){return this.next?this.next.title.replace(/^\d+\.\s*/,``):``}},mounted(){this.current||d(`/cloud/iam`,{target:`router`})},watch:{"$route.params.sectionId"(){this.current?window.scrollTo({top:0,behavior:`smooth`}):d(`/cloud/iam`,{target:`router`})}},methods:{handleBack(){d(`/cloud`)},goTo(e){d(`/cloud/`+e,{target:`router`})}}},h={class:`cloud-section-page`},g={class:`cs-wrap`},_={class:`cs-nav`},v=[`onClick`],y={key:0,class:`cs-panel`},b={class:`cs-title`},x=[`innerHTML`],S={class:`cs-pager`},C=[`disabled`],w=[`disabled`];function T(u,d,f,p,m,T){let E=i(`CTopbar`);return r(),a(`div`,h,[l(`div`,g,[o(E,{title:`☁️ AWS Cloud`,"back-label":`AWS Cloud`,onGoHome:T.handleBack},null,8,[`onGoHome`]),l(`div`,_,[(r(!0),a(s,null,e(m.cloudSections,(e,i)=>(r(),a(`button`,{key:e.id,class:n([`cs-nav-item`,{active:e.id===T.currentId}]),onClick:t=>T.goTo(e.id)},t(i+1),11,v))),128))]),T.current?(r(),a(`section`,y,[l(`div`,b,t(T.current.title),1),l(`div`,{class:`cs-body`,innerHTML:T.current.html},null,8,x)])):c(``,!0),l(`div`,S,[l(`button`,{class:`cs-pager-btn`,disabled:!T.prev,onClick:d[0]||=e=>T.goTo(T.prev.id)},` ← `+t(T.prevTitle),9,C),l(`button`,{class:`cs-pager-btn next`,disabled:!T.next,onClick:d[1]||=e=>T.goTo(T.next.id)},t(T.nextTitle)+` → `,9,w)])])])}var E=u(m,[[`render`,T],[`__scopeId`,`data-v-a3f1f8f7`]]);export{E as default};