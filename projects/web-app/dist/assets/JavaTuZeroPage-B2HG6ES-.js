...
System.out.println(a % b);`,question:`In ra 2 dòng gì?`,options:[`3 và 1`,`3.33 và 1`,`3 và 0`,`3.33 và 0.33`],answer:0,explain:`Chia 2 int bỏ phần dư: 10/3 = 3. % lấy phần dư: 10%3 = 1.`}]},ie={class:`tu-zero-page`},m={class:`tz-header`},h={class:`tz-heading`},g={class:`tz-tabs`},_=[`onClick`],v={class:`tz-chapter-head`},y={class:`tz-time`},b={class:`tz-intro`},x={class:`code-title`},S={key:0,class:`tz-quiz`},C={class:`quiz-q`},w={class:`quiz-options`},T=[`disabled`,`onClick`],E={key:0,class:`quiz-why`},D={key:1,class:`tz-section`},O={class:`tz-chapter-head`},k={class:`tz-time`},A={class:`ex-head`},j={class:`ex-task`},M={class:`ex-buttons`},N=[`onClick`],P=[`onClick`],F={key:0,class:`ex-hint`},ae={key:1,class:`ex-answer`},I={class:`code-card`},L={class:`ex-explain`},R={key:2,class:`tz-section`},z={class:`tz-chapter-head`},B={class:`tz-time`},V={class:`rc-index`},H={class:`code-card`},U={class:`quiz-q`},W={class:`quiz-options`},G=[`disabled`,`onClick`],K={key:0,class:`quiz-why`},q=ne({__name:`JavaTuZeroPage`,setup(ne){let q=t(()=>p.chapters),J=u(`ch1`),Y=i({}),X=i({}),Z=i({});function Q(e,t){return e+`-`+t}function oe(e){return e.startsWith(`rc-`)?X:Y}function $(e,t,n,r){let i=e===`rc`?`rc-`+t:Q(e,t),a=oe(i)[i];return a===void 0?{}:n===r?{correct:!0}:n===a?{wrong:!0}:{}}function se(e,t,n){let r=Q(e,t);Y[r]===void 0&&(Y[r]=n)}function ce(e,t){let n=`rc-`+e;X[n]===void 0&&(X[n]=t)}function le(e){Z[e]||(Z[e]={hint:!1,answer:!1}),Z[e].hint=!Z[e].hint}function ue(e){Z[e]||(Z[e]={hint:!1,answer:!1}),Z[e].answer=!Z[e].answer}function de(e){return e===`easy`?`Dễ`:e===`medium`?`Trung bình`:`Khó`}function fe(){re(`/java/hub`)}return(t,i)=>(n(),s(`div`,ie,[f(`header`,m,[f(`button`,{class:`tz-back`,onClick:fe},`← Java`),f(`div`,h,[i[2]||=f(`h1`,null,`🌱 Java Từ 0 — mất gốc → đi làm`,-1),f(`p`,null,` Dành cho người yếu Java và tư duy lập trình: 6 chương nền tảng + quiz, `+e(l(p).exercises.length)+` bài tập có lời giải từng bước, `+e(l(p).readCode.length)+` bài đọc-code đoán kết quả. `,1)])]),f(`nav`,g,[(n(!0),s(o,null,c(l(p).chapters,t=>(n(),s(`button`,{key:t.id,class:d([`tz-tab`,{active:J.value===t.id}]),onClick:e=>J.value=t.id},e(t.emoji)+` `+e(t.title),11,_))),128)),f(`button`,{class:d([`tz-tab`,{active:J.value===`exercises`}]),onClick:i[0]||=e=>J.value=`exercises`},` 💪 Bài tập `,2),f(`button`,{class:d([`tz-tab`,{active:J.value===`readcode`}]),onClick:i[1]||=e=>J.value=`readcode`},` 🔍 Đọc code `,2)]),J.value.startsWith(`ch`)?(n(!0),s(o,{key:0},c(q.value,t=>te((n(),s(`section`,{key:t.id,class:`tz-section`},[f(`div`,v,[f(`h2`,null,e(t.emoji)+` `+e(t.title),1),f(`span`,y,`⏱️ `+e(t.time),1)]),f(`p`,b,e(t.intro),1),(n(!0),s(o,null,c(t.lessons,t=>(n(),s(`div`,{key:t.title,class:`tz-lesson`},[f(`h3`,null,e(t.title),1),(n(!0),s(o,null,c(t.paragraphs,(t,r)=>(n(),s(`p`,{key:r,class:`tz-para`},e(t),1))),128)),(n(!0),s(o,null,c(t.codes,t=>(n(),s(`div`,{key:t.title,class:`code-card`},[f(`div`,x,e(t.title),1),f(`pre`,null,[f(`code`,null,e(t.code),1)])]))),128))]))),128)),t.quiz&&t.quiz.length?(n(),s(`div`,S,[i[3]||=f(`h3`,null,`✅ Kiểm tra nhanh — hiểu rồi mới sang bài sau`,-1),(n(!0),s(o,null,c(t.quiz,(r,i)=>(n(),s(`div`,{key:i,class:`quiz-item`},[f(`p`,C,e(r.q),1),f(`div`,w,[(n(!0),s(o,null,c(r.options,(a,o)=>(n(),s(`button`,{key:o,class:d([`quiz-opt`,$(t.id,i,o,r.answer)]),disabled:Y[Q(t.id,i)]!==void 0,onClick:e=>se(t.id,i,o)},e(a),11,T))),128))]),Y[Q(t.id,i)]===void 0?a(``,!0):(n(),s(`p`,E,e(Y[Q(t.id,i)]===r.answer?`✅ Đúng. `:`❌ Chưa đúng. `)+` `+e(r.why),1))]))),128))])):a(``,!0)])),[[ee,J.value===t.id]])),128)):J.value===`exercises`?(n(),s(`section`,D,[f(`div`,O,[i[4]||=f(`h2`,null,`💪 Bài tập luyện tư duy`,-1),f(`span`,k,e(l(p).exercises.length)+` bài · Dễ → Khó`,1)]),i[9]||=f(`p`,{class:`tz-intro`},` Quy tắc vàng: tự viết 20–30 phút KHÔNG được thì mới xem gợi ý; viết tiếp vẫn bí mới xem đáp án. Chép đáp án không rèn được tư duy — hiểu "vì sao" mới là mục tiêu. `,-1),(n(!0),s(o,null,c(l(p).exercises,t=>(n(),s(`div`,{key:t.id,class:`ex-card`},[f(`div`,A,[f(`span`,{class:d([`ex-level`,`lv-`+t.level])},e(de(t.level)),3),f(`h3`,null,e(t.title),1)]),f(`div`,j,[i[5]||=f(`strong`,null,`Đề bài:`,-1),r(` `+e(t.task),1)]),f(`div`,M,[f(`button`,{class:`ex-btn`,onClick:e=>le(t.id)},e(Z[t.id]&&Z[t.id].hint?`Ẩn gợi ý`:`💡 Xem gợi ý`),9,N),f(`button`,{class:`ex-btn primary`,onClick:e=>ue(t.id)},e(Z[t.id]&&Z[t.id].answer?`Ẩn đáp án`:`✅ Xem đáp án`),9,P)]),Z[t.id]&&Z[t.id].hint?(n(),s(`div`,F,[i[6]||=f(`strong`,null,`Cách nghĩ:`,-1),r(` `+e(t.hint),1)])):a(``,!0),Z[t.id]&&Z[t.id].answer?(n(),s(`div`,ae,[f(`div`,I,[i[7]||=f(`div`,{class:`code-title`},`Lời giải`,-1),f(`pre`,null,[f(`code`,null,e(t.solution),1)])]),f(`p`,L,[i[8]||=f(`strong`,null,`Vì sao:`,-1),r(` `+e(t.explain),1)])])):a(``,!0)]))),128))])):(n(),s(`section`,R,[f(`div`,z,[i[10]||=f(`h2`,null,`🔍 Đọc code — đoán kết quả`,-1),f(`span`,B,e(l(p).readCode.length)+` câu hỏi bẫy`,1)]),i[11]||=f(`p`,{class:`tz-intro`},` Cách rèn "tư duy lập trình" nhanh nhất: đọc code như máy tính, chạy từng dòng trong đầu rồi đoán output. Sai bao nhiêu cũng được — đọc kỹ phần giải thích. `,-1),(n(!0),s(o,null,c(l(p).readCode,(t,r)=>(n(),s(`div`,{key:r,class:`rc-card`},[f(`span`,V,`Câu `+e(r+1),1),f(`div`,H,[f(`pre`,null,[f(`code`,null,e(t.code),1)])]),f(`p`,U,e(t.question),1),f(`div`,W,[(n(!0),s(o,null,c(t.options,(i,a)=>(n(),s(`button`,{key:a,class:d([`quiz-opt`,$(`rc`,r,a,t.answer)]),disabled:X[`rc-`+r]!==void 0,onClick:e=>ce(r,a)},e(i),11,G))),128))]),X[`rc-`+r]===void 0?a(``,!0):(n(),s(`p`,K,e(X[`rc-`+r]===t.answer?`✅ Đúng. `:`❌ Chưa đúng. `)+` `+e(t.explain),1))]))),128))]))]))}},[[`__scopeId`,`data-v-2203e295`]]);export{q as default};