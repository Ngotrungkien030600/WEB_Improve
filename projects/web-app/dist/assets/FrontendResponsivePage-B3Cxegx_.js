import{d as e,h as t,i as n,v as r,w as i,y as a}from"./index-CX3t5JlV.js";import{t as o}from"./navigate-UokpJLHS.js";var s={name:`FrontendResponsivePage`,methods:{handleNav(e){o(e)}}},c={class:`responsive-page`,style:{"--color-accent":`#34d399`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(n,o,s,f,p,m){return i(),r(`div`,c,[t(`div`,l,[t(`div`,u,[o[2]||=t(`h1`,null,`📱 Responsive Design`,-1),t(`div`,d,[t(`a`,{href:`#`,onClick:o[0]||=e(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),t(`a`,{href:`#`,onClick:o[1]||=e(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=a(`<p class="desc" data-v-19dd2eda>Media Queries, Container Queries, Mobile-first, Fluid typography, Breakpoint system.</p><div class="section" data-v-19dd2eda><h2 data-v-19dd2eda>📐 Breakpoint System</h2><pre data-v-19dd2eda><code data-v-19dd2eda>/* Mobile-first: base styles cho mobile, mở rộng dần */
...
/* Tự động đảo chiều khi dir=&quot;rtl&quot; */</code></pre></div>`,8)])])}var p=n(s,[[`render`,f],[`__scopeId`,`data-v-19dd2eda`]]);export{p as default};