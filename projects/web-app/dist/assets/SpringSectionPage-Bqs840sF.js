import{$ as e,B as t,D as n,F as r,I as i,L as a,M as ee,O as o,P as s,U as c,V as l,W as u,Z as d,j as f,v as p}from"./index-DgMtGGTp.js";import{n as m}from"./navigate-CTQGF1Xi.js";import{t as h}from"./CodeBlock-DFXF1Hrc.js";var g=`// 1. Field injection (không khuyến nghị — khó test)
@Service
...
}`,k={name:`SpringSectionJpa`,components:{CodeBlock:h},data(){return{entityCode:E,repositoryCode:D,n1Code:O}}},A={class:`ss-section`};function j(e,n,ee,o,l,u){let d=c(`CodeBlock`);return t(),s(`div`,A,[n[0]||=f(`h3`,null,`Entity & Relationships — ánh xạ bảng DB thành object`,-1),n[1]||=f(`p`,{class:`section-text`},[f(`code`,null,`@Entity`),i(` đánh dấu class ánh xạ tới 1 bảng, mỗi field là 1 cột. Quan hệ quan trọng nhất: `),f(`code`,null,`@OneToMany`),i(` (1 user → nhiều order) và `),f(`code`,null,`@ManyToMany`),i(` (user ↔ role) qua bảng trung gian `),f(`code`,null,`user_roles`),i(`. Chọn đúng quan hệ + cascade quyết định cách Hibernate sinh SQL và quản lý dữ liệu liên quan.`)],-1),a(d,{code:l.entityCode,language:`java`},null,8,[`code`]),n[2]||=f(`h3`,null,`Repository — Spring Data JPA sinh sẵn query`,-1),n[3]||=f(`p`,{class:`section-text`},[f(`code`,null,`JpaRepository`),i(` cung cấp sẵn CRUD + paging (findAll, save, findById...). Chỉ cần `),f(`strong`,null,`khai báo method theo quy ước tên`),i(` (`),f(`code`,null,`findByEmail`),i(`) Spring tự implement. `),f(`code`,null,`@Query`),i(` dùng khi cần JPQL tùy biến — kèm `),f(`code`,null,`@Modifying`),i(` cho lệnh UPDATE/DELETE.`)],-1),a(d,{code:l.repositoryCode,language:`java`},null,8,[`code`]),n[4]||=r(`<h3 data-v-1a64ab5a>N+1 Problem — cái bẫy hiệu năng kinh điển</h3><p class="section-text" data-v-1a64ab5a><strong data-v-1a64ab5a>N+1</strong>: lấy danh sách N record, rồi mỗi record lại query thêm quan hệ → tổng <strong data-v-1a64ab5a>N+1 queries</strong> thay vì 1. Gây chậm rõ rệt khi dữ liệu lớn (1000 users → 1001 queries). Đây là lỗi hiệu năng phổ biến nhất khi dùng JPA, thường bị phát hiện muộn ở production.</p><div class="cards-grid cols-2" data-v-1a64ab5a><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Fix 1: JOIN FETCH</h4><p data-v-1a64ab5a>Gộp 1 query lấy luôn dữ liệu quan hệ. Hiệu quả cho truy vấn cố định.</p></div><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Fix 2: @EntityGraph</h4><p data-v-1a64ab5a>Khai báo eager load các quan hệ theo tên — tái sử dụng được với nhiều query.</p></div><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Fix 3: @BatchSize</h4><p data-v-1a64ab5a>Gom N quan hệ vào 1 query IN (...). Giảm số query mà không phải sửa từng truy vấn.</p></div><div class="info-card" data-v-1a64ab5a><h4 data-v-1a64ab5a>Kiểm tra thực tế</h4><p data-v-1a64ab5a>Bật <code data-v-1a64ab5a>spring.jpa.show-sql</code> hoặc Hibernate Stats khi test — đếm số query phát sinh, bắt N+1 trước khi lên production.</p></div></div>`,3),a(d,{code:l.n1Code,language:`java`},null,8,[`code`])])}var M=p(k,[[`render`,j],[`__scopeId`,`data-v-1a64ab5a`]]),N=`@Configuration
@EnableWebSecurity
...
}`,J={name:`SpringSectionAsync`,components:{CodeBlock:h},data(){return{asyncCode:G,scheduledCode:K,eventCode:q}}},Y={class:`ss-section`};function ae(e,n,r,ee,o,l){let u=c(`CodeBlock`);return t(),s(`div`,Y,[n[0]||=f(`h3`,null,`@Async — chạy nền, không chặn response`,-1),n[1]||=f(`p`,{class:`section-text`},[f(`code`,null,`@Async`),i(` đẩy method chạy vào `),f(`strong`,null,`thread pool riêng`),i(`, trả response ngay lập tức. Áp dụng cho tác vụ chậm không cần đợi kết quả: gửi email welcome, gọi webhook, xử lý file. `),f(`strong`,null,`Bẫy phổ biến:`),i(` gọi @Async method từ bên trong cùng class sẽ không có tác dụng (proxy không đi qua).`)],-1),a(u,{code:o.asyncCode,language:`java`},null,8,[`code`]),n[2]||=f(`h3`,null,`@Scheduled — chạy tự động theo lịch`,-1),n[3]||=f(`p`,{class:`section-text`},[i(`Tác vụ định kỳ như dọn dữ liệu cũ, gửi báo cáo, chạy backup. Cron `),f(`code`,null,`0 0 2 * * ?`),i(` = mỗi ngày lúc 2h sáng. Khi chạy nhiều instance, cần khóa phân tán (ShedLock, Quartz) để tránh `),f(`strong`,null,`nhiều instance chạy cùng lúc`),i(`.`)],-1),a(u,{code:o.scheduledCode,language:`java`},null,8,[`code`]),n[4]||=f(`h3`,null,`@EventListener — tách rời các module`,-1),n[5]||=f(`p`,{class:`section-text`},[i(`Publisher `),f(`strong`,null,`phát event`),i(`, listener `),f(`strong`,null,`lắng nghe và xử lý`),i(` — hai module không biết về nhau. VD: UserService tạo user xong phát `),f(`code`,null,`UserCreatedEvent`),i(`, module email/notification tự phản ứng. Kết hợp `),f(`code`,null,`@Async`),i(` để không làm chậm luồng chính. Đây là nền tảng của kiến trúc `),f(`strong`,null,`event-driven`),i(`.`)],-1),a(u,{code:o.eventCode,language:`java`},null,8,[`code`])])}var X=p(J,[[`render`,ae],[`__scopeId`,`data-v-0200952d`]]),oe=`@ExtendWith(MockitoExtension.class)
...
}`,ce={name:`SpringSectionTest`,components:{CodeBlock:h},data(){return{unitTestCode:oe,integrationTestCode:se}}},le={class:`ss-section`};function ue(e,n,ee,o,l,u){let d=c(`CodeBlock`);return t(),s(`div`,le,[n[0]||=r(`<h3 data-v-d45a1664>Các loại test — kiểm tra ở đúng tầng</h3><div class="cards-grid cols-4" data-v-d45a1664><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Unit Test</h4><p data-v-d45a1664>Test 1 class độc lập, mock dependencies. Nhanh nhất, chạy mỗi lần commit. @ExtendWith(MockitoExtension.class).</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Integration Test</h4><p data-v-d45a1664>Test tầng repository với DB thật. @DataJpaTest + Testcontainers.</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Web Layer Test</h4><p data-v-d45a1664>@WebMvcTest — chỉ tầng controller, mock service — test HTTP + JSON serialize.</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Full Integration</h4><p data-v-d45a1664>@SpringBootTest + Testcontainers — test từ controller đến DB. Chậm nhất, chạy trước khi release.</p></div></div><p class="section-text" data-v-d45a1664><strong data-v-d45a1664>Chiến lược thực tế:</strong> đa số là unit test (nhanh, rẻ), vài integration test cho repository/controller, số ít full flow. Kim tự tháp test — càng lên cao càng ít, càng xuống dưới càng nhiều.</p><h3 data-v-d45a1664>Unit Test với Mockito — test logic không cần DB</h3><p class="section-text" data-v-d45a1664><code data-v-d45a1664>@Mock</code> tạo &quot;bản sao giả&quot; của dependency (không chạm DB thật), <code data-v-d45a1664>@InjectMocks</code> đưa chúng vào class cần test. Kiểm tra: kết quả trả về đúng (<code data-v-d45a1664>assertThat</code>) và method được gọi đúng (<code data-v-d45a1664>verify</code>). Chạy trong mili-giây, lặp lại vô tận.</p>`,5),a(d,{code:l.unitTestCode,language:`java`},null,8,[`code`]),n[1]||=f(`h3`,null,`Integration Test với Testcontainers — DB thật nhưng tạm thời`,-1),n[2]||=f(`p`,{class:`section-text`},[f(`strong`,null,`Testcontainers`),i(` khởi động PostgreSQL thật trong Docker cho mỗi lần test — dữ liệu sạch, không phụ thuộc máy dev, không ô nhiễm DB thật. Bắt được lỗi mà mock bỏ sót: SQL sai, mapping Entity lệch schema, constraint vi phạm.`)],-1),a(d,{code:l.integrationTestCode,language:`java`},null,8,[`code`])])}var Z=p(ce,[[`render`,ue],[`__scopeId`,`data-v-d45a1664`]]),de=`// Service Registry (Eureka Server)
