...
- [ ] So sánh được edge vs cloud AI`,checklist:[`Trả lời trôi chảy 10 câu phỏng vấn trên`,`Giải thích được vòng lặp agent bằng ví dụ cụ thể`,`Biết cách xử lý rate limit và tối ưu chi phí`,`So sánh được edge vs cloud AI`]}];var te=window.aiAgentConcepts,g=window.aiAgentQuizData,_=window.aiAgentTopics,v=`sf_forge_stats`;function y(){try{let e=localStorage.getItem(v);if(e)return JSON.parse(e)}catch{}return{todayMinutes:0,todayDate:null,streak:0,total:0}}function b(e){try{localStorage.setItem(v,JSON.stringify(e))}catch{}}var x={name:`ForgeTimer`,data(){let e=y(),t=new Date().toDateString();return e.todayDate!==t&&(e.todayMinutes=0,e.todayDate=t,b(e)),{totalSeconds:1800,remaining:1800,isRunning:!1,interval:null,selectedDuration:`30`,streak:0,total:0}},computed:{minutes(){return Math.floor(this.remaining/60)},seconds(){return this.remaining%60},formattedTime(){return`${String(this.minutes).padStart(2,`0`)}:${String(this.seconds).padStart(2,`0`)}`},progress(){return 1-this.remaining/this.totalSeconds},dashOffset(){return 2*Math.PI*30*(1-this.progress)},todayMinutes(){let e=y(),t=new Date().toDateString();return e.todayDate===t?e.todayMinutes:0}},methods:{toggle(){this.isRunning?this.pause():this.start()},start(){this.isRunning||this.remaining<=0||(this.isRunning=!0,this.interval=setInterval(()=>{this.remaining--,this.remaining<=0&&(this.pause(),this.remaining=0,this.complete())},1e3))},pause(){this.isRunning=!1,this.interval&&=(clearInterval(this.interval),null)},reset(){this.pause();let e=parseInt(this.selectedDuration)||30;this.totalSeconds=e*60,this.remaining=this.totalSeconds},complete(){let e=y(),t=new Date().toDateString(),n=parseInt(this.selectedDuration)||30;e.todayMinutes=(e.todayDate===t?e.todayMinutes:0)+n,e.todayDate=t,e.total=(e.total||0)+1,e.todayMinutes>n&&e.todayMinutes<n*2&&(e.streak=(e.streak||0)+1),b(e),this.todayMinutes=e.todayMinutes,this.streak=e.streak,this.total=e.total}},beforeUnmount(){this.pause()}},S={class:`forge-timer-wrap`},C={class:`forge-timer-ring`},w={viewBox:`0 0 68 68`},T={class:`forge-time`},E={class:`forge-controls`},D={class:`forge-btn-row`},O={class:`forge-stats`},k={class:`forge-stat-row`},A={class:`val fire`},j={class:`forge-stat-row`},M={class:`val`},N={class:`forge-stat-row`},P={class:`val`};function F(t,n,r,i,s,u){return o(),a(`div`,S,[c(`div`,C,[(o(),a(`svg`,w,[n[4]||=c(`circle`,{class:`forge-ring-bg`,cx:`34`,cy:`34`,r:`30`},null,-1),c(`circle`,{class:`forge-ring-progress`,style:e({strokeDashoffset:u.dashOffset}),cx:`34`,cy:`34`,r:`30`},null,4)])),c(`div`,T,p(u.formattedTime),1)]),c(`div`,E,[m(c(`select`,{"onUpdate:modelValue":n[0]||=e=>s.selectedDuration=e,onChange:n[1]||=(...e)=>u.reset&&u.reset(...e)},[...n[5]||=[c(`option`,{value:`30`},`30p`,-1),c(`option`,{value:`60`},`1h`,-1)]],544),[[f,s.selectedDuration]]),c(`div`,D,[c(`button`,{class:`forge-btn forge-btn-primary`,onClick:n[2]||=(...e)=>u.toggle&&u.toggle(...e)},p(s.isRunning?`⏸`:`⚒️`),1),c(`button`,{class:`forge-btn forge-btn-secondary`,onClick:n[3]||=(...e)=>u.reset&&u.reset(...e)},`↻`)])]),c(`div`,O,[c(`div`,k,[n[6]||=l(`📋 Hôm nay `,-1),c(`span`,A,p(u.todayMinutes)+`m`,1)]),c(`div`,j,[n[7]||=l(`🔥 Streak `,-1),c(`span`,M,p(s.streak)+`🔥`,1)]),c(`div`,N,[n[8]||=l(`📦 Đã rèn `,-1),c(`span`,P,p(s.total),1)])])])}var I=u(x,[[`render`,F],[`__scopeId`,`data-v-f0561c5b`]]),L=`aiAgentChecklist`;function R(){try{return JSON.parse(localStorage.getItem(L)||`{}`)}catch{return{}}}function z(e){localStorage.setItem(L,JSON.stringify(e))}function B(e,t){let n=0,r=0;return e.forEach(e=>{e.checklist&&e.checklist.forEach(e=>{n++,t[e]&&r++})}),{done:r,total:n,percent:n>0?Math.round(r/n*100):0}}function V(e,t){let n=e.checklist||[];return{done:n.filter(e=>t[e]).length,total:n.length}}var H=[{id:`learn`,label:`Học`,icon:`📚`},{id:`quiz`,label:`Thi`,icon:`🎯`},{id:`lessons`,label:`Bài học`,icon:`📖`}],U=[{id:`general`,label:`Agent cơ bản`,icon:`🤖`},{id:`token`,label:`Token`,icon:`🔢`},{id:`quota`,label:`Quota`,icon:`⏳`},{id:`edge`,label:`Edge`,icon:`📡`}],W={name:`AiAgentPage`,components:{ForgeTimer:I},data(){return{tabs:H,activeTab:`learn`,filterCategory:`all`,currentIndex:0,isFlipped:!1,selectedLesson:0,concepts:te,lessons:_,checklist:{},quizQuestions:[],quizCategories:U,currentQuestion:0,selectedAnswer:null,answered:!1,quizScore:0,quizStarted:!1,quizCount:10,quizTime:15,quizTimer:null,quizTimeLeft:15,selectedQuizCategory:`general`}},computed:{filteredCards(){return this.filterCategory===`all`?this.concepts:this.concepts.filter(e=>e.category===this.filterCategory)},currentCard(){return this.filteredCards[this.currentIndex]},lessonProgress(){return B(this.lessons,this.checklist)},renderedLesson(){let e=this.lessons[this.selectedLesson];if(!e)return``;let t=e.content?this.renderMarkdown(e.content):``;return e.checklist&&e.checklist.length>0&&(t+=`<h3>📝 Checklist</h3>`,e.checklist.forEach(e=>{let n=!!this.checklist[e],r=e.replace(/"/g,`&quot;`);t+=`
            <label class="checklist-item ${n?`checked`:``}">
              <input type="checkbox" ${n?`checked`:``} data-item="${r}">
              <span>${e}</span>
            </label>`})),t},currentQuizQuestion(){return this.quizQuestions[this.currentQuestion]?this.quizQuestions[this.currentQuestion]:null},quizPercent(){return this.quizScore===0&&!this.quizStarted?`0%`:Math.round(this.quizScore/this.quizQuestions.length*100)+`%`},quizLevel(){let e=this.quizScore/this.quizQuestions.length*100;return e>=90?`🟢 Xuất sắc`:e>=70?`🟡 Tốt`:e>=50?`🟠 Trung bình`:`🔴 Cần cố gắng`}},mounted(){this.checklist=R(),this.$nextTick(()=>this.bindLessonEvents())},updated(){this.$nextTick(()=>this.bindLessonEvents())},methods:{handleNavigate(e){ee(e)},filterCategory(){this.currentIndex=0,this.isFlipped=!1},prevCard(){this.currentIndex>0&&(this.currentIndex--,this.isFlipped=!1)},nextCard(){this.currentIndex<this.filteredCards.length-1&&(this.currentIndex++,this.isFlipped=!1)},toggleLessonItem(e,t){this.checklist={...this.checklist,[e]:t},z(this.checklist)},getLessonProgress(e){let t=this.lessons[e];if(!t)return`0/0`;let{done:n,total:r}=V(t,this.checklist);return`${n}/${r}`},bindLessonEvents(){document.querySelectorAll(`.ai-lesson-content .checklist-item input`).forEach(e=>{e._bound||(e._bound=!0,e.addEventListener(`change`,()=>{this.toggleLessonItem(e.dataset.item,e.checked);let t=e.closest(`.checklist-item`);t&&t.classList.toggle(`checked`,e.checked)}))})},startQuiz(){let e=g[this.selectedQuizCategory]||[];if(e.length===0)return;let t=[...e].sort(()=>Math.random()-.5);this.quizQuestions=t.slice(0,Math.min(this.quizCount,e.length)),this.currentQuestion=0,this.selectedAnswer=null,this.answered=!1,this.quizScore=0,this.quizStarted=!0,this.startQuizTimer()},startQuizTimer(){this.quizTimer&&clearInterval(this.quizTimer),this.quizTimeLeft=this.quizTime,this.quizTimer=setInterval(()=>{this.quizTimeLeft--,this.quizTimeLeft<=0&&this.submitQuizAnswer()},1e3)},submitQuizAnswer(){if(this.answered)return;this.answered=!0,this.quizTimer&&clearInterval(this.quizTimer);let e=this.quizQuestions[this.currentQuestion];this.selectedAnswer===e.correct&&this.quizScore++},nextQuestion(){this.answered||this.submitQuizAnswer(),this.currentQuestion<this.quizQuestions.length-1&&(this.currentQuestion++,this.selectedAnswer=null,this.answered=!1,this.startQuizTimer())},resetQuiz(){this.quizTimer&&clearInterval(this.quizTimer),this.quizStarted=!1,this.quizQuestions=[],this.currentQuestion=0,this.selectedAnswer=null,this.answered=!1,this.quizScore=0},renderMarkdown(e){return e?e.replace(/^#{1,6} (.+)$/gm,(e,t)=>`<h${t.length}>${t}</h${t.length}>`).replace(/\*\*(.+?)\*\*/g,`<strong>$1</strong>`).replace(/\n\n/g,`</p><p>`).replace(/^(?!<[h|p|u|o|l|b|c])(.+)$/gm,`<p>$1</p>`).replace(/<p><\/p>/g,``):``}}},G={class:`page-root`,style:{"--color-accent":`#f472b6`}},K={class:`container`},q={class:`ai-topbar`},J={class:`topbar-right`},Y={class:`ai-tabs`},X=[`onClick`],Z={key:0,class:`ai-section active`},Q={class:`ai-card-filter`},ne={class:`ai-card-inner`},re={class:`ai-card-front`},ie={class:`ai-card-category`},ae={class:`ai-card-en`},oe={class:`ai-card-vi`},se={class:`ai-card-def`},ce={class:`ai-card-back`},le={class:`ai-card-ex`},ue={class:`ai-card-counter`},de={class:`ai-card-controls`},fe={key:1,class:`ai-section`},pe={key:0,class:`ai-q-config`},me={class:`ai-q-tabs`},he=[`onClick`],ge={class:`ai-q-settings`},_e={class:`ai-q-timer-bar`},ve={class:`ai-q-timer-text`},ye={class:`ai-q-card`},be={class:`ai-q-badge`},xe={class:`ai-q-progress`},Se={class:`ai-q-question`},Ce={class:`ai-q-options`},we=[`disabled`,`onClick`],Te={class:`ai-q-stats`},Ee={class:`ai-q-stat-value`},De={class:`ai-q-stat-value`},Oe={class:`ai-q-stat-value`},ke={class:`ai-q-stat-value`},Ae={key:2,class:`ai-section`},je={class:`ai-lesson-layout`},Me={class:`ai-lesson-sidebar`},Ne={class:`ai-lesson-list`},Pe=[`onClick`],$={class:`ai-lesson-stat`},Fe={class:`ai-lesson-progress`},Ie={class:`progress-track`},Le={class:`ai-lesson-content`},Re={class:`ai-lesson-card`},ze=[`innerHTML`];function Be(l,u,ee,te,g,_){let v=h(`ForgeTimer`);return o(),a(`div`,G,[c(`div`,K,[c(`header`,q,[u[12]||=c(`div`,{class:`topbar-left`},[c(`h1`,null,`🤖 Học AI Agent`),c(`p`,null,`Agent — Tools — Token — Quota — AI at Edge`)],-1),c(`div`,J,[s(v),c(`button`,{class:`home-btn`,type:`button`,"aria-label":`Về trang chủ`,title:`Về trang chủ`,onClick:u[0]||=e=>_.handleNavigate(`/`)},`🏠`)])]),c(`nav`,Y,[(o(!0),a(r,null,n(g.tabs,e=>(o(),a(`button`,{key:e.id,class:t([`ai-tab`,{active:g.activeTab===e.id}]),onClick:t=>g.activeTab=e.id},p(e.icon)+` `+p(e.label),11,X))),128))]),g.activeTab===`learn`?(o(),a(`section`,Z,[c(`div`,Q,[m(c(`select`,{"onUpdate:modelValue":u[1]||=e=>_.filterCategory=e},[...u[13]||=[d(`<option value="all" data-v-f6afc003>📂 Tất cả chủ đề</option><option value="agent" data-v-f6afc003>🤖 Agent Fundamentals</option><option value="tools" data-v-f6afc003>🔧 Tools &amp; MCP</option><option value="token" data-v-f6afc003>🔢 Token &amp; Context</option><option value="quota" data-v-f6afc003>⏳ Quota &amp; Cost</option><option value="edge" data-v-f6afc003>📡 AI at Edge</option>`,6)]],512),[[f,_.filterCategory]])]),c(`div`,{class:t([`ai-card`,{flipped:g.isFlipped}]),onClick:u[2]||=e=>g.isFlipped=!g.isFlipped},[c(`div`,ne,[c(`div`,re,[c(`span`,ie,p(_.currentCard?.category?.toUpperCase()),1),c(`div`,ae,p(_.currentCard?.en),1),c(`div`,oe,p(_.currentCard?.vi),1),c(`div`,se,p(_.currentCard?.definition),1)]),c(`div`,ce,[u[14]||=c(`span`,{class:`ai-card-category`},`VÍ DỤ`,-1),c(`div`,le,p(_.currentCard?.example),1),u[15]||=c(`p`,{class:`flip-hint`},`🔄 Click để xem lại mặt trước`,-1)])])],2),c(`p`,ue,p(g.currentIndex+1)+` / `+p(_.filteredCards.length),1),c(`div`,de,[c(`button`,{class:`ai-card-btn`,onClick:u[3]||=(...e)=>_.prevCard&&_.prevCard(...e)},`⬅️ Trước`),c(`button`,{class:`ai-card-btn`,onClick:u[4]||=e=>g.isFlipped=!g.isFlipped},`🔄 Lật`),c(`button`,{class:`ai-card-btn`,onClick:u[5]||=(...e)=>_.nextCard&&_.nextCard(...e)},`Tiếp ➡️`)])])):i(``,!0),g.activeTab===`quiz`?(o(),a(`section`,fe,[g.quizStarted?i(``,!0):(o(),a(`div`,pe,[c(`div`,me,[(o(!0),a(r,null,n(g.quizCategories,e=>(o(),a(`button`,{key:e.id,class:t([`ai-q-tab`,{active:g.selectedQuizCategory===e.id}]),onClick:t=>g.selectedQuizCategory=e.id},p(e.icon)+` `+p(e.label),11,he))),128))]),c(`div`,ge,[m(c(`select`,{"onUpdate:modelValue":u[6]||=e=>g.quizCount=e},[...u[16]||=[c(`option`,{value:`5`},`5 câu`,-1),c(`option`,{value:`10`},`10 câu`,-1),c(`option`,{value:`15`},`15 câu`,-1)]],512),[[f,g.quizCount,void 0,{number:!0}]]),m(c(`select`,{"onUpdate:modelValue":u[7]||=e=>g.quizTime=e},[...u[17]||=[c(`option`,{value:`10`},`10s`,-1),c(`option`,{value:`15`},`15s`,-1),c(`option`,{value:`20`},`20s`,-1),c(`option`,{value:`30`},`30s`,-1)]],512),[[f,g.quizTime,void 0,{number:!0}]]),c(`button`,{class:`ai-q-start`,onClick:u[8]||=(...e)=>_.startQuiz&&_.startQuiz(...e)},`▶️ Bắt đầu`)])])),g.quizStarted&&_.currentQuizQuestion?(o(),a(r,{key:1},[c(`div`,_e,[c(`div`,{class:`ai-q-timer-fill`,style:e({width:g.quizTimeLeft/g.quizTime*100+`%`})},null,4)]),c(`p`,ve,p(g.quizTimeLeft)+`s`,1),c(`div`,ye,[c(`span`,be,p(g.quizCategories.find(e=>e.id===g.selectedQuizCategory)?.label),1),c(`span`,xe,`Câu `+p(g.currentQuestion+1)+` / `+p(g.quizQuestions.length),1),c(`h2`,Se,p(_.currentQuizQuestion.question),1),c(`div`,Ce,[(o(!0),a(r,null,n(_.currentQuizQuestion.options,(e,n)=>(o(),a(`button`,{key:n,class:t([`ai-q-option`,{selected:g.selectedAnswer===n,correct:g.answered&&n===_.currentQuizQuestion.correct,wrong:g.answered&&g.selectedAnswer===n&&n!==_.currentQuizQuestion.correct}]),disabled:g.answered,onClick:e=>{g.selectedAnswer=n,_.submitQuizAnswer()}},p(e),11,we))),128))]),g.answered?(o(),a(`div`,{key:0,class:t([`ai-q-feedback`,g.selectedAnswer===_.currentQuizQuestion.correct?`correct`:`wrong`])},p(g.selectedAnswer===_.currentQuizQuestion.correct?`✅ Chính xác!`:`❌ Chưa đúng. Đáp án đúng: `+_.currentQuizQuestion.options[_.currentQuizQuestion.correct]),3)):i(``,!0),g.answered?i(``,!0):(o(),a(`button`,{key:1,class:`ai-q-submit`,onClick:u[9]||=(...e)=>_.submitQuizAnswer&&_.submitQuizAnswer(...e)},`Xác nhận`)),g.answered&&g.currentQuestion<g.quizQuestions.length-1?(o(),a(`button`,{key:2,class:`ai-q-next`,onClick:u[10]||=(...e)=>_.nextQuestion&&_.nextQuestion(...e)},`Câu tiếp theo ➡️`)):i(``,!0),g.answered&&g.currentQuestion===g.quizQuestions.length-1?(o(),a(`button`,{key:3,class:`ai-q-restart`,onClick:u[11]||=(...e)=>_.resetQuiz&&_.resetQuiz(...e)},`🔄 Làm lại`)):i(``,!0)]),c(`div`,Te,[c(`div`,null,[c(`span`,Ee,p(g.quizScore),1),u[18]||=c(`span`,{class:`ai-q-stat-label`},`Đúng`,-1)]),c(`div`,null,[c(`span`,De,p(g.quizQuestions.length),1),u[19]||=c(`span`,{class:`ai-q-stat-label`},`Tổng`,-1)]),c(`div`,null,[c(`span`,Oe,p(_.quizPercent),1),u[20]||=c(`span`,{class:`ai-q-stat-label`},`Tỉ lệ`,-1)]),c(`div`,null,[c(`span`,ke,p(_.quizLevel),1),u[21]||=c(`span`,{class:`ai-q-stat-label`},`Trình độ`,-1)])])],64)):i(``,!0)])):i(``,!0),g.activeTab===`lessons`?(o(),a(`section`,Ae,[c(`div`,je,[c(`aside`,Me,[u[22]||=c(`h3`,null,`📚 Bài học`,-1),c(`ul`,Ne,[(o(!0),a(r,null,n(g.lessons,(e,n)=>(o(),a(`li`,{key:n,class:t([`ai-lesson-item`,{active:g.selectedLesson===n}]),onClick:e=>g.selectedLesson=n},[c(`span`,null,p(e.title?.replace(/^📄 /,``)),1),c(`span`,$,p(_.getLessonProgress(n)),1)],10,Pe))),128))]),c(`div`,Fe,[c(`span`,null,p(_.lessonProgress.done)+` / `+p(_.lessonProgress.total),1),c(`div`,Ie,[c(`div`,{class:`progress-fill`,style:e({width:_.lessonProgress.percent+`%`})},null,4)])])]),c(`div`,Le,[c(`div`,Re,[c(`h2`,null,p(g.lessons[g.selectedLesson]?.title),1),c(`div`,{class:`lesson-body`,innerHTML:_.renderedLesson},null,8,ze)])])])])):i(``,!0)])])}var Ve=u(W,[[`render`,Be],[`__scopeId`,`data-v-f6afc003`]]);export{Ve as default};