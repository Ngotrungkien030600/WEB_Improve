import{F as e,H as t,I as n,M as r,O as i,y as a}from"./index-MzO-v9ny.js";import{n as o}from"./navigate-BtkC05lP.js";var s={name:`FrontendJavaScriptPage`,methods:{handleNav(e){o(e)}}},c={class:`js-page`,style:{"--color-accent":`#f59e0b`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(a,o,s,f,p,m){return t(),e(`div`,c,[r(`div`,l,[r(`div`,u,[o[2]||=r(`h1`,null,`⚡ JavaScript`,-1),r(`div`,d,[r(`a`,{href:`#`,onClick:o[0]||=i(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),r(`a`,{href:`#`,onClick:o[1]||=i(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=n(`<p class="desc" data-v-eeaf1192>ES6+, DOM, Async/Await, Closure, Promise, Event Loop, Web API, TypeScript cơ bản.</p><div class="section" data-v-eeaf1192><h2 data-v-eeaf1192>📦 ES6+ Features</h2><pre data-v-eeaf1192><code data-v-eeaf1192>const add = (a, b) =&gt; a + b;                     // Arrow
