...
System.out.println(a % b);`,question:`In ra 2 dòng gì?`,options:[`3 và 1`,`3.33 và 1`,`3 và 0`,`3.33 và 0.33`],answer:0,explain:`Chia 2 int bỏ phần dư: 10/3 = 3. % lấy phần dư: 10%3 = 1.`}]},re={class:`tu-zero-page`},ie={class:`tz-header`},h={class:`tz-heading`},g={class:`tz-tabs`},_=[`onClick`],v={class:`tz-chapter-head`},y={class:`tz-time`},b={class:`tz-intro`},x={class:`code-title`},S={key:0,class:`tz-quiz`},C={class:`quiz-q`},w={class:`quiz-options`},T=[`disabled`,`onClick`],E={key:0,class:`quiz-why`},D={key:1,class:`tz-section`},O={class:`tz-chapter-head`},k={class:`tz-time`},A={class:`ex-head`},j={class:`ex-task`},M={class:`ex-buttons`},N=[`onClick`],P=[`onClick`],F={key:0,class:`ex-hint`},I={key:1,class:`ex-answer`},ae={class:`code-card`},L={class:`ex-explain`},R={key:2,class:`tz-section`},z={class:`tz-chapter-head`},B={class:`tz-time`},V={class:`rc-index`},H={class:`code-card`},U={class:`quiz-q`},W={class:`quiz-options`},G=[`disabled`,`onClick`],K={key:0,class:`quiz-why`},q=d({__name:`JavaTuZeroPage`,setup(d){let q=ee(()=>m.chapters),J=te(`ch1`),Y=a({}),X=a({}),Z=a({});function Q(e,t){return e+`-`+t}function oe(e){return e.startsWith(`rc-`)?X:Y}function $(e,t,n,r){let i=e===`rc`?`rc-`+t:Q(e,t),a=oe(i)[i];return a===void 0?{}:n===r?{correct:!0}:n===a?{wrong:!0}:{}}function se(e,t,n){let r=Q(e,t);Y[r]===void 0&&(Y[r]=n)}function ce(e,t){let n=`rc-`+e;X[n]===void 0&&(X[n]=t)}function le(e){Z[e]||(Z[e]={hint:!1,answer:!1}),Z[e].hint=!Z[e].hint}function ue(e){Z[e]||(Z[e]={hint:!1,answer:!1}),Z[e].answer=!Z[e].answer}function de(e){return e===`easy`?`Dễ`:e===`medium`?`Trung bình`:`Khó`}function fe(){ne(`/java/hub`)}return(a,d)=>(c(),s(`div`,re,[e(`header`,ie,[e(`button`,{class:`tz-back`,onClick:fe},`← Java`),e(`div`,h,[d[2]||=e(`h1`,null,`🌱 Java Từ 0 — mất gốc → đi làm`,-1),e(`p`,null,` Dành cho người yếu Java và tư duy lập trình: 6 chương nền tảng + quiz, `+u(i(m).exercises.length)+` bài tập có lời giải từng bước, `+u(i(m).readCode.length)+` bài đọc-code đoán kết quả. `,1)])]),e(`nav`,g,[(c(!0),s(t,null,p(i(m).chapters,e=>(c(),s(`button`,{key:e.id,class:l([`tz-tab`,{active:J.value===e.id}]),onClick:t=>J.value=e.id},u(e.emoji)+` `+u(e.title),11,_))),128)),e(`button`,{class:l([`tz-tab`,{active:J.value===`exercises`}]),onClick:d[0]||=e=>J.value=`exercises`},` 💪 Bài tập `,2),e(`button`,{class:l([`tz-tab`,{active:J.value===`readcode`}]),onClick:d[1]||=e=>J.value=`readcode`},` 🔍 Đọc code `,2)]),J.value.startsWith(`ch`)?(c(!0),s(t,{key:0},p(q.value,n=>r((c(),s(`section`,{key:n.id,class:`tz-section`},[e(`div`,v,[e(`h2`,null,u(n.emoji)+` `+u(n.title),1),e(`span`,y,`⏱️ `+u(n.time),1)]),e(`p`,b,u(n.intro),1),(c(!0),s(t,null,p(n.lessons,n=>(c(),s(`div`,{key:n.title,class:`tz-lesson`},[e(`h3`,null,u(n.title),1),(c(!0),s(t,null,p(n.paragraphs,(e,t)=>(c(),s(`p`,{key:t,class:`tz-para`},u(e),1))),128)),(c(!0),s(t,null,p(n.codes,t=>(c(),s(`div`,{key:t.title,class:`code-card`},[e(`div`,x,u(t.title),1),e(`pre`,null,[e(`code`,null,u(t.code),1)])]))),128))]))),128)),n.quiz&&n.quiz.length?(c(),s(`div`,S,[d[3]||=e(`h3`,null,`✅ Kiểm tra nhanh — hiểu rồi mới sang bài sau`,-1),(c(!0),s(t,null,p(n.quiz,(r,i)=>(c(),s(`div`,{key:i,class:`quiz-item`},[e(`p`,C,u(r.q),1),e(`div`,w,[(c(!0),s(t,null,p(r.options,(e,t)=>(c(),s(`button`,{key:t,class:l([`quiz-opt`,$(n.id,i,t,r.answer)]),disabled:Y[Q(n.id,i)]!==void 0,onClick:e=>se(n.id,i,t)},u(e),11,T))),128))]),Y[Q(n.id,i)]===void 0?o(``,!0):(c(),s(`p`,E,u(Y[Q(n.id,i)]===r.answer?`✅ Đúng. `:`❌ Chưa đúng. `)+` `+u(r.why),1))]))),128))])):o(``,!0)])),[[f,J.value===n.id]])),128)):J.value===`exercises`?(c(),s(`section`,D,[e(`div`,O,[d[4]||=e(`h2`,null,`💪 Bài tập luyện tư duy`,-1),e(`span`,k,u(i(m).exercises.length)+` bài · Dễ → Khó`,1)]),d[9]||=e(`p`,{class:`tz-intro`},` Quy tắc vàng: tự viết 20–30 phút KHÔNG được thì mới xem gợi ý; viết tiếp vẫn bí mới xem đáp án. Chép đáp án không rèn được tư duy — hiểu "vì sao" mới là mục tiêu. `,-1),(c(!0),s(t,null,p(i(m).exercises,t=>(c(),s(`div`,{key:t.id,class:`ex-card`},[e(`div`,A,[e(`span`,{class:l([`ex-level`,`lv-`+t.level])},u(de(t.level)),3),e(`h3`,null,u(t.title),1)]),e(`div`,j,[d[5]||=e(`strong`,null,`Đề bài:`,-1),n(` `+u(t.task),1)]),e(`div`,M,[e(`button`,{class:`ex-btn`,onClick:e=>le(t.id)},u(Z[t.id]&&Z[t.id].hint?`Ẩn gợi ý`:`💡 Xem gợi ý`),9,N),e(`button`,{class:`ex-btn primary`,onClick:e=>ue(t.id)},u(Z[t.id]&&Z[t.id].answer?`Ẩn đáp án`:`✅ Xem đáp án`),9,P)]),Z[t.id]&&Z[t.id].hint?(c(),s(`div`,F,[d[6]||=e(`strong`,null,`Cách nghĩ:`,-1),n(` `+u(t.hint),1)])):o(``,!0),Z[t.id]&&Z[t.id].answer?(c(),s(`div`,I,[e(`div`,ae,[d[7]||=e(`div`,{class:`code-title`},`Lời giải`,-1),e(`pre`,null,[e(`code`,null,u(t.solution),1)])]),e(`p`,L,[d[8]||=e(`strong`,null,`Vì sao:`,-1),n(` `+u(t.explain),1)])])):o(``,!0)]))),128))])):(c(),s(`section`,R,[e(`div`,z,[d[10]||=e(`h2`,null,`🔍 Đọc code — đoán kết quả`,-1),e(`span`,B,u(i(m).readCode.length)+` câu hỏi bẫy`,1)]),d[11]||=e(`p`,{class:`tz-intro`},` Cách rèn "tư duy lập trình" nhanh nhất: đọc code như máy tính, chạy từng dòng trong đầu rồi đoán output. Sai bao nhiêu cũng được — đọc kỹ phần giải thích. `,-1),(c(!0),s(t,null,p(i(m).readCode,(n,r)=>(c(),s(`div`,{key:r,class:`rc-card`},[e(`span`,V,`Câu `+u(r+1),1),e(`div`,H,[e(`pre`,null,[e(`code`,null,u(n.code),1)])]),e(`p`,U,u(n.question),1),e(`div`,W,[(c(!0),s(t,null,p(n.options,(e,t)=>(c(),s(`button`,{key:t,class:l([`quiz-opt`,$(`rc`,r,t,n.answer)]),disabled:X[`rc-`+r]!==void 0,onClick:e=>ce(r,t)},u(e),11,G))),128))]),X[`rc-`+r]===void 0?o(``,!0):(c(),s(`p`,K,u(X[`rc-`+r]===n.answer?`✅ Đúng. `:`❌ Chưa đúng. `)+` `+u(n.explain),1))]))),128))]))]))}},[[`__scopeId`,`data-v-2203e295`]]);export{q as default};