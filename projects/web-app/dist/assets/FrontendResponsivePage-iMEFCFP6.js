import{F as e,H as t,I as n,M as r,O as i,y as a}from"./index-C8K8osaj.js";import{n as o}from"./navigate-DpWPbedo.js";var s={name:`FrontendResponsivePage`,methods:{handleNav(e){o(e)}}},c={class:`responsive-page`,style:{"--color-accent":`#34d399`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(a,o,s,f,p,m){return t(),e(`div`,c,[r(`div`,l,[r(`div`,u,[o[2]||=r(`h1`,null,`📱 Responsive Design`,-1),r(`div`,d,[r(`a`,{href:`#`,onClick:o[0]||=i(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),r(`a`,{href:`#`,onClick:o[1]||=i(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=n(`<p class="desc" data-v-19dd2eda>Media Queries, Container Queries, Mobile-first, Fluid typography, Breakpoint system.</p><div class="section" data-v-19dd2eda><h2 data-v-19dd2eda>📐 Breakpoint System</h2><pre data-v-19dd2eda><code data-v-19dd2eda>/* Mobile-first: base styles cho mobile, mở rộng dần */
