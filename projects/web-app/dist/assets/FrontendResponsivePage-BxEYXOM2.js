import{B as e,D as t,F as n,P as r,j as i,v as a}from"./index-DgMtGGTp.js";import{n as o}from"./navigate-CTQGF1Xi.js";var s={name:`FrontendResponsivePage`,methods:{handleNav(e){o(e)}}},c={class:`responsive-page`,style:{"--color-accent":`#34d399`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(a,o,s,f,p,m){return e(),r(`div`,c,[i(`div`,l,[i(`div`,u,[o[2]||=i(`h1`,null,`📱 Responsive Design`,-1),i(`div`,d,[i(`a`,{href:`#`,onClick:o[0]||=t(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),i(`a`,{href:`#`,onClick:o[1]||=t(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=n(`<p class="desc" data-v-19dd2eda>Media Queries, Container Queries, Mobile-first, Fluid typography, Breakpoint system.</p><div class="section" data-v-19dd2eda><h2 data-v-19dd2eda>📐 Breakpoint System</h2><pre data-v-19dd2eda><code data-v-19dd2eda>/* Mobile-first: base styles cho mobile, mở rộng dần */
