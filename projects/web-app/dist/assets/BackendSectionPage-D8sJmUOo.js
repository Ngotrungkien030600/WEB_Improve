import{F as e,G as t,H as n,I as r,L as i,M as a,N as o,O as s,Q as c,R as l,V as u,W as d,et as f,k as p,y as m}from"./index-5Qa7uoRc.js";import{n as h}from"./navigate-CUQawh9L.js";import{t as g}from"./CodeBlock-BUJdWzT2.js";var _=`-- B-Tree index (mặc định) — tốt cho =, >, <, BETWEEN, LIKE 'abc%'
...
-- Covering index
CREATE INDEX idx_covering ON users(email) INCLUDE (name, avatar_url);`,ee=`-- Pessimistic Lock
...
services:
  ...
  db:
    ...
    healthcheck:
      test: ["CMD-SHELL", "pg_isready -U postgres"]`,A={name:`BackendSectionDocker`,components:{CodeBlock:g},data(){return{dockerfileCode:O,dockerComposeCode:k}}},j={class:`bs-section`};function M(t,n,o,s,c,f){let p=d(`CodeBlock`);return u(),e(`div`,j,[n[0]||=r(`<h3 data-v-2f60ffe5>Docker — tại sao mọi backend team cần?</h3><p class="section-text" data-v-2f60ffe5>Docker đóng gói app + môi trường (JDK, dependencies, config) vào 1 image chạy được ở <strong data-v-2f60ffe5>mọi nơi</strong>: máy dev, CI, server. Hết bài toán &quot;chạy được trên máy tôi&quot;. Đây là nền tảng cho microservices, K8s, và CI/CD — deploy cùng 1 image từ dev đến production.</p><h3 data-v-2f60ffe5>Dockerfile cho Spring Boot — multi-stage build</h3><p class="section-text" data-v-2f60ffe5>Multi-stage tách 2 giai đoạn: <strong data-v-2f60ffe5>build</strong> (đầy đủ JDK + Maven) và <strong data-v-2f60ffe5>runtime</strong> (chỉ JRE nhẹ). Image cuối nhỏ hơn nhiều, an toàn hơn. Chạy với <strong data-v-2f60ffe5>user non-root</strong> và <code data-v-2f60ffe5>HEALTHCHECK</code> — để K8s biết app còn sống không.</p>`,4),l(p,{code:c.dockerfileCode,language:`dockerfile`},null,8,[`code`]),n[1]||=a(`h3`,null,`docker-compose — chạy nhiều service cùng lúc`,-1),n[2]||=a(`p`,{class:`section-text`},[i(`Một file YAML khai báo toàn bộ stack: app + PostgreSQL + Redis... `),a(`code`,null,`depends_on + healthcheck`),i(` đảm bảo app chỉ start khi DB sẵn sàng — chuẩn cho local dev và cả staging.`)],-1),l(p,{code:c.dockerComposeCode,language:`yaml`},null,8,[`code`])])}var N=m(A,[[`render`,M],[`__scopeId`,`data-v-2f60ffe5`]]),P=`# deployment.yml
apiVersion: apps/v1
kind: Deployment
metadata:
  name: user-service
  ...
  metrics:
    - type: Resource
      resource:
        ...
        target:
          type: Utilization
          averageUtilization: 70`,L={name:`BackendSectionK8s`,components:{CodeBlock:g},data(){return{k8sDeploymentCode:P,k8sConfigMapCode:F,k8sHpaCode:I}}},R={class:`bs-section`};function z(t,n,o,s,c,f){let p=d(`CodeBlock`);return u(),e(`div`,R,[n[0]||=r(`<h3 data-v-c2e833ad>Kubernetes — tại sao cần khi đã có Docker?</h3><p class="section-text" data-v-c2e833ad>Docker chạy container, nhưng <strong data-v-c2e833ad>K8s quản lý hàng trăm container</strong>: tự deploy, scale, self-heal, load balance. Khi traffic tăng, K8s tự tạo thêm pod; pod chết thì tự tạo lại. Đây là lớp vận hành mà production thật cần — Docker chỉ giải quyết 1 container, K8s giải quyết cả hệ thống.</p><h3 data-v-c2e833ad>Deployment &amp; Service — khai báo trạng thái mong muốn</h3><p class="section-text" data-v-c2e833ad><strong data-v-c2e833ad>Deployment</strong> khai báo &quot;tôi muốn 3 replicas&quot; — K8s tự duy trì con số đó. <strong data-v-c2e833ad>RollingUpdate</strong> thay từng pod một, không downtime. <strong data-v-c2e833ad>Probes</strong> (liveness/readiness) giúp K8s biết pod sống và sẵn sàng nhận traffic — app phải expose <code data-v-c2e833ad>/actuator/health</code>.</p>`,4),l(p,{code:c.k8sDeploymentCode,language:`yaml`},null,8,[`code`]),n[1]||=a(`h3`,null,`ConfigMap & Secret — tách config khỏi image`,-1),n[2]||=a(`p`,{class:`section-text`},[a(`strong`,null,`ConfigMap`),i(` chứa cấu hình không nhạy cảm (application.yml), `),a(`strong`,null,`Secret`),i(` chứa dữ liệu mật (password, token). Tách ra để: đổi config không cần build lại image, và không bao giờ commit secret vào repo/image.`)],-1),l(p,{code:c.k8sConfigMapCode,language:`yaml`},null,8,[`code`]),n[3]||=a(`h3`,null,`HPA — tự scale theo tải`,-1),n[4]||=a(`p`,{class:`section-text`},[a(`strong`,null,`HorizontalPodAutoscaler`),i(` tự tăng/giảm số pod theo CPU/memory. Chạy 2 pod lúc thấp điểm, scale lên 10 khi cao điểm, rồi tự giảm về — không cần can thiệp tay, tiết kiệm chi phí.`)],-1),l(p,{code:c.k8sHpaCode,language:`yaml`},null,8,[`code`])])}var B=m(L,[[`render`,z],[`__scopeId`,`data-v-c2e833ad`]]),V=`name: Build and Deploy
on:
  push:
    branches: [main]
...
// CDC Worker — Debezium capture changes từ outbox → publish lên Kafka`,pe={name:`BackendSectionArch`,components:{CodeBlock:g},data(){return{outboxCode:fe}}},me={class:`bs-section`};function he(t,n,i,a,o,s){let c=d(`CodeBlock`);return u(),e(`div`,me,[n[0]||=r(`<h3 data-v-18ae645f>Architecture Patterns — chọn kiến trúc theo bài toán</h3><div class="cards-grid cols-4" data-v-18ae645f><div class="info-card" data-v-18ae645f><h4 data-v-18ae645f>Monolithic</h4><p data-v-18ae645f>1 ứng dụng, 1 DB. Đơn giản, dễ develop. Giới hạn: scaling — phải scale cả app khi chỉ 1 module nóng.</p></div><div class="info-card" data-v-18ae645f><h4 data-v-18ae645f>Microservices</h4><p data-v-18ae645f>Nhiều service nhỏ, độc lập. Cần: API Gateway, service discovery. Phức tạp hơn nhưng scale và deploy độc lập.</p></div><div class="info-card" data-v-18ae645f><h4 data-v-18ae645f>CQRS + Event Sourcing</h4><p data-v-18ae645f>Tách read/write model. Lưu events thay vì state. Read model tối ưu riêng cho query.</p></div><div class="info-card" data-v-18ae645f><h4 data-v-18ae645f>Event-Driven</h4><p data-v-18ae645f>Service giao tiếp qua events (Kafka). Saga pattern. Tách rời, chịu lỗi tốt nhưng khó debug hơn.</p></div></div><h3 data-v-18ae645f>Outbox Pattern — đảm bảo &quot;ghi DB + gửi event&quot; cùng xảy ra</h3><p class="section-text" data-v-18ae645f>Vấn đề: ghi Order vào DB xong gửi event lên Kafka — nếu gửi event fail, dữ liệu ghi rồi nhưng hệ thống khác không biết (mất event). <strong data-v-18ae645f>Outbox Pattern:</strong> ghi event vào bảng <code data-v-18ae645f>outbox</code> <strong data-v-18ae645f>trong cùng transaction</strong> với Order. Sau đó CDC Worker (Debezium) đọc bảng outbox và publish lên Kafka — đảm bảo không mất event, không trùng.</p>`,4),l(c,{code:o.outboxCode,language:`java`},null,8,[`code`])])}var Z=m(pe,[[`render`,he],[`__scopeId`,`data-v-18ae645f`]]),ge={name:`BackendSectionInterview`,methods:{handleNav(e){h(e)}}},_e={class:`bs-section`},ve={class:`interview-cta`};function ye(t,n,i,o,c,l){return u(),e(`div`,_e,[n[1]||=r(`<h3 data-v-9fa7f757>Câu hỏi theo level — bạn đang ở đâu?</h3><p class="section-text" data-v-9fa7f757>Các câu hỏi phỏng vấn backend thường tăng dần theo level: Junior hỏi nền tảng, Middle hỏi vận hành, Senior hỏi thiết kế &amp; xử lý sự cố, Architect hỏi kiến trúc hệ thống. Luyện từ level của bạn trở lên để sẵn sàng.</p><div class="cards-grid cols-4" data-v-9fa7f757><div class="info-card level-junior" data-v-9fa7f757><h4 data-v-9fa7f757>🌱 Junior</h4><ul data-v-9fa7f757><li data-v-9fa7f757>ACID là gì?</li><li data-v-9fa7f757>INNER JOIN vs LEFT JOIN?</li><li data-v-9fa7f757>INDEX hoạt động thế nào?</li><li data-v-9fa7f757>Transaction isolation levels?</li><li data-v-9fa7f757>GET vs POST?</li></ul></div><div class="info-card level-middle" data-v-9fa7f757><h4 data-v-9fa7f757>📈 Middle</h4><ul data-v-9fa7f757><li data-v-9fa7f757>N+1 problem + fix?</li><li data-v-9fa7f757>Optimistic vs Pessimistic lock?</li><li data-v-9fa7f757>Redis dùng để làm gì?</li><li data-v-9fa7f757>Kafka partition?</li><li data-v-9fa7f757>Docker multi-stage build?</li></ul></div><div class="info-card level-senior" data-v-9fa7f757><h4 data-v-9fa7f757>🎯 Senior</h4><ul data-v-9fa7f757><li data-v-9fa7f757>CAP theorem?</li><li data-v-9fa7f757>Saga pattern?</li><li data-v-9fa7f757>Distributed caching?</li><li data-v-9fa7f757>Circuit Breaker?</li></ul></div><div class="info-card level-architect" data-v-9fa7f757><h4 data-v-9fa7f757>🏗️ Architect</h4><ul data-v-9fa7f757><li data-v-9fa7f757>Design URL shortener?</li><li data-v-9fa7f757>Design chat 10M users?</li><li data-v-9fa7f757>CQRS + Event Sourcing?</li></ul></div></div>`,3),a(`div`,ve,[a(`a`,{href:`#`,onClick:n[0]||=s(e=>l.handleNav(`/salary-interview`),[`prevent`])},`💰 Luyện phỏng vấn theo mức lương →`)])])}var Q=m(ge,[[`render`,ye],[`__scopeId`,`data-v-9fa7f757`]]),be=[{id:`sql`,num:`01`,title:`SQL & Database`,component:x},{id:`nosql`,num:`02`,title:`NoSQL Databases`,component:S},{id:`mq`,num:`03`,title:`Message Queue`,component:D},{id:`docker`,num:`04`,title:`Docker`,component:N},{id:`k8s`,num:`05`,title:`Kubernetes`,component:B},{id:`cicd`,num:`06`,title:`CI/CD`,component:G},{id:`design`,num:`07`,title:`System Design`,component:Y},{id:`perf`,num:`08`,title:`Performance Optimization`,component:X},{id:`arch`,num:`09`,title:`Architecture Patterns`,component:Z},{id:`interview`,num:`10`,title:`Câu hỏi phỏng vấn`,component:Q}],xe={name:`BackendSectionPage`,components:{SectionSql:x,SectionNosql:S,SectionMq:D,SectionDocker:N,SectionK8s:B,SectionCicd:G,SectionDesign:Y,SectionPerf:X,SectionArch:Z,SectionInterview:Q},data(){return{sections:be}},computed:{currentId(){return this.$route.params.sectionId},current(){return this.sections.find(e=>e.id===this.currentId)||null},currentComponent(){return this.current?this.current.component:null},currentTitle(){return this.current?this.current.title:``},currentNum(){return this.current?this.current.num:``},currentIndex(){return this.sections.findIndex(e=>e.id===this.currentId)},prev(){let e=this.currentIndex;return e>0?this.sections[e-1]:null},next(){let e=this.currentIndex;return e>=0&&e<this.sections.length-1?this.sections[e+1]:null},prevTitle(){return this.prev?this.prev.title:``},nextTitle(){return this.next?this.next.title:``}},mounted(){this.ensureValid()},watch:{"$route.params.sectionId"(){this.ensureValid()}},methods:{ensureValid(){this.current?window.scrollTo({top:0,behavior:`smooth`}):h(`/java/backend/sql`,{target:`router`})},handleNav(e){h(e)},goTo(e){h(`/java/backend/${e}`,{target:`router`})}}},Se={class:`backend-section-page`},Ce={class:`page-header`},we={class:`header-content`},Te={class:`header-nav`},Ee={class:`page-content`},De={class:`sidebar-toc`},Oe={class:`toc-container`},ke={class:`toc-nav`},Ae=[`onClick`],je={class:`toc-num`},Me={class:`toc-text`},Ne={class:`main-content`},Pe={class:`content-section`},$={class:`section-header`},Fe={class:`section-num`},Ie={class:`section-title`},Le={class:`section-body`},Re={class:`pager`},ze=[`disabled`],Be=[`disabled`];function Ve(r,i,l,d,m,h){return u(),e(`div`,Se,[a(`header`,Ce,[a(`div`,we,[a(`div`,Te,[a(`button`,{class:`nav-btn`,onClick:i[0]||=e=>h.handleNav(`/java/hub`)},[...i[4]||=[a(`span`,null,`←`,-1),a(`span`,null,`Java`,-1)]]),a(`button`,{class:`nav-btn`,onClick:i[1]||=e=>h.handleNav(`/`)},[...i[5]||=[a(`span`,null,`🏠`,-1),a(`span`,null,`Trang chủ`,-1)]])]),i[6]||=a(`div`,{class:`header-title`},[a(`h1`,null,`⚙️ Backend Engineering`),a(`p`,{class:`desc`},`Database, Message Queue, Docker, K8s, CI/CD, System Design, Performance`)],-1)])]),a(`div`,Ee,[a(`aside`,De,[a(`div`,Oe,[i[7]||=a(`h3`,{class:`toc-title`},`Các bài học`,-1),a(`nav`,ke,[(u(!0),e(p,null,n(m.sections,t=>(u(),e(`a`,{key:t.id,href:`#`,class:c([`toc-link`,{active:t.id===h.currentId}]),onClick:s(e=>h.goTo(t.id),[`prevent`])},[a(`span`,je,f(t.num)+`.`,1),a(`span`,Me,f(t.title),1)],10,Ae))),128))])])]),a(`main`,Ne,[a(`section`,Pe,[a(`div`,$,[a(`span`,Fe,f(h.currentNum),1),a(`h2`,Ie,f(h.currentTitle),1)]),a(`div`,Le,[(u(),o(t(h.currentComponent)))])]),a(`div`,Re,[a(`button`,{class:`pager-btn`,disabled:!h.prev,onClick:i[2]||=e=>h.goTo(h.prev.id)},` ← `+f(h.prevTitle),9,ze),a(`button`,{class:`pager-btn next`,disabled:!h.next,onClick:i[3]||=e=>h.goTo(h.next.id)},f(h.nextTitle)+` → `,9,Be)])])])])}var He=m(xe,[[`render`,Ve],[`__scopeId`,`data-v-c42a4c37`]]);export{He as default};