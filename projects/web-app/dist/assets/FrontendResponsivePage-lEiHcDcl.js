import{A as e,E as t,N as n,P as r,R as i,_ as a}from"./index-CaZw3_YQ.js";import{n as o}from"./navigate-CdhFtmit.js";var s={name:`FrontendResponsivePage`,methods:{handleNav(e){o(e)}}},c={class:`responsive-page`,style:{"--color-accent":`#34d399`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(a,o,s,f,p,m){return i(),n(`div`,c,[e(`div`,l,[e(`div`,u,[o[2]||=e(`h1`,null,`📱 Responsive Design`,-1),e(`div`,d,[e(`a`,{href:`#`,onClick:o[0]||=t(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),e(`a`,{href:`#`,onClick:o[1]||=t(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=r(`<p class="desc" data-v-19dd2eda>Media Queries, Container Queries, Mobile-first, Fluid typography, Breakpoint system.</p><div class="section" data-v-19dd2eda><h2 data-v-19dd2eda>📐 Breakpoint System</h2><pre data-v-19dd2eda><code data-v-19dd2eda>/* Mobile-first: base styles cho mobile, mở rộng dần */
