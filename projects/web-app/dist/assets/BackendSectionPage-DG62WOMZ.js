import{C as e,D as t,E as n,F as r,N as ee,b as i,d as a,f as o,g as s,h as c,i as l,v as u,w as d,x as f,y as p}from"./index-DF7F7VnS.js";import{t as m}from"./navigate-DoDAyYnU.js";import{t as h}from"./CodeBlock-hhtJftAV.js";var g=`-- B-Tree index (mặc định) — tốt cho =, >, <, BETWEEN, LIKE 'abc%'
  ...
  metrics:
    - type: Resource
      resource:
        ...
        target:
          type: Utilization
          averageUtilization: 70`,L={name:`BackendSectionK8s`,components:{CodeBlock:h},data(){return{k8sDeploymentCode:P,k8sConfigMapCode:F,k8sHpaCode:I}}},R={class:`bs-section`};function z(t,r,ee,a,o,s){let l=n(`CodeBlock`);return e(),u(`div`,R,[r[0]||=p(`<h3 data-v-c2e833ad>Kubernetes — tại sao cần khi đã có Docker?</h3><p class="section-text" data-v-c2e833ad>Docker chạy container, nhưng <strong data-v-c2e833ad>K8s quản lý hàng trăm container</strong>: tự deploy, scale, self-heal, load balance. Khi traffic tăng, K8s tự tạo thêm pod; pod chết thì tự tạo lại. Đây là lớp vận hành mà production thật cần — Docker chỉ giải quyết 1 container, K8s giải quyết cả hệ thống.</p><h3 data-v-c2e833ad>Deployment &amp; Service — khai báo trạng thái mong muốn</h3><p class="section-text" data-v-c2e833ad><strong data-v-c2e833ad>Deployment</strong> khai báo &quot;tôi muốn 3 replicas&quot; — K8s tự duy trì con số đó. <strong data-v-c2e833ad>RollingUpdate</strong> thay từng pod một, không downtime. <strong data-v-c2e833ad>Probes</strong> (liveness/readiness) giúp K8s biết pod sống và sẵn sàng nhận traffic — app phải expose <code data-v-c2e833ad>/actuator/health</code>.</p>`,4),f(l,{code:o.k8sDeploymentCode,language:`yaml`},null,8,[`code`]),r[1]||=c(`h3`,null,`ConfigMap & Secret — tách config khỏi image`,-1),r[2]||=c(`p`,{class:`section-text`},[c(`strong`,null,`ConfigMap`),i(` chứa cấu hình không nhạy cảm (application.yml), `),c(`strong`,null,`Secret`),i(` chứa dữ liệu mật (password, token). Tách ra để: đổi config không cần build lại image, và không bao giờ commit secret vào repo/image.`)],-1),f(l,{code:o.k8sConfigMapCode,language:`yaml`},null,8,[`code`]),r[3]||=c(`h3`,null,`HPA — tự scale theo tải`,-1),r[4]||=c(`p`,{class:`section-text`},[c(`strong`,null,`HorizontalPodAutoscaler`),i(` tự tăng/giảm số pod theo CPU/memory. Chạy 2 pod lúc thấp điểm, scale lên 10 khi cao điểm, rồi tự giảm về — không cần can thiệp tay, tiết kiệm chi phí.`)],-1),f(l,{code:o.k8sHpaCode,language:`yaml`},null,8,[`code`])])}var B=l(L,[[`render`,z],[`__scopeId`,`data-v-c2e833ad`]]),V=`name: Build and Deploy
on:
  push:
    branches: [main]
