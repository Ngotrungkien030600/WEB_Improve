...
System.out.println(a % b);`,question:`In ra 2 dòng gì?`,options:[`3 và 1`,`3.33 và 1`,`3 và 0`,`3.33 và 0.33`],answer:0,explain:`Chia 2 int bỏ phần dư: 10/3 = 3. % lấy phần dư: 10%3 = 1.`}]},ie={class:`tu-zero-page`},m={class:`tz-header`},h={class:`tz-heading`},g={class:`tz-tabs`},_=[`onClick`],v={class:`tz-chapter-head`},y={class:`tz-time`},b={class:`tz-intro`},x={class:`code-title`},S={key:0,class:`tz-quiz`},C={class:`quiz-q`},w={class:`quiz-options`},T=[`disabled`,`onClick`],E={key:0,class:`quiz-why`},D={key:1,class:`tz-section`},O={class:`tz-chapter-head`},k={class:`tz-time`},A={class:`ex-head`},j={class:`ex-task`},M={class:`ex-buttons`},N=[`onClick`],P=[`onClick`],F={key:0,class:`ex-hint`},ae={key:1,class:`ex-answer`},I={class:`code-card`},L={class:`ex-explain`},R={key:2,class:`tz-section`},z={class:`tz-chapter-head`},B={class:`tz-time`},V={class:`rc-index`},H={class:`code-card`},U={class:`quiz-q`},W={class:`quiz-options`},G=[`disabled`,`onClick`],K={key:0,class:`quiz-why`},q=te({__name:`JavaTuZeroPage`,setup(te){let q=ee(()=>p.chapters),J=r(`ch1`),Y=n({}),X=n({}),Z=n({});function Q(e,t){return e+`-`+t}function oe(e){return e.startsWith(`rc-`)?X:Y}function $(e,t,n,r){let i=e===`rc`?`rc-`+t:Q(e,t),a=oe(i)[i];return a===void 0?{}:n===r?{correct:!0}:n===a?{wrong:!0}:{}}function se(e,t,n){let r=Q(e,t);Y[r]===void 0&&(Y[r]=n)}function ce(e,t){let n=`rc-`+e;X[n]===void 0&&(X[n]=t)}function le(e){Z[e]||(Z[e]={hint:!1,answer:!1}),Z[e].hint=!Z[e].hint}function ue(e){Z[e]||(Z[e]={hint:!1,answer:!1}),Z[e].answer=!Z[e].answer}function de(e){return e===`easy`?`Dễ`:e===`medium`?`Trung bình`:`Khó`}function fe(){re(`/java/hub`)}return(n,r)=>(u(),f(`div`,ie,[o(`header`,m,[o(`button`,{class:`tz-back`,onClick:fe},`← Java`),o(`div`,h,[r[2]||=o(`h1`,null,`🌱 Java Từ 0 — mất gốc → đi làm`,-1),o(`p`,null,` Dành cho người yếu Java và tư duy lập trình: 6 chương nền tảng + quiz, `+t(i(p).exercises.length)+` bài tập có lời giải từng bước, `+t(i(p).readCode.length)+` bài đọc-code đoán kết quả. `,1)])]),o(`nav`,g,[(u(!0),f(c,null,a(i(p).chapters,n=>(u(),f(`button`,{key:n.id,class:e([`tz-tab`,{active:J.value===n.id}]),onClick:e=>J.value=n.id},t(n.emoji)+` `+t(n.title),11,_))),128)),o(`button`,{class:e([`tz-tab`,{active:J.value===`exercises`}]),onClick:r[0]||=e=>J.value=`exercises`},` 💪 Bài tập `,2),o(`button`,{class:e([`tz-tab`,{active:J.value===`readcode`}]),onClick:r[1]||=e=>J.value=`readcode`},` 🔍 Đọc code `,2)]),J.value.startsWith(`ch`)?(u(!0),f(c,{key:0},a(q.value,n=>s((u(),f(`section`,{key:n.id,class:`tz-section`},[o(`div`,v,[o(`h2`,null,t(n.emoji)+` `+t(n.title),1),o(`span`,y,`⏱️ `+t(n.time),1)]),o(`p`,b,t(n.intro),1),(u(!0),f(c,null,a(n.lessons,e=>(u(),f(`div`,{key:e.title,class:`tz-lesson`},[o(`h3`,null,t(e.title),1),(u(!0),f(c,null,a(e.paragraphs,(e,n)=>(u(),f(`p`,{key:n,class:`tz-para`},t(e),1))),128)),(u(!0),f(c,null,a(e.codes,e=>(u(),f(`div`,{key:e.title,class:`code-card`},[o(`div`,x,t(e.title),1),o(`pre`,null,[o(`code`,null,t(e.code),1)])]))),128))]))),128)),n.quiz&&n.quiz.length?(u(),f(`div`,S,[r[3]||=o(`h3`,null,`✅ Kiểm tra nhanh — hiểu rồi mới sang bài sau`,-1),(u(!0),f(c,null,a(n.quiz,(r,i)=>(u(),f(`div`,{key:i,class:`quiz-item`},[o(`p`,C,t(r.q),1),o(`div`,w,[(u(!0),f(c,null,a(r.options,(a,o)=>(u(),f(`button`,{key:o,class:e([`quiz-opt`,$(n.id,i,o,r.answer)]),disabled:Y[Q(n.id,i)]!==void 0,onClick:e=>se(n.id,i,o)},t(a),11,T))),128))]),Y[Q(n.id,i)]===void 0?l(``,!0):(u(),f(`p`,E,t(Y[Q(n.id,i)]===r.answer?`✅ Đúng. `:`❌ Chưa đúng. `)+` `+t(r.why),1))]))),128))])):l(``,!0)])),[[ne,J.value===n.id]])),128)):J.value===`exercises`?(u(),f(`section`,D,[o(`div`,O,[r[4]||=o(`h2`,null,`💪 Bài tập luyện tư duy`,-1),o(`span`,k,t(i(p).exercises.length)+` bài · Dễ → Khó`,1)]),r[9]||=o(`p`,{class:`tz-intro`},` Quy tắc vàng: tự viết 20–30 phút KHÔNG được thì mới xem gợi ý; viết tiếp vẫn bí mới xem đáp án. Chép đáp án không rèn được tư duy — hiểu "vì sao" mới là mục tiêu. `,-1),(u(!0),f(c,null,a(i(p).exercises,n=>(u(),f(`div`,{key:n.id,class:`ex-card`},[o(`div`,A,[o(`span`,{class:e([`ex-level`,`lv-`+n.level])},t(de(n.level)),3),o(`h3`,null,t(n.title),1)]),o(`div`,j,[r[5]||=o(`strong`,null,`Đề bài:`,-1),d(` `+t(n.task),1)]),o(`div`,M,[o(`button`,{class:`ex-btn`,onClick:e=>le(n.id)},t(Z[n.id]&&Z[n.id].hint?`Ẩn gợi ý`:`💡 Xem gợi ý`),9,N),o(`button`,{class:`ex-btn primary`,onClick:e=>ue(n.id)},t(Z[n.id]&&Z[n.id].answer?`Ẩn đáp án`:`✅ Xem đáp án`),9,P)]),Z[n.id]&&Z[n.id].hint?(u(),f(`div`,F,[r[6]||=o(`strong`,null,`Cách nghĩ:`,-1),d(` `+t(n.hint),1)])):l(``,!0),Z[n.id]&&Z[n.id].answer?(u(),f(`div`,ae,[o(`div`,I,[r[7]||=o(`div`,{class:`code-title`},`Lời giải`,-1),o(`pre`,null,[o(`code`,null,t(n.solution),1)])]),o(`p`,L,[r[8]||=o(`strong`,null,`Vì sao:`,-1),d(` `+t(n.explain),1)])])):l(``,!0)]))),128))])):(u(),f(`section`,R,[o(`div`,z,[r[10]||=o(`h2`,null,`🔍 Đọc code — đoán kết quả`,-1),o(`span`,B,t(i(p).readCode.length)+` câu hỏi bẫy`,1)]),r[11]||=o(`p`,{class:`tz-intro`},` Cách rèn "tư duy lập trình" nhanh nhất: đọc code như máy tính, chạy từng dòng trong đầu rồi đoán output. Sai bao nhiêu cũng được — đọc kỹ phần giải thích. `,-1),(u(!0),f(c,null,a(i(p).readCode,(n,r)=>(u(),f(`div`,{key:r,class:`rc-card`},[o(`span`,V,`Câu `+t(r+1),1),o(`div`,H,[o(`pre`,null,[o(`code`,null,t(n.code),1)])]),o(`p`,U,t(n.question),1),o(`div`,W,[(u(!0),f(c,null,a(n.options,(i,a)=>(u(),f(`button`,{key:a,class:e([`quiz-opt`,$(`rc`,r,a,n.answer)]),disabled:X[`rc-`+r]!==void 0,onClick:e=>ce(r,a)},t(i),11,G))),128))]),X[`rc-`+r]===void 0?l(``,!0):(u(),f(`p`,K,t(X[`rc-`+r]===n.answer?`✅ Đúng. `:`❌ Chưa đúng. `)+` `+t(n.explain),1))]))),128))]))]))}},[[`__scopeId`,`data-v-2203e295`]]);export{q as default};