import{b as e,f as t,g as n,i as r,w as i,y as a}from"./index-D4zRvpF0.js";import{t as o}from"./navigate-CURE7lqT.js";var s={name:`FrontendResponsivePage`,methods:{handleNav(e){o(e)}}},c={class:`responsive-page`,style:{"--color-accent":`#34d399`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(r,o,s,f,p,m){return i(),a(`div`,c,[n(`div`,l,[n(`div`,u,[o[2]||=n(`h1`,null,`📱 Responsive Design`,-1),n(`div`,d,[n(`a`,{href:`#`,onClick:o[0]||=t(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),n(`a`,{href:`#`,onClick:o[1]||=t(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=e(`<p class="desc" data-v-19dd2eda>Media Queries, Container Queries, Mobile-first, Fluid typography, Breakpoint system.</p><div class="section" data-v-19dd2eda><h2 data-v-19dd2eda>📐 Breakpoint System</h2><pre data-v-19dd2eda><code data-v-19dd2eda>/* Mobile-first: base styles cho mobile, mở rộng dần */
...
/* Tự động đảo chiều khi dir=&quot;rtl&quot; */</code></pre></div>`,8)])])}var p=r(s,[[`render`,f],[`__scopeId`,`data-v-19dd2eda`]]);export{p as default};