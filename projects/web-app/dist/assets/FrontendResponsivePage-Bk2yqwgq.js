import{c as e,d as t,h as n,m as r,n as i,v as a}from"./index-0polZIe7.js";import{t as o}from"./navigate-DpwFjPeS.js";var s={name:`FrontendResponsivePage`,methods:{handleNav(e){o(e)}}},c={class:`responsive-page`,style:{"--color-accent":`#34d399`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(i,o,s,f,p,m){return a(),r(`div`,c,[t(`div`,l,[t(`div`,u,[o[2]||=t(`h1`,null,`📱 Responsive Design`,-1),t(`div`,d,[t(`a`,{href:`#`,onClick:o[0]||=e(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),t(`a`,{href:`#`,onClick:o[1]||=e(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=n(`<p class="desc" data-v-19dd2eda>Media Queries, Container Queries, Mobile-first, Fluid typography, Breakpoint system.</p><div class="section" data-v-19dd2eda><h2 data-v-19dd2eda>📐 Breakpoint System</h2><pre data-v-19dd2eda><code data-v-19dd2eda>/* Mobile-first: base styles cho mobile, mở rộng dần */
