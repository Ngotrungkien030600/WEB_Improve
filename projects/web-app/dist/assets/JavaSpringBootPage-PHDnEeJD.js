import{E as e,c as t,d as n,h as r,l as i,m as a,n as o,v as s,y as c}from"./index-0polZIe7.js";import{t as l}from"./navigate-DpwFjPeS.js";var u=[{id:`core`,num:`1`,title:`IoC & DI`},{id:`web`,num:`2`,title:`Spring MVC & REST`},{id:`jpa`,num:`3`,title:`JPA & Hibernate`},{id:`security`,num:`4`,title:`Security & JWT`},{id:`boot`,num:`5`,title:`Auto-config & Actuator`},{id:`async`,num:`6`,title:`Async & Scheduling`},{id:`test`,num:`7`,title:`Testing`},{id:`cloud`,num:`8`,title:`Microservices`}],d={name:`JavaSpringBootPage`,data(){return{tocSections:u}},methods:{handleNav(e){l(e)},scrollTo(e){let t=document.getElementById(e);t&&t.scrollIntoView({behavior:`smooth`,block:`start`})}}},f={class:`spring-boot-page`,style:{"--color-accent":`#22d3ee`}},p={class:`page`},m={class:`topbar`},h={class:`links`},g={class:`toc`},_=[`onClick`];function v(o,l,u,d,v,y){return s(),a(`div`,f,[n(`div`,p,[n(`div`,m,[l[2]||=n(`div`,null,[n(`h1`,null,`🍃 Spring Boot`),n(`p`,{class:`desc`},`Từ IoC/DI đến Microservices — code mẫu, kiến trúc, best practices`)],-1),n(`div`,h,[n(`a`,{href:`#`,onClick:l[0]||=t(e=>y.handleNav(`/java/hub`),[`prevent`])},`← Java`),n(`a`,{href:`#`,onClick:l[1]||=t(e=>y.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),n(`div`,g,[(s(!0),a(i,null,c(v.tocSections,n=>(s(),a(`a`,{key:n.id,href:`#`,onClick:t(e=>y.scrollTo(n.id),[`prevent`])},e(n.num)+`. `+e(n.title),9,_))),128))]),l[3]||=r(`<div class="section" id="core" data-v-5a275584><div class="section-title" data-v-5a275584>1. IoC (Inversion of Control) &amp; Dependency Injection</div><div class="section-body" data-v-5a275584><h3 data-v-5a275584>IoC Container là gì?</h3><p data-v-5a275584>IoC Container (ApplicationContext) quản lý vòng đời của beans — tạo, cấu hình, inject dependencies. Thay vì tự tạo object (<code data-v-5a275584>new UserService()</code>), bạn để Spring quản lý và inject khi cần.</p><h3 data-v-5a275584>Các cách inject</h3><pre data-v-5a275584><code data-v-5a275584>// 1. Field injection (không khuyến nghị — khó test)
@Service
...
spring:
  config:
    import: configserver:http://localhost:8888</code></pre><h3 data-v-5a275584>Best Practices Checklist</h3><ul data-v-5a275584><li data-v-5a275584><strong data-v-5a275584>Package structure:</strong> controller → service → repository → entity/dto</li><li data-v-5a275584><strong data-v-5a275584>DTO riêng:</strong> không expose entity ra ngoài</li><li data-v-5a275584><strong data-v-5a275584>Exception handling:</strong> Global exception handler</li><li data-v-5a275584><strong data-v-5a275584>Logging:</strong> SLF4J + MDC (traceId, userId)</li><li data-v-5a275584><strong data-v-5a275584>Transaction:</strong> @Transactional trên service layer</li><li data-v-5a275584><strong data-v-5a275584>Security:</strong> JWT + HTTPS, không hardcode secret</li><li data-v-5a275584><strong data-v-5a275584>Monitoring:</strong> Actuator + Micrometer + Prometheus</li></ul></div></div>`,8)])])}var y=o(d,[[`render`,v],[`__scopeId`,`data-v-5a275584`]]);export{y as default};