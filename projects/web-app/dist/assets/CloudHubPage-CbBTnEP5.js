import{C as e,D as t,N as n,S as r,T as i,g as a,l as o,m as s,n as c,p as l,u,y as d}from"./index-4YFT1SnF.js";import{t as f}from"./navigate-CQJaTUEf.js";import{t as p}from"./CTopbar-BrXuYpO4.js";import{t as m}from"./CGrid-ChA4pita.js";import{t as h}from"./CHubCard-B7lX1kK1.js";var g=[{id:`iam`,title:`1. IAM (Identity & Access Management)`,html:`<h3>IAM là gì?</h3>\r
...
\r
      ...
      <div class="grid-2">\r
        ...
        <div class="card"><h4>🌐 NAT Gateway</h4><p><strong>Outbound</strong> — cho private instances đi ra internet. Không cho ai vào từ ngoài.</p>`}],_=[{id:`iam`,num:`1`,title:`IAM & Security`},{id:`vpc`,num:`2`,title:`VPC & Networking`},{id:`ec2`,num:`3`,title:`EC2 & Auto Scaling`},{id:`lambda`,num:`4`,title:`Lambda & Serverless`},{id:`ecs`,num:`5`,title:`ECS & Containers`},{id:`s3`,num:`6`,title:`S3 & Storage`},{id:`rds`,num:`7`,title:`RDS & DynamoDB`},{id:`cicd`,num:`8`,title:`CodePipeline & DevOps`},{id:`arch`,num:`9`,title:`Architecture & Best Practices`},{id:`bastion`,num:`10`,title:`Bastion & Jump Host`}],v=[{icon:`🔐`,title:`IAM & Security`,description:`Users, Roles, Policies, MFA, Least Privilege`,path:`/cloud`,hash:`iam`},{icon:`🌐`,title:`VPC & Networking`,description:`Subnets, IGW, NAT, Security Groups, NACL`,path:`/cloud`,hash:`vpc`},{icon:`🖥️`,title:`EC2 & Auto Scaling`,description:`Instance types, ASG, Load Balancer, EBS`,path:`/cloud`,hash:`ec2`},{icon:`⚡`,title:`Lambda & Serverless`,description:`Functions, API Gateway, DynamoDB`,path:`/cloud`,hash:`lambda`},{icon:`🔀`,title:`ALB & NLB`,description:`Load Balancers, Target Groups, Health Checks`,path:`/cloud`,hash:`ec2`},{icon:`🚀`,title:`API Gateway`,description:`REST, HTTP, WebSocket, Lambda Authorizers`,path:`/cloud`,hash:`lambda`},{icon:`🔗`,title:`Lambda Invoke`,description:`S3, SQS, DynamoDB, EventBridge, CloudWatch`,path:`/cloud`,hash:`lambda`},{icon:`🪣`,title:`S3 & Storage`,description:`Buckets, Lifecycle, Replication, presigned URL`,path:`/cloud`,hash:`s3`},{icon:`🐳`,title:`ECS & Containers`,description:`Fargate, ECR, Task Definition, Service`,path:`/cloud`,hash:`ecs`},{icon:`🗄️`,title:`RDS & DynamoDB`,description:`PostgreSQL, MySQL, Aurora, NoSQL`,path:`/cloud`,hash:`rds`},{icon:`🔄`,title:`CI/CD & DevOps`,description:`CodePipeline, CodeBuild, CodeDeploy`,path:`/cloud`,hash:`cicd`},{icon:`🏗️`,title:`Architecture`,description:`Patterns, Best Practices, Well-Architected`,path:`/cloud`,hash:`arch`},{icon:`🔑`,title:`Bastion & Jump Host`,description:`SSH Tunnel, SSM Session Manager`,path:`/cloud`,hash:`bastion`}],y={name:`CloudHubPage`,components:{CTopbar:p,CGrid:m,CHubCard:h},data(){return{tocSections:_,hubCards:v,cloudSections:g}},mounted(){this.scrollToHash()},watch:{"$route.hash":function(){this.scrollToHash()}},methods:{scrollToHash(){let e=window.location.hash.slice(1);e&&this.$nextTick(()=>{setTimeout(()=>{let t=document.getElementById(e);t&&t.scrollIntoView({behavior:`smooth`,block:`start`})},60)})},handleNavigate(e){let t=this.hubCards.find(t=>t.path===e);f(t&&t.hash?t.path+`#`+t.hash:e)},scrollTo(e){let t=document.getElementById(e);t&&t.scrollIntoView({behavior:`smooth`,block:`start`})}}},b={class:`cloud-hub-page`},x={class:`hub-container`},S={class:`toc`},C=[`onClick`],w={class:`cloud-sections`},T=[`id`],E={class:`cloud-section-title`},D=[`innerHTML`];function O(c,f,p,m,h,g){let _=i(`CTopbar`),v=i(`CHubCard`),y=i(`CGrid`);return r(),a(`div`,b,[l(`div`,x,[d(_,{title:`☁️ AWS Cloud`,"back-label":`← Trang chủ`,onGoHome:f[0]||=e=>g.handleNavigate(`/`)}),f[1]||=l(`p`,{class:`hub-description`},`IAM, VPC, EC2, Lambda, S3, RDS, ECS, CodePipeline — kiến trúc, code mẫu, best practices`,-1),l(`div`,S,[(r(!0),a(u,null,e(h.tocSections,e=>(r(),a(`a`,{key:e.id,href:`#`,onClick:o(t=>g.scrollTo(e.id),[`prevent`])},n(e.num)+`. `+n(e.title),9,C))),128))]),d(y,null,{default:t(()=>[(r(!0),a(u,null,e(h.hubCards,e=>(r(),s(v,{key:e.title,icon:e.icon,title:e.title,description:e.description,path:e.path,onNavigate:g.handleNavigate},null,8,[`icon`,`title`,`description`,`path`,`onNavigate`]))),128))]),_:1}),l(`div`,w,[(r(!0),a(u,null,e(h.cloudSections,e=>(r(),a(`section`,{id:e.id,key:e.id,class:`cloud-section`},[l(`div`,E,n(e.title),1),l(`div`,{class:`cloud-section-body`,innerHTML:e.html},null,8,D)],8,T))),128))])])])}var k=c(y,[[`render`,O],[`__scopeId`,`data-v-bffd69db`]]);export{k as default};