import{C as e,d as t,h as n,i as r,v as i,y as a}from"./index-DF7F7VnS.js";import{t as o}from"./navigate-DoDAyYnU.js";var s={name:`FrontendJavaScriptPage`,methods:{handleNav(e){o(e)}}},c={class:`js-page`,style:{"--color-accent":`#f59e0b`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(r,o,s,f,p,m){return e(),i(`div`,c,[n(`div`,l,[n(`div`,u,[o[2]||=n(`h1`,null,`⚡ JavaScript`,-1),n(`div`,d,[n(`a`,{href:`#`,onClick:o[0]||=t(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),n(`a`,{href:`#`,onClick:o[1]||=t(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=a(`<p class="desc" data-v-eeaf1192>ES6+, DOM, Async/Await, Closure, Promise, Event Loop, Web API, TypeScript cơ bản.</p><div class="section" data-v-eeaf1192><h2 data-v-eeaf1192>📦 ES6+ Features</h2><pre data-v-eeaf1192><code data-v-eeaf1192>const add = (a, b) =&gt; a + b;                     // Arrow
