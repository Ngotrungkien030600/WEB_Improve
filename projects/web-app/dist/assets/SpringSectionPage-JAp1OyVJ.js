import{F as e,G as t,H as n,I as r,L as i,M as a,N as o,O as s,Q as c,R as l,V as u,W as d,et as f,k as p,y as m}from"./index-IfqOXmhW.js";import{n as h}from"./navigate-jrKs_A-l.js";import{t as g}from"./CodeBlock-DJycdO67.js";var ee=`// 1. Field injection (không khuyến nghị — khó test)
@Service
...
}`,J={name:`SpringSectionAsync`,components:{CodeBlock:g},data(){return{asyncCode:G,scheduledCode:K,eventCode:q}}},Y={class:`ss-section`};function ae(t,n,r,o,s,c){let f=d(`CodeBlock`);return u(),e(`div`,Y,[n[0]||=a(`h3`,null,`@Async — chạy nền, không chặn response`,-1),n[1]||=a(`p`,{class:`section-text`},[a(`code`,null,`@Async`),i(` đẩy method chạy vào `),a(`strong`,null,`thread pool riêng`),i(`, trả response ngay lập tức. Áp dụng cho tác vụ chậm không cần đợi kết quả: gửi email welcome, gọi webhook, xử lý file. `),a(`strong`,null,`Bẫy phổ biến:`),i(` gọi @Async method từ bên trong cùng class sẽ không có tác dụng (proxy không đi qua).`)],-1),l(f,{code:s.asyncCode,language:`java`},null,8,[`code`]),n[2]||=a(`h3`,null,`@Scheduled — chạy tự động theo lịch`,-1),n[3]||=a(`p`,{class:`section-text`},[i(`Tác vụ định kỳ như dọn dữ liệu cũ, gửi báo cáo, chạy backup. Cron `),a(`code`,null,`0 0 2 * * ?`),i(` = mỗi ngày lúc 2h sáng. Khi chạy nhiều instance, cần khóa phân tán (ShedLock, Quartz) để tránh `),a(`strong`,null,`nhiều instance chạy cùng lúc`),i(`.`)],-1),l(f,{code:s.scheduledCode,language:`java`},null,8,[`code`]),n[4]||=a(`h3`,null,`@EventListener — tách rời các module`,-1),n[5]||=a(`p`,{class:`section-text`},[i(`Publisher `),a(`strong`,null,`phát event`),i(`, listener `),a(`strong`,null,`lắng nghe và xử lý`),i(` — hai module không biết về nhau. VD: UserService tạo user xong phát `),a(`code`,null,`UserCreatedEvent`),i(`, module email/notification tự phản ứng. Kết hợp `),a(`code`,null,`@Async`),i(` để không làm chậm luồng chính. Đây là nền tảng của kiến trúc `),a(`strong`,null,`event-driven`),i(`.`)],-1),l(f,{code:s.eventCode,language:`java`},null,8,[`code`])])}var X=m(J,[[`render`,ae],[`__scopeId`,`data-v-0200952d`]]),oe=`@ExtendWith(MockitoExtension.class)
...
}`,ce={name:`SpringSectionTest`,components:{CodeBlock:g},data(){return{unitTestCode:oe,integrationTestCode:se}}},le={class:`ss-section`};function ue(t,n,o,s,c,f){let p=d(`CodeBlock`);return u(),e(`div`,le,[n[0]||=r(`<h3 data-v-d45a1664>Các loại test — kiểm tra ở đúng tầng</h3><div class="cards-grid cols-4" data-v-d45a1664><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Unit Test</h4><p data-v-d45a1664>Test 1 class độc lập, mock dependencies. Nhanh nhất, chạy mỗi lần commit. @ExtendWith(MockitoExtension.class).</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Integration Test</h4><p data-v-d45a1664>Test tầng repository với DB thật. @DataJpaTest + Testcontainers.</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Web Layer Test</h4><p data-v-d45a1664>@WebMvcTest — chỉ tầng controller, mock service — test HTTP + JSON serialize.</p></div><div class="info-card" data-v-d45a1664><h4 data-v-d45a1664>Full Integration</h4><p data-v-d45a1664>@SpringBootTest + Testcontainers — test từ controller đến DB. Chậm nhất, chạy trước khi release.</p></div></div><p class="section-text" data-v-d45a1664><strong data-v-d45a1664>Chiến lược thực tế:</strong> đa số là unit test (nhanh, rẻ), vài integration test cho repository/controller, số ít full flow. Kim tự tháp test — càng lên cao càng ít, càng xuống dưới càng nhiều.</p><h3 data-v-d45a1664>Unit Test với Mockito — test logic không cần DB</h3><p class="section-text" data-v-d45a1664><code data-v-d45a1664>@Mock</code> tạo &quot;bản sao giả&quot; của dependency (không chạm DB thật), <code data-v-d45a1664>@InjectMocks</code> đưa chúng vào class cần test. Kiểm tra: kết quả trả về đúng (<code data-v-d45a1664>assertThat</code>) và method được gọi đúng (<code data-v-d45a1664>verify</code>). Chạy trong mili-giây, lặp lại vô tận.</p>`,5),l(p,{code:c.unitTestCode,language:`java`},null,8,[`code`]),n[1]||=a(`h3`,null,`Integration Test với Testcontainers — DB thật nhưng tạm thời`,-1),n[2]||=a(`p`,{class:`section-text`},[a(`strong`,null,`Testcontainers`),i(` khởi động PostgreSQL thật trong Docker cho mỗi lần test — dữ liệu sạch, không phụ thuộc máy dev, không ô nhiễm DB thật. Bắt được lỗi mà mock bỏ sót: SQL sai, mapping Entity lệch schema, constraint vi phạm.`)],-1),l(p,{code:c.integrationTestCode,language:`java`},null,8,[`code`])])}var Z=m(ce,[[`render`,ue],[`__scopeId`,`data-v-d45a1664`]]),de=`// Service Registry (Eureka Server)
