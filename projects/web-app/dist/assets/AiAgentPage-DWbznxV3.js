...
- [ ] So sánh được edge vs cloud AI`,checklist:[`Trả lời trôi chảy 10 câu phỏng vấn trên`,`Giải thích được vòng lặp agent bằng ví dụ cụ thể`,`Biết cách xử lý rate limit và tối ưu chi phí`,`So sánh được edge vs cloud AI`]}];var g=window.aiAgentConcepts;window.aiAgentQuizData;var _=window.aiAgentTopics,v=`sf_forge_stats`;function y(){try{let e=localStorage.getItem(v);if(e)return JSON.parse(e)}catch{}return{todayMinutes:0,todayDate:null,streak:0,total:0}}function b(e){try{localStorage.setItem(v,JSON.stringify(e))}catch{}}var x={name:`ForgeTimer`,data(){let e=y(),t=new Date().toDateString();return e.todayDate!==t&&(e.todayMinutes=0,e.todayDate=t,b(e)),{totalSeconds:1800,remaining:1800,isRunning:!1,interval:null,selectedDuration:`30`,streak:0,total:0}},computed:{minutes(){return Math.floor(this.remaining/60)},seconds(){return this.remaining%60},formattedTime(){return`${String(this.minutes).padStart(2,`0`)}:${String(this.seconds).padStart(2,`0`)}`},progress(){return 1-this.remaining/this.totalSeconds},dashOffset(){return 2*Math.PI*30*(1-this.progress)},todayMinutes(){let e=y(),t=new Date().toDateString();return e.todayDate===t?e.todayMinutes:0}},methods:{toggle(){this.isRunning?this.pause():this.start()},start(){this.isRunning||this.remaining<=0||(this.isRunning=!0,this.interval=setInterval(()=>{this.remaining--,this.remaining<=0&&(this.pause(),this.remaining=0,this.complete())},1e3))},pause(){this.isRunning=!1,this.interval&&=(clearInterval(this.interval),null)},reset(){this.pause();let e=parseInt(this.selectedDuration)||30;this.totalSeconds=e*60,this.remaining=this.totalSeconds},complete(){let e=y(),t=new Date().toDateString(),n=parseInt(this.selectedDuration)||30;e.todayMinutes=(e.todayDate===t?e.todayMinutes:0)+n,e.todayDate=t,e.total=(e.total||0)+1,e.todayMinutes>n&&e.todayMinutes<n*2&&(e.streak=(e.streak||0)+1),b(e),this.todayMinutes=e.todayMinutes,this.streak=e.streak,this.total=e.total}},beforeUnmount(){this.pause()}},S={class:`forge-timer-wrap`},C={class:`forge-timer-ring`},w={viewBox:`0 0 68 68`},T={class:`forge-time`},E={class:`forge-controls`},D={class:`forge-btn-row`},O={class:`forge-stats`},k={class:`forge-stat-row`},A={class:`val fire`},j={class:`forge-stat-row`},M={class:`val`},N={class:`forge-stat-row`},P={class:`val`};function F(a,o,c,l,f,p){return s(),i(`div`,S,[r(`div`,C,[(s(),i(`svg`,w,[o[4]||=r(`circle`,{class:`forge-ring-bg`,cx:`34`,cy:`34`,r:`30`},null,-1),r(`circle`,{class:`forge-ring-progress`,style:t({strokeDashoffset:p.dashOffset}),cx:`34`,cy:`34`,r:`30`},null,4)])),r(`div`,T,e(p.formattedTime),1)]),r(`div`,E,[n(r(`select`,{"onUpdate:modelValue":o[0]||=e=>f.selectedDuration=e,onChange:o[1]||=(...e)=>p.reset&&p.reset(...e)},[...o[5]||=[r(`option`,{value:`30`},`30p`,-1),r(`option`,{value:`60`},`1h`,-1)]],544),[[d,f.selectedDuration]]),r(`div`,D,[r(`button`,{class:`forge-btn forge-btn-primary`,onClick:o[2]||=(...e)=>p.toggle&&p.toggle(...e)},e(f.isRunning?`⏸`:`⚒️`),1),r(`button`,{class:`forge-btn forge-btn-secondary`,onClick:o[3]||=(...e)=>p.reset&&p.reset(...e)},`↻`)])]),r(`div`,O,[r(`div`,k,[o[6]||=u(`📋 Hôm nay `,-1),r(`span`,A,e(p.todayMinutes)+`m`,1)]),r(`div`,j,[o[7]||=u(`🔥 Streak `,-1),r(`span`,M,e(f.streak)+`🔥`,1)]),r(`div`,N,[o[8]||=u(`📦 Đã rèn `,-1),r(`span`,P,e(f.total),1)])])])}var I=l(x,[[`render`,F],[`__scopeId`,`data-v-f0561c5b`]]),L=[{id:`learn`,label:`Học`,icon:`📚`},{id:`quiz`,label:`Thi`,icon:`🎯`},{id:`lessons`,label:`Bài học`,icon:`📖`}],R={name:`AiAgentPage`,components:{ForgeTimer:I},data(){return{tabs:L,activeTab:`learn`,filterCategory:`all`,currentIndex:0,isFlipped:!1,selectedLesson:0,concepts:g,lessons:_}},computed:{filteredCards(){return this.filterCategory===`all`?this.concepts:this.concepts.filter(e=>e.category===this.filterCategory)},currentCard(){return this.filteredCards[this.currentIndex]}},watch:{filterCategory(){this.currentIndex=0,this.isFlipped=!1}},methods:{handleNavigate(e){h(e)},prevCard(){this.currentIndex>0&&(this.currentIndex--,this.isFlipped=!1)},nextCard(){this.currentIndex<this.filteredCards.length-1&&(this.currentIndex++,this.isFlipped=!1)},renderMarkdown(e){return e?e.replace(/^#{1,6} (.+)$/gm,(e,t)=>`<h${t.length}>${t}</h${t.length}>`).replace(/\*\*(.+?)\*\*/g,`<strong>$1</strong>`).replace(/\n\n/g,`</p><p>`).replace(/^(?!<[h|p|u|o|l|b|c])(.+)$/gm,`<p>$1</p>`).replace(/<p><\/p>/g,``):``}}},z={class:`page-root`,style:{"--color-accent":`#f472b6`}},B={class:`container`},V={class:`ai-topbar`},te={class:`topbar-right`},H={class:`ai-tabs`},U=[`onClick`],W={key:0,class:`ai-section active`},G={class:`ai-card-filter`},K={class:`ai-card-inner`},q={class:`ai-card-front`},J={class:`ai-card-category`},Y={class:`ai-card-en`},X={class:`ai-card-vi`},Z={class:`ai-card-def`},Q={class:`ai-card-back`},ne={class:`ai-card-ex`},re={class:`ai-card-counter`},ie={class:`ai-card-controls`},ae={key:1,class:`ai-section`},oe={class:`quiz-placeholder`},se={class:`quiz-categories`},ce={key:2,class:`ai-section`},le={class:`ai-lesson-layout`},ue={class:`ai-lesson-sidebar`},de={class:`ai-lesson-list`},fe=[`onClick`],pe={class:`ai-lesson-progress`},$={class:`ai-lesson-content`},me={class:`ai-lesson-card`},he=[`innerHTML`];function ge(t,l,u,h,g,_){let v=ee(`ForgeTimer`);return s(),i(`div`,z,[r(`div`,B,[r(`header`,V,[l[8]||=r(`div`,{class:`topbar-left`},[r(`h1`,null,`🤖 Học AI Agent`),r(`p`,null,`Agent — Tools — Token — Quota — AI at Edge`)],-1),r(`div`,te,[c(v),r(`button`,{class:`home-btn`,onClick:l[0]||=e=>_.handleNavigate(`/`)},`🏠`)])]),r(`nav`,H,[(s(!0),i(f,null,o(g.tabs,t=>(s(),i(`button`,{key:t.id,class:m([`ai-tab`,{active:g.activeTab===t.id}]),onClick:e=>g.activeTab=t.id},e(t.icon)+` `+e(t.label),11,U))),128))]),g.activeTab===`learn`?(s(),i(`section`,W,[r(`div`,G,[n(r(`select`,{"onUpdate:modelValue":l[1]||=e=>g.filterCategory=e},[...l[9]||=[a(`<option value="all" data-v-1121becb>📂 Tất cả chủ đề</option><option value="agent" data-v-1121becb>🤖 Agent Fundamentals</option><option value="tools" data-v-1121becb>🔧 Tools &amp; MCP</option><option value="token" data-v-1121becb>🔢 Token &amp; Context</option><option value="quota" data-v-1121becb>⏳ Quota &amp; Cost</option><option value="edge" data-v-1121becb>📡 AI at Edge</option>`,6)]],512),[[d,g.filterCategory]])]),r(`div`,{class:m([`ai-card`,{flipped:g.isFlipped}]),onClick:l[2]||=e=>g.isFlipped=!g.isFlipped},[r(`div`,K,[r(`div`,q,[r(`span`,J,e(_.currentCard?.category?.toUpperCase()),1),r(`div`,Y,e(_.currentCard?.en),1),r(`div`,X,e(_.currentCard?.vi),1),r(`div`,Z,e(_.currentCard?.definition),1)]),r(`div`,Q,[l[10]||=r(`span`,{class:`ai-card-category`},`VÍ DỤ`,-1),r(`div`,ne,e(_.currentCard?.example),1),l[11]||=r(`p`,{class:`flip-hint`},`🔄 Click để xem lại mặt trước`,-1)])])],2),r(`p`,re,e(g.currentIndex+1)+` / `+e(_.filteredCards.length),1),r(`div`,ie,[r(`button`,{class:`ai-card-btn`,onClick:l[3]||=(...e)=>_.prevCard&&_.prevCard(...e)},`⬅️ Trước`),r(`button`,{class:`ai-card-btn`,onClick:l[4]||=e=>g.isFlipped=!g.isFlipped},`🔄 Lật`),r(`button`,{class:`ai-card-btn`,onClick:l[5]||=(...e)=>_.nextCard&&_.nextCard(...e)},`Tiếp ➡️`)])])):p(``,!0),g.activeTab===`quiz`?(s(),i(`section`,ae,[r(`div`,oe,[l[12]||=r(`h3`,null,`🎯 Quiz AI Agent`,-1),l[13]||=r(`p`,null,`Tính năng quiz đang được phát triển. Hiện tại bạn có thể học flashcards và bài học.`,-1),r(`p`,se,[r(`span`,{class:`quiz-cat-tag`,onClick:l[6]||=e=>g.activeTab=`learn`},`📚 Học flashcards`),r(`span`,{class:`quiz-cat-tag`,onClick:l[7]||=e=>g.activeTab=`lessons`},`📖 Bài học`)])])])):p(``,!0),g.activeTab===`lessons`?(s(),i(`section`,ce,[r(`div`,le,[r(`aside`,ue,[l[14]||=r(`h3`,null,`📚 Bài học`,-1),r(`ul`,de,[(s(!0),i(f,null,o(g.lessons,(t,n)=>(s(),i(`li`,{key:n,class:m([`ai-lesson-item`,{active:g.selectedLesson===n}]),onClick:e=>g.selectedLesson=n},e(t.title),11,fe))),128))]),r(`div`,pe,[r(`span`,null,e(g.selectedLesson+1)+` / `+e(g.lessons.length),1)])]),r(`div`,$,[r(`div`,me,[r(`h2`,null,e(g.lessons[g.selectedLesson]?.title),1),r(`div`,{class:`lesson-body`,innerHTML:_.renderMarkdown(g.lessons[g.selectedLesson]?.content)},null,8,he)])])])])):p(``,!0)])])}var _e=l(R,[[`render`,ge],[`__scopeId`,`data-v-1121becb`]]);export{_e as default};