...
System.out.println(a % b);`,question:`In ra 2 dòng gì?`,options:[`3 và 1`,`3.33 và 1`,`3 và 0`,`3.33 và 0.33`],answer:0,explain:`Chia 2 int bỏ phần dư: 10/3 = 3. % lấy phần dư: 10%3 = 1.`}]},re={class:`tu-zero-page`},ie={class:`tz-header`},h={class:`tz-heading`},g={class:`tz-tabs`},_=[`onClick`],v={class:`tz-chapter-head`},y={class:`tz-time`},b={class:`tz-intro`},x={class:`code-title`},S={key:0,class:`tz-quiz`},C={class:`quiz-q`},w={class:`quiz-options`},T=[`disabled`,`onClick`],E={key:0,class:`quiz-why`},D={key:1,class:`tz-section`},O={class:`tz-chapter-head`},k={class:`tz-time`},A={class:`ex-head`},j={class:`ex-task`},M={class:`ex-buttons`},N=[`onClick`],P=[`onClick`],F={key:0,class:`ex-hint`},I={key:1,class:`ex-answer`},ae={class:`code-card`},L={class:`ex-explain`},R={key:2,class:`tz-section`},z={class:`tz-chapter-head`},B={class:`tz-time`},V={class:`rc-index`},H={class:`code-card`},U={class:`quiz-q`},W={class:`quiz-options`},G=[`disabled`,`onClick`],K={key:0,class:`quiz-why`},q=te({__name:`JavaTuZeroPage`,setup(te){let q=d(()=>m.chapters),J=u(`ch1`),Y=l({}),X=l({}),Z=l({});function Q(e,t){return e+`-`+t}function oe(e){return e.startsWith(`rc-`)?X:Y}function $(e,t,n,r){let i=e===`rc`?`rc-`+t:Q(e,t),a=oe(i)[i];return a===void 0?{}:n===r?{correct:!0}:n===a?{wrong:!0}:{}}function se(e,t,n){let r=Q(e,t);Y[r]===void 0&&(Y[r]=n)}function ce(e,t){let n=`rc-`+e;X[n]===void 0&&(X[n]=t)}function le(e){Z[e]||(Z[e]={hint:!1,answer:!1}),Z[e].hint=!Z[e].hint}function ue(e){Z[e]||(Z[e]={hint:!1,answer:!1}),Z[e].answer=!Z[e].answer}function de(e){return e===`easy`?`Dễ`:e===`medium`?`Trung bình`:`Khó`}function fe(){ne(`/java/hub`)}return(l,u)=>(r(),n(`div`,re,[a(`header`,ie,[a(`button`,{class:`tz-back`,onClick:fe},`← Java`),a(`div`,h,[u[2]||=a(`h1`,null,`🌱 Java Từ 0 — mất gốc → đi làm`,-1),a(`p`,null,` Dành cho người yếu Java và tư duy lập trình: 6 chương nền tảng + quiz, `+p(s(m).exercises.length)+` bài tập có lời giải từng bước, `+p(s(m).readCode.length)+` bài đọc-code đoán kết quả. `,1)])]),a(`nav`,g,[(r(!0),n(f,null,c(s(m).chapters,t=>(r(),n(`button`,{key:t.id,class:e([`tz-tab`,{active:J.value===t.id}]),onClick:e=>J.value=t.id},p(t.emoji)+` `+p(t.title),11,_))),128)),a(`button`,{class:e([`tz-tab`,{active:J.value===`exercises`}]),onClick:u[0]||=e=>J.value=`exercises`},` 💪 Bài tập `,2),a(`button`,{class:e([`tz-tab`,{active:J.value===`readcode`}]),onClick:u[1]||=e=>J.value=`readcode`},` 🔍 Đọc code `,2)]),J.value.startsWith(`ch`)?(r(!0),n(f,{key:0},c(q.value,i=>ee((r(),n(`section`,{key:i.id,class:`tz-section`},[a(`div`,v,[a(`h2`,null,p(i.emoji)+` `+p(i.title),1),a(`span`,y,`⏱️ `+p(i.time),1)]),a(`p`,b,p(i.intro),1),(r(!0),n(f,null,c(i.lessons,e=>(r(),n(`div`,{key:e.title,class:`tz-lesson`},[a(`h3`,null,p(e.title),1),(r(!0),n(f,null,c(e.paragraphs,(e,t)=>(r(),n(`p`,{key:t,class:`tz-para`},p(e),1))),128)),(r(!0),n(f,null,c(e.codes,e=>(r(),n(`div`,{key:e.title,class:`code-card`},[a(`div`,x,p(e.title),1),a(`pre`,null,[a(`code`,null,p(e.code),1)])]))),128))]))),128)),i.quiz&&i.quiz.length?(r(),n(`div`,S,[u[3]||=a(`h3`,null,`✅ Kiểm tra nhanh — hiểu rồi mới sang bài sau`,-1),(r(!0),n(f,null,c(i.quiz,(t,s)=>(r(),n(`div`,{key:s,class:`quiz-item`},[a(`p`,C,p(t.q),1),a(`div`,w,[(r(!0),n(f,null,c(t.options,(a,o)=>(r(),n(`button`,{key:o,class:e([`quiz-opt`,$(i.id,s,o,t.answer)]),disabled:Y[Q(i.id,s)]!==void 0,onClick:e=>se(i.id,s,o)},p(a),11,T))),128))]),Y[Q(i.id,s)]===void 0?o(``,!0):(r(),n(`p`,E,p(Y[Q(i.id,s)]===t.answer?`✅ Đúng. `:`❌ Chưa đúng. `)+` `+p(t.why),1))]))),128))])):o(``,!0)])),[[t,J.value===i.id]])),128)):J.value===`exercises`?(r(),n(`section`,D,[a(`div`,O,[u[4]||=a(`h2`,null,`💪 Bài tập luyện tư duy`,-1),a(`span`,k,p(s(m).exercises.length)+` bài · Dễ → Khó`,1)]),u[9]||=a(`p`,{class:`tz-intro`},` Quy tắc vàng: tự viết 20–30 phút KHÔNG được thì mới xem gợi ý; viết tiếp vẫn bí mới xem đáp án. Chép đáp án không rèn được tư duy — hiểu "vì sao" mới là mục tiêu. `,-1),(r(!0),n(f,null,c(s(m).exercises,t=>(r(),n(`div`,{key:t.id,class:`ex-card`},[a(`div`,A,[a(`span`,{class:e([`ex-level`,`lv-`+t.level])},p(de(t.level)),3),a(`h3`,null,p(t.title),1)]),a(`div`,j,[u[5]||=a(`strong`,null,`Đề bài:`,-1),i(` `+p(t.task),1)]),a(`div`,M,[a(`button`,{class:`ex-btn`,onClick:e=>le(t.id)},p(Z[t.id]&&Z[t.id].hint?`Ẩn gợi ý`:`💡 Xem gợi ý`),9,N),a(`button`,{class:`ex-btn primary`,onClick:e=>ue(t.id)},p(Z[t.id]&&Z[t.id].answer?`Ẩn đáp án`:`✅ Xem đáp án`),9,P)]),Z[t.id]&&Z[t.id].hint?(r(),n(`div`,F,[u[6]||=a(`strong`,null,`Cách nghĩ:`,-1),i(` `+p(t.hint),1)])):o(``,!0),Z[t.id]&&Z[t.id].answer?(r(),n(`div`,I,[a(`div`,ae,[u[7]||=a(`div`,{class:`code-title`},`Lời giải`,-1),a(`pre`,null,[a(`code`,null,p(t.solution),1)])]),a(`p`,L,[u[8]||=a(`strong`,null,`Vì sao:`,-1),i(` `+p(t.explain),1)])])):o(``,!0)]))),128))])):(r(),n(`section`,R,[a(`div`,z,[u[10]||=a(`h2`,null,`🔍 Đọc code — đoán kết quả`,-1),a(`span`,B,p(s(m).readCode.length)+` câu hỏi bẫy`,1)]),u[11]||=a(`p`,{class:`tz-intro`},` Cách rèn "tư duy lập trình" nhanh nhất: đọc code như máy tính, chạy từng dòng trong đầu rồi đoán output. Sai bao nhiêu cũng được — đọc kỹ phần giải thích. `,-1),(r(!0),n(f,null,c(s(m).readCode,(t,i)=>(r(),n(`div`,{key:i,class:`rc-card`},[a(`span`,V,`Câu `+p(i+1),1),a(`div`,H,[a(`pre`,null,[a(`code`,null,p(t.code),1)])]),a(`p`,U,p(t.question),1),a(`div`,W,[(r(!0),n(f,null,c(t.options,(a,o)=>(r(),n(`button`,{key:o,class:e([`quiz-opt`,$(`rc`,i,o,t.answer)]),disabled:X[`rc-`+i]!==void 0,onClick:e=>ce(i,o)},p(a),11,G))),128))]),X[`rc-`+i]===void 0?o(``,!0):(r(),n(`p`,K,p(X[`rc-`+i]===t.answer?`✅ Đúng. `:`❌ Chưa đúng. `)+` `+p(t.explain),1))]))),128))]))]))}},[[`__scopeId`,`data-v-2203e295`]]);export{q as default};