import{A as e,D as t,E as n,F as r,H as i,I as a,N as o,P as s,R as c,V as l,Y as u,Z as d,_ as f,j as p,z as ee}from"./index-CaZw3_YQ.js";import{n as m}from"./navigate-CdhFtmit.js";import{t as h}from"./CodeBlock-sleLze8a.js";var te=`-- B-Tree index (mặc định) — tốt cho =, >, <, BETWEEN, LIKE 'abc%'
...
-- Covering index
CREATE INDEX idx_covering ON users(email) INCLUDE (name, avatar_url);`,g=`-- Pessimistic Lock
  ...
  metrics:
    - type: Resource
      resource:
        ...
        target:
          type: Utilization
          averageUtilization: 70`,L={name:`BackendSectionK8s`,components:{CodeBlock:h},data(){return{k8sDeploymentCode:P,k8sConfigMapCode:F,k8sHpaCode:I}}},R={class:`bs-section`};function z(t,n,i,u,d,f){let p=l(`CodeBlock`);return c(),o(`div`,R,[n[0]||=s(`<h3 data-v-c2e833ad>Kubernetes — tại sao cần khi đã có Docker?</h3><p class="section-text" data-v-c2e833ad>Docker chạy container, nhưng <strong data-v-c2e833ad>K8s quản lý hàng trăm container</strong>: tự deploy, scale, self-heal, load balance. Khi traffic tăng, K8s tự tạo thêm pod; pod chết thì tự tạo lại. Đây là lớp vận hành mà production thật cần — Docker chỉ giải quyết 1 container, K8s giải quyết cả hệ thống.</p><h3 data-v-c2e833ad>Deployment &amp; Service — khai báo trạng thái mong muốn</h3><p class="section-text" data-v-c2e833ad><strong data-v-c2e833ad>Deployment</strong> khai báo &quot;tôi muốn 3 replicas&quot; — K8s tự duy trì con số đó. <strong data-v-c2e833ad>RollingUpdate</strong> thay từng pod một, không downtime. <strong data-v-c2e833ad>Probes</strong> (liveness/readiness) giúp K8s biết pod sống và sẵn sàng nhận traffic — app phải expose <code data-v-c2e833ad>/actuator/health</code>.</p>`,4),a(p,{code:d.k8sDeploymentCode,language:`yaml`},null,8,[`code`]),n[1]||=e(`h3`,null,`ConfigMap & Secret — tách config khỏi image`,-1),n[2]||=e(`p`,{class:`section-text`},[e(`strong`,null,`ConfigMap`),r(` chứa cấu hình không nhạy cảm (application.yml), `),e(`strong`,null,`Secret`),r(` chứa dữ liệu mật (password, token). Tách ra để: đổi config không cần build lại image, và không bao giờ commit secret vào repo/image.`)],-1),a(p,{code:d.k8sConfigMapCode,language:`yaml`},null,8,[`code`]),n[3]||=e(`h3`,null,`HPA — tự scale theo tải`,-1),n[4]||=e(`p`,{class:`section-text`},[e(`strong`,null,`HorizontalPodAutoscaler`),r(` tự tăng/giảm số pod theo CPU/memory. Chạy 2 pod lúc thấp điểm, scale lên 10 khi cao điểm, rồi tự giảm về — không cần can thiệp tay, tiết kiệm chi phí.`)],-1),a(p,{code:d.k8sHpaCode,language:`yaml`},null,8,[`code`])])}var B=f(L,[[`render`,z],[`__scopeId`,`data-v-c2e833ad`]]),V=`name: Build and Deploy
on:
  push:
    branches: [main]
