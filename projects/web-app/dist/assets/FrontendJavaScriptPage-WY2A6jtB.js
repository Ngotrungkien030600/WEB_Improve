import{B as e,D as t,F as n,P as r,j as i,v as a}from"./index-DgMtGGTp.js";import{n as o}from"./navigate-CTQGF1Xi.js";var s={name:`FrontendJavaScriptPage`,methods:{handleNav(e){o(e)}}},c={class:`js-page`,style:{"--color-accent":`#f59e0b`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(a,o,s,f,p,m){return e(),r(`div`,c,[i(`div`,l,[i(`div`,u,[o[2]||=i(`h1`,null,`⚡ JavaScript`,-1),i(`div`,d,[i(`a`,{href:`#`,onClick:o[0]||=t(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),i(`a`,{href:`#`,onClick:o[1]||=t(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=n(`<p class="desc" data-v-eeaf1192>ES6+, DOM, Async/Await, Closure, Promise, Event Loop, Web API, TypeScript cơ bản.</p><div class="section" data-v-eeaf1192><h2 data-v-eeaf1192>📦 ES6+ Features</h2><pre data-v-eeaf1192><code data-v-eeaf1192>const add = (a, b) =&gt; a + b;                     // Arrow
