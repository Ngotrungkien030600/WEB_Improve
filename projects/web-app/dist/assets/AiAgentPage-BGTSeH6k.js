...
- [ ] So sánh được edge vs cloud AI`,checklist:[`Trả lời trôi chảy 10 câu phỏng vấn trên`,`Giải thích được vòng lặp agent bằng ví dụ cụ thể`,`Biết cách xử lý rate limit và tối ưu chi phí`,`So sánh được edge vs cloud AI`]}];var g=window.aiAgentConcepts,_=window.aiAgentQuizData,v=window.aiAgentTopics,y=`aiAgentChecklist`;function b(){try{return JSON.parse(localStorage.getItem(y)||`{}`)}catch{return{}}}function x(e){localStorage.setItem(y,JSON.stringify(e))}function S(e,t){let n=0,r=0;return e.forEach(e=>{e.checklist&&e.checklist.forEach(e=>{n++,t[e]&&r++})}),{done:r,total:n,percent:n>0?Math.round(r/n*100):0}}function C(e,t){let n=e.checklist||[];return{done:n.filter(e=>t[e]).length,total:n.length}}var w=[{id:`learn`,label:`Học`,icon:`📚`},{id:`quiz`,label:`Thi`,icon:`🎯`},{id:`lessons`,label:`Bài học`,icon:`📖`}],T=[{id:`general`,label:`Agent cơ bản`,icon:`🤖`},{id:`token`,label:`Token`,icon:`🔢`},{id:`quota`,label:`Quota`,icon:`⏳`},{id:`edge`,label:`Edge`,icon:`📡`}],E={name:`AiAgentPage`,components:{CHomeTimer:ee},data(){return{tabs:w,activeTab:`learn`,filterCategory:`all`,currentIndex:0,isFlipped:!1,selectedLesson:0,concepts:g,lessons:v,checklist:{},quizQuestions:[],quizCategories:T,currentQuestion:0,selectedAnswer:null,answered:!1,quizScore:0,quizStarted:!1,quizCount:10,quizTime:15,quizTimer:null,quizTimeLeft:15,selectedQuizCategory:`general`}},computed:{filteredCards(){return this.filterCategory===`all`?this.concepts:this.concepts.filter(e=>e.category===this.filterCategory)},currentCard(){return this.filteredCards[this.currentIndex]},lessonProgress(){return S(this.lessons,this.checklist)},renderedLesson(){let e=this.lessons[this.selectedLesson];if(!e)return``;let t=e.content?this.renderMarkdown(e.content):``;return e.checklist&&e.checklist.length>0&&(t+=`<h3>📝 Checklist</h3>`,e.checklist.forEach(e=>{let n=!!this.checklist[e],r=e.replace(/"/g,`&quot;`);t+=`
            <label class="checklist-item ${n?`checked`:``}">
              <input type="checkbox" ${n?`checked`:``} data-item="${r}">
              <span>${e}</span>
            </label>`})),t},currentQuizQuestion(){return this.quizQuestions[this.currentQuestion]?this.quizQuestions[this.currentQuestion]:null},quizPercent(){return this.quizScore===0&&!this.quizStarted?`0%`:Math.round(this.quizScore/this.quizQuestions.length*100)+`%`},quizLevel(){let e=this.quizScore/this.quizQuestions.length*100;return e>=90?`🟢 Xuất sắc`:e>=70?`🟡 Tốt`:e>=50?`🟠 Trung bình`:`🔴 Cần cố gắng`}},mounted(){this.checklist=b(),this.$nextTick(()=>this.bindLessonEvents())},updated(){this.$nextTick(()=>this.bindLessonEvents())},methods:{handleNavigate(e){h(e)},filterCategory(){this.currentIndex=0,this.isFlipped=!1},prevCard(){this.currentIndex>0&&(this.currentIndex--,this.isFlipped=!1)},nextCard(){this.currentIndex<this.filteredCards.length-1&&(this.currentIndex++,this.isFlipped=!1)},toggleLessonItem(e,t){this.checklist={...this.checklist,[e]:t},x(this.checklist)},getLessonProgress(e){let t=this.lessons[e];if(!t)return`0/0`;let{done:n,total:r}=C(t,this.checklist);return`${n}/${r}`},bindLessonEvents(){document.querySelectorAll(`.ai-lesson-content .checklist-item input`).forEach(e=>{e._bound||(e._bound=!0,e.addEventListener(`change`,()=>{this.toggleLessonItem(e.dataset.item,e.checked);let t=e.closest(`.checklist-item`);t&&t.classList.toggle(`checked`,e.checked)}))})},startQuiz(){let e=_[this.selectedQuizCategory]||[];if(e.length===0)return;let t=[...e].sort(()=>Math.random()-.5);this.quizQuestions=t.slice(0,Math.min(this.quizCount,e.length)),this.currentQuestion=0,this.selectedAnswer=null,this.answered=!1,this.quizScore=0,this.quizStarted=!0,this.startQuizTimer()},startQuizTimer(){this.quizTimer&&clearInterval(this.quizTimer),this.quizTimeLeft=this.quizTime,this.quizTimer=setInterval(()=>{this.quizTimeLeft--,this.quizTimeLeft<=0&&this.submitQuizAnswer()},1e3)},submitQuizAnswer(){if(this.answered)return;this.answered=!0,this.quizTimer&&clearInterval(this.quizTimer);let e=this.quizQuestions[this.currentQuestion];this.selectedAnswer===e.correct&&this.quizScore++},nextQuestion(){this.answered||this.submitQuizAnswer(),this.currentQuestion<this.quizQuestions.length-1&&(this.currentQuestion++,this.selectedAnswer=null,this.answered=!1,this.startQuizTimer())},resetQuiz(){this.quizTimer&&clearInterval(this.quizTimer),this.quizStarted=!1,this.quizQuestions=[],this.currentQuestion=0,this.selectedAnswer=null,this.answered=!1,this.quizScore=0},renderMarkdown(e){return e?e.replace(/^#{1,6} (.+)$/gm,(e,t)=>`<h${t.length}>${t}</h${t.length}>`).replace(/\*\*(.+?)\*\*/g,`<strong>$1</strong>`).replace(/\n\n/g,`</p><p>`).replace(/^(?!<[h|p|u|o|l|b|c])(.+)$/gm,`<p>$1</p>`).replace(/<p><\/p>/g,``):``}}},D={class:`page-root`,style:{"--color-accent":`#f472b6`}},O={class:`container`},k={class:`ai-topbar`},A={class:`topbar-right`},j={class:`ai-tabs`},M=[`onClick`],N={key:0,class:`ai-section active`},P={class:`ai-card-filter`},F={class:`ai-card-inner`},I={class:`ai-card-front`},L={class:`ai-card-category`},R={class:`ai-card-en`},z={class:`ai-card-vi`},B={class:`ai-card-def`},V={class:`ai-card-back`},H={class:`ai-card-ex`},U={class:`ai-card-counter`},te={class:`ai-card-controls`},W={key:1,class:`ai-section`},G={key:0,class:`ai-q-config`},K={class:`ai-q-tabs`},q=[`onClick`],J={class:`ai-q-settings`},Y={class:`ai-q-timer-bar`},X={class:`ai-q-timer-text`},Z={class:`ai-q-card`},Q={class:`ai-q-badge`},ne={class:`ai-q-progress`},re={class:`ai-q-question`},ie={class:`ai-q-options`},ae=[`disabled`,`onClick`],oe={class:`ai-q-stats`},se={class:`ai-q-stat-value`},ce={class:`ai-q-stat-value`},le={class:`ai-q-stat-value`},ue={class:`ai-q-stat-value`},de={key:2,class:`ai-section`},fe={class:`ai-lesson-layout`},pe={class:`ai-lesson-sidebar`},$={class:`ai-lesson-list`},me=[`onClick`],he={class:`ai-lesson-stat`},ge={class:`ai-lesson-progress`},_e={class:`progress-track`},ve={class:`ai-lesson-content`},ye={class:`ai-lesson-card`},be=[`innerHTML`];function xe(l,h,ee,g,_,v){let y=p(`CHomeTimer`);return d(),c(`div`,D,[i(`div`,O,[i(`header`,k,[h[12]||=i(`div`,{class:`topbar-left`},[i(`h1`,null,`🤖 Học AI Agent`),i(`p`,null,`Agent — Tools — Token — Quota — AI at Edge`)],-1),i(`div`,A,[r(y),i(`button`,{class:`home-btn`,type:`button`,"aria-label":`Về trang chủ`,title:`Về trang chủ`,onClick:h[0]||=e=>v.handleNavigate(`/`)},`🏠`)])]),i(`nav`,j,[(d(!0),c(s,null,m(_.tabs,e=>(d(),c(`button`,{key:e.id,class:f([`ai-tab`,{active:_.activeTab===e.id}]),onClick:t=>_.activeTab=e.id},t(e.icon)+` `+t(e.label),11,M))),128))]),_.activeTab===`learn`?(d(),c(`section`,N,[i(`div`,P,[e(i(`select`,{"onUpdate:modelValue":h[1]||=e=>v.filterCategory=e},[...h[13]||=[a(`<option value="all" data-v-bfce81e0>📂 Tất cả chủ đề</option><option value="agent" data-v-bfce81e0>🤖 Agent Fundamentals</option><option value="tools" data-v-bfce81e0>🔧 Tools &amp; MCP</option><option value="token" data-v-bfce81e0>🔢 Token &amp; Context</option><option value="quota" data-v-bfce81e0>⏳ Quota &amp; Cost</option><option value="edge" data-v-bfce81e0>📡 AI at Edge</option>`,6)]],512),[[o,v.filterCategory]])]),i(`div`,{class:f([`ai-card`,{flipped:_.isFlipped}]),onClick:h[2]||=e=>_.isFlipped=!_.isFlipped},[i(`div`,F,[i(`div`,I,[i(`span`,L,t(v.currentCard?.category?.toUpperCase()),1),i(`div`,R,t(v.currentCard?.en),1),i(`div`,z,t(v.currentCard?.vi),1),i(`div`,B,t(v.currentCard?.definition),1)]),i(`div`,V,[h[14]||=i(`span`,{class:`ai-card-category`},`VÍ DỤ`,-1),i(`div`,H,t(v.currentCard?.example),1),h[15]||=i(`p`,{class:`flip-hint`},`🔄 Click để xem lại mặt trước`,-1)])])],2),i(`p`,U,t(_.currentIndex+1)+` / `+t(v.filteredCards.length),1),i(`div`,te,[i(`button`,{class:`ai-card-btn`,onClick:h[3]||=(...e)=>v.prevCard&&v.prevCard(...e)},`⬅️ Trước`),i(`button`,{class:`ai-card-btn`,onClick:h[4]||=e=>_.isFlipped=!_.isFlipped},`🔄 Lật`),i(`button`,{class:`ai-card-btn`,onClick:h[5]||=(...e)=>v.nextCard&&v.nextCard(...e)},`Tiếp ➡️`)])])):u(``,!0),_.activeTab===`quiz`?(d(),c(`section`,W,[_.quizStarted?u(``,!0):(d(),c(`div`,G,[i(`div`,K,[(d(!0),c(s,null,m(_.quizCategories,e=>(d(),c(`button`,{key:e.id,class:f([`ai-q-tab`,{active:_.selectedQuizCategory===e.id}]),onClick:t=>_.selectedQuizCategory=e.id},t(e.icon)+` `+t(e.label),11,q))),128))]),i(`div`,J,[e(i(`select`,{"onUpdate:modelValue":h[6]||=e=>_.quizCount=e},[...h[16]||=[i(`option`,{value:`5`},`5 câu`,-1),i(`option`,{value:`10`},`10 câu`,-1),i(`option`,{value:`15`},`15 câu`,-1)]],512),[[o,_.quizCount,void 0,{number:!0}]]),e(i(`select`,{"onUpdate:modelValue":h[7]||=e=>_.quizTime=e},[...h[17]||=[i(`option`,{value:`10`},`10s`,-1),i(`option`,{value:`15`},`15s`,-1),i(`option`,{value:`20`},`20s`,-1),i(`option`,{value:`30`},`30s`,-1)]],512),[[o,_.quizTime,void 0,{number:!0}]]),i(`button`,{class:`ai-q-start`,onClick:h[8]||=(...e)=>v.startQuiz&&v.startQuiz(...e)},`▶️ Bắt đầu`)])])),_.quizStarted&&v.currentQuizQuestion?(d(),c(s,{key:1},[i(`div`,Y,[i(`div`,{class:`ai-q-timer-fill`,style:n({width:_.quizTimeLeft/_.quizTime*100+`%`})},null,4)]),i(`p`,X,t(_.quizTimeLeft)+`s`,1),i(`div`,Z,[i(`span`,Q,t(_.quizCategories.find(e=>e.id===_.selectedQuizCategory)?.label),1),i(`span`,ne,`Câu `+t(_.currentQuestion+1)+` / `+t(_.quizQuestions.length),1),i(`h2`,re,t(v.currentQuizQuestion.question),1),i(`div`,ie,[(d(!0),c(s,null,m(v.currentQuizQuestion.options,(e,n)=>(d(),c(`button`,{key:n,class:f([`ai-q-option`,{selected:_.selectedAnswer===n,correct:_.answered&&n===v.currentQuizQuestion.correct,wrong:_.answered&&_.selectedAnswer===n&&n!==v.currentQuizQuestion.correct}]),disabled:_.answered,onClick:e=>{_.selectedAnswer=n,v.submitQuizAnswer()}},t(e),11,ae))),128))]),_.answered?(d(),c(`div`,{key:0,class:f([`ai-q-feedback`,_.selectedAnswer===v.currentQuizQuestion.correct?`correct`:`wrong`])},t(_.selectedAnswer===v.currentQuizQuestion.correct?`✅ Chính xác!`:`❌ Chưa đúng. Đáp án đúng: `+v.currentQuizQuestion.options[v.currentQuizQuestion.correct]),3)):u(``,!0),_.answered?u(``,!0):(d(),c(`button`,{key:1,class:`ai-q-submit`,onClick:h[9]||=(...e)=>v.submitQuizAnswer&&v.submitQuizAnswer(...e)},`Xác nhận`)),_.answered&&_.currentQuestion<_.quizQuestions.length-1?(d(),c(`button`,{key:2,class:`ai-q-next`,onClick:h[10]||=(...e)=>v.nextQuestion&&v.nextQuestion(...e)},`Câu tiếp theo ➡️`)):u(``,!0),_.answered&&_.currentQuestion===_.quizQuestions.length-1?(d(),c(`button`,{key:3,class:`ai-q-restart`,onClick:h[11]||=(...e)=>v.resetQuiz&&v.resetQuiz(...e)},`🔄 Làm lại`)):u(``,!0)]),i(`div`,oe,[i(`div`,null,[i(`span`,se,t(_.quizScore),1),h[18]||=i(`span`,{class:`ai-q-stat-label`},`Đúng`,-1)]),i(`div`,null,[i(`span`,ce,t(_.quizQuestions.length),1),h[19]||=i(`span`,{class:`ai-q-stat-label`},`Tổng`,-1)]),i(`div`,null,[i(`span`,le,t(v.quizPercent),1),h[20]||=i(`span`,{class:`ai-q-stat-label`},`Tỉ lệ`,-1)]),i(`div`,null,[i(`span`,ue,t(v.quizLevel),1),h[21]||=i(`span`,{class:`ai-q-stat-label`},`Trình độ`,-1)])])],64)):u(``,!0)])):u(``,!0),_.activeTab===`lessons`?(d(),c(`section`,de,[i(`div`,fe,[i(`aside`,pe,[h[22]||=i(`h3`,null,`📚 Bài học`,-1),i(`ul`,$,[(d(!0),c(s,null,m(_.lessons,(e,n)=>(d(),c(`li`,{key:n,class:f([`ai-lesson-item`,{active:_.selectedLesson===n}]),onClick:e=>_.selectedLesson=n},[i(`span`,null,t(e.title?.replace(/^📄 /,``)),1),i(`span`,he,t(v.getLessonProgress(n)),1)],10,me))),128))]),i(`div`,ge,[i(`span`,null,t(v.lessonProgress.done)+` / `+t(v.lessonProgress.total),1),i(`div`,_e,[i(`div`,{class:`progress-fill`,style:n({width:v.lessonProgress.percent+`%`})},null,4)])])]),i(`div`,ve,[i(`div`,ye,[i(`h2`,null,t(_.lessons[_.selectedLesson]?.title),1),i(`div`,{class:`lesson-body`,innerHTML:v.renderedLesson},null,8,be)])])])])):u(``,!0)])])}var Se=l(E,[[`render`,xe],[`__scopeId`,`data-v-bfce81e0`]]);export{Se as default};