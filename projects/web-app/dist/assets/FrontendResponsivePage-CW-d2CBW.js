import{S as e,_ as t,m as n,n as r,u as i,v as a}from"./index-D9HXQNcj.js";import{n as o}from"./navigate-Byzdyx8e.js";var s={name:`FrontendResponsivePage`,methods:{handleNav(e){o(e)}}},c={class:`responsive-page`,style:{"--color-accent":`#34d399`}},l={class:`page`},u={class:`topbar`},d={class:`links`};function f(r,o,s,f,p,m){return e(),t(`div`,c,[n(`div`,l,[n(`div`,u,[o[2]||=n(`h1`,null,`📱 Responsive Design`,-1),n(`div`,d,[n(`a`,{href:`#`,onClick:o[0]||=i(e=>m.handleNav(`/frontend/hub`),[`prevent`])},`← Frontend`),n(`a`,{href:`#`,onClick:o[1]||=i(e=>m.handleNav(`/`),[`prevent`])},`Trang chủ`)])]),o[3]||=a(`<p class="desc" data-v-19dd2eda>Media Queries, Container Queries, Mobile-first, Fluid typography, Breakpoint system.</p><div class="section" data-v-19dd2eda><h2 data-v-19dd2eda>📐 Breakpoint System</h2><pre data-v-19dd2eda><code data-v-19dd2eda>/* Mobile-first: base styles cho mobile, mở rộng dần */
