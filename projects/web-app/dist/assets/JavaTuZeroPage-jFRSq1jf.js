...
System.out.println(a % b);`,question:`In ra 2 dòng gì?`,options:[`3 và 1`,`3.33 và 1`,`3 và 0`,`3.33 và 0.33`],answer:0,explain:`Chia 2 int bỏ phần dư: 10/3 = 3. % lấy phần dư: 10%3 = 1.`}]},re={class:`tu-zero-page`},ie={class:`tz-header`},h={class:`tz-heading`},g={class:`tz-tabs`},_=[`onClick`],v={class:`tz-chapter-head`},y={class:`tz-time`},b={class:`tz-intro`},x={class:`code-title`},S={key:0,class:`tz-quiz`},C={class:`quiz-q`},w={class:`quiz-options`},T=[`disabled`,`onClick`],E={key:0,class:`quiz-why`},D={key:1,class:`tz-section`},O={class:`tz-chapter-head`},k={class:`tz-time`},A={class:`ex-head`},j={class:`ex-task`},M={class:`ex-buttons`},N=[`onClick`],P=[`onClick`],F={key:0,class:`ex-hint`},I={key:1,class:`ex-answer`},ae={class:`code-card`},L={class:`ex-explain`},R={key:2,class:`tz-section`},z={class:`tz-chapter-head`},B={class:`tz-time`},V={class:`rc-index`},H={class:`code-card`},U={class:`quiz-q`},W={class:`quiz-options`},G=[`disabled`,`onClick`],K={key:0,class:`quiz-why`},q=te({__name:`JavaTuZeroPage`,setup(te){let q=f(()=>m.chapters),J=u(`ch1`),Y=e({}),X=e({}),Z=e({});function Q(e,t){return e+`-`+t}function oe(e){return e.startsWith(`rc-`)?X:Y}function $(e,t,n,r){let i=e===`rc`?`rc-`+t:Q(e,t),a=oe(i)[i];return a===void 0?{}:n===r?{correct:!0}:n===a?{wrong:!0}:{}}function se(e,t,n){let r=Q(e,t);Y[r]===void 0&&(Y[r]=n)}function ce(e,t){let n=`rc-`+e;X[n]===void 0&&(X[n]=t)}function le(e){Z[e]||(Z[e]={hint:!1,answer:!1}),Z[e].hint=!Z[e].hint}function ue(e){Z[e]||(Z[e]={hint:!1,answer:!1}),Z[e].answer=!Z[e].answer}function de(e){return e===`easy`?`Dễ`:e===`medium`?`Trung bình`:`Khó`}function fe(){ne(`/java/hub`)}return(e,u)=>(a(),o(`div`,re,[d(`header`,ie,[d(`button`,{class:`tz-back`,onClick:fe},`← Java`),d(`div`,h,[u[2]||=d(`h1`,null,`🌱 Java Từ 0 — mất gốc → đi làm`,-1),d(`p`,null,` Dành cho người yếu Java và tư duy lập trình: 6 chương nền tảng + quiz, `+n(r(m).exercises.length)+` bài tập có lời giải từng bước, `+n(r(m).readCode.length)+` bài đọc-code đoán kết quả. `,1)])]),d(`nav`,g,[(a(!0),o(c,null,t(r(m).chapters,e=>(a(),o(`button`,{key:e.id,class:i([`tz-tab`,{active:J.value===e.id}]),onClick:t=>J.value=e.id},n(e.emoji)+` `+n(e.title),11,_))),128)),d(`button`,{class:i([`tz-tab`,{active:J.value===`exercises`}]),onClick:u[0]||=e=>J.value=`exercises`},` 💪 Bài tập `,2),d(`button`,{class:i([`tz-tab`,{active:J.value===`readcode`}]),onClick:u[1]||=e=>J.value=`readcode`},` 🔍 Đọc code `,2)]),J.value.startsWith(`ch`)?(a(!0),o(c,{key:0},t(q.value,e=>ee((a(),o(`section`,{key:e.id,class:`tz-section`},[d(`div`,v,[d(`h2`,null,n(e.emoji)+` `+n(e.title),1),d(`span`,y,`⏱️ `+n(e.time),1)]),d(`p`,b,n(e.intro),1),(a(!0),o(c,null,t(e.lessons,e=>(a(),o(`div`,{key:e.title,class:`tz-lesson`},[d(`h3`,null,n(e.title),1),(a(!0),o(c,null,t(e.paragraphs,(e,t)=>(a(),o(`p`,{key:t,class:`tz-para`},n(e),1))),128)),(a(!0),o(c,null,t(e.codes,e=>(a(),o(`div`,{key:e.title,class:`code-card`},[d(`div`,x,n(e.title),1),d(`pre`,null,[d(`code`,null,n(e.code),1)])]))),128))]))),128)),e.quiz&&e.quiz.length?(a(),o(`div`,S,[u[3]||=d(`h3`,null,`✅ Kiểm tra nhanh — hiểu rồi mới sang bài sau`,-1),(a(!0),o(c,null,t(e.quiz,(r,s)=>(a(),o(`div`,{key:s,class:`quiz-item`},[d(`p`,C,n(r.q),1),d(`div`,w,[(a(!0),o(c,null,t(r.options,(t,c)=>(a(),o(`button`,{key:c,class:i([`quiz-opt`,$(e.id,s,c,r.answer)]),disabled:Y[Q(e.id,s)]!==void 0,onClick:t=>se(e.id,s,c)},n(t),11,T))),128))]),Y[Q(e.id,s)]===void 0?l(``,!0):(a(),o(`p`,E,n(Y[Q(e.id,s)]===r.answer?`✅ Đúng. `:`❌ Chưa đúng. `)+` `+n(r.why),1))]))),128))])):l(``,!0)])),[[s,J.value===e.id]])),128)):J.value===`exercises`?(a(),o(`section`,D,[d(`div`,O,[u[4]||=d(`h2`,null,`💪 Bài tập luyện tư duy`,-1),d(`span`,k,n(r(m).exercises.length)+` bài · Dễ → Khó`,1)]),u[9]||=d(`p`,{class:`tz-intro`},` Quy tắc vàng: tự viết 20–30 phút KHÔNG được thì mới xem gợi ý; viết tiếp vẫn bí mới xem đáp án. Chép đáp án không rèn được tư duy — hiểu "vì sao" mới là mục tiêu. `,-1),(a(!0),o(c,null,t(r(m).exercises,e=>(a(),o(`div`,{key:e.id,class:`ex-card`},[d(`div`,A,[d(`span`,{class:i([`ex-level`,`lv-`+e.level])},n(de(e.level)),3),d(`h3`,null,n(e.title),1)]),d(`div`,j,[u[5]||=d(`strong`,null,`Đề bài:`,-1),p(` `+n(e.task),1)]),d(`div`,M,[d(`button`,{class:`ex-btn`,onClick:t=>le(e.id)},n(Z[e.id]&&Z[e.id].hint?`Ẩn gợi ý`:`💡 Xem gợi ý`),9,N),d(`button`,{class:`ex-btn primary`,onClick:t=>ue(e.id)},n(Z[e.id]&&Z[e.id].answer?`Ẩn đáp án`:`✅ Xem đáp án`),9,P)]),Z[e.id]&&Z[e.id].hint?(a(),o(`div`,F,[u[6]||=d(`strong`,null,`Cách nghĩ:`,-1),p(` `+n(e.hint),1)])):l(``,!0),Z[e.id]&&Z[e.id].answer?(a(),o(`div`,I,[d(`div`,ae,[u[7]||=d(`div`,{class:`code-title`},`Lời giải`,-1),d(`pre`,null,[d(`code`,null,n(e.solution),1)])]),d(`p`,L,[u[8]||=d(`strong`,null,`Vì sao:`,-1),p(` `+n(e.explain),1)])])):l(``,!0)]))),128))])):(a(),o(`section`,R,[d(`div`,z,[u[10]||=d(`h2`,null,`🔍 Đọc code — đoán kết quả`,-1),d(`span`,B,n(r(m).readCode.length)+` câu hỏi bẫy`,1)]),u[11]||=d(`p`,{class:`tz-intro`},` Cách rèn "tư duy lập trình" nhanh nhất: đọc code như máy tính, chạy từng dòng trong đầu rồi đoán output. Sai bao nhiêu cũng được — đọc kỹ phần giải thích. `,-1),(a(!0),o(c,null,t(r(m).readCode,(e,r)=>(a(),o(`div`,{key:r,class:`rc-card`},[d(`span`,V,`Câu `+n(r+1),1),d(`div`,H,[d(`pre`,null,[d(`code`,null,n(e.code),1)])]),d(`p`,U,n(e.question),1),d(`div`,W,[(a(!0),o(c,null,t(e.options,(t,s)=>(a(),o(`button`,{key:s,class:i([`quiz-opt`,$(`rc`,r,s,e.answer)]),disabled:X[`rc-`+r]!==void 0,onClick:e=>ce(r,s)},n(t),11,G))),128))]),X[`rc-`+r]===void 0?l(``,!0):(a(),o(`p`,K,n(X[`rc-`+r]===e.answer?`✅ Đúng. `:`❌ Chưa đúng. `)+` `+n(e.explain),1))]))),128))]))]))}},[[`__scopeId`,`data-v-2203e295`]]);export{q as default};